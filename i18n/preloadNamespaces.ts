...
export const ROUTE_NAMESPACES: Record<string, Namespace[]> = {
  ...
  // Also include 'booking' for ScheduleWidget and lead modals
  '/dancehall': ['pages', 'classes', 'booking'],
  '/twerk': ['pages', 'classes', 'booking'],
  '/sexy-reggaeton': ['pages', 'classes', 'booking'],
  '/sexy-style': ['pages', 'classes', 'booking'],
  '/hip-hop-reggaeton': ['pages', 'classes', 'booking'],
  '/contemporaneo': ['pages', 'classes', 'booking'],
  '/femmology': ['pages', 'classes', 'booking'],
  '/bachata': ['pages', 'classes', 'booking'],
  '/hip-hop': ['pages', 'classes', 'booking'],
  '/afrobeats': ['pages', 'classes', 'booking'],
  '/afro-jazz': ['pages', 'classes', 'booking'],
  '/salsa-cubana': ['pages', 'classes', 'booking'],
  '/ballet': ['pages', 'classes', 'booking'],
  '/afro-contemporaneo': ['pages', 'classes', 'booking'],
  '/jornada-puertas-abiertas': ['pages', 'classes', 'booking'],
