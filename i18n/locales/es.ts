export const es = {
  ...
  metaDescription:
    'Academia de baile de élite en Barcelona, dirigida por el icono mundial Yunaisy Farray. Ofrecemos formación en más de 25 estilos con el revolucionario Método Farray®, en un centro acreditado por CID-UNESCO.',
  ...
  navReggaetonCubano: 'Reggaeton Cubano',
  navHeels: 'Heels',
  ...
  // Happiness Story
  happinessStoryLine1:
    'Hay quienes buscan una escuela de baile parecida a las que ya conocen, y no hay nada de malo en eso.',
  ...
  classCatLatinDesc:
    'Aprende a bailar en pareja con la auténtica técnica cubana. Desde salsa cubana y timba hasta bachata sensual, nuestros profesores formados en la Escuela Nacional de Arte de Cuba te enseñarán a conectar con tu pareja, dominar el ritmo latino y disfrutar de la música caribeña. Grupos separados por niveles reales: iniciación, intermedio y avanzado.',
  classCatUrbanTitle: 'Clases de Danza Urbana y Hip Hop',
  classCatUrbanDesc:
    'Siente la energía de la calle con Hip Hop, Dancehall, Reggaeton, Afrobeat, K-Pop y Commercial Dance. Aprende coreografías de videoclip, técnica urbana auténtica, flow y actitud escénica. Estilos para todos los niveles: desde iniciación hasta avanzado. Ideal para quienes buscan expresión, música actual y cultura urbana.',
  classCatContemporaryTitle: 'Ballet, Contemporáneo y Jazz',
  classCatContemporaryDesc:
    'Explora la técnica clásica y la expresión contemporánea con Ballet Clásico, Danza Contemporánea, Modern Jazz, Afro-Jazz y Afro-Contemporáneo. Desarrolla tu técnica, flexibilidad, musicalidad y expresión artística. Clases adaptadas a todos los niveles con profesores formados en escuelas cubanas de reconocido prestigio internacional.',
  classCatFitnessTitle: 'Preparación Física',
  classCatFitnessDesc:
    'Mejora tu fuerza, flexibilidad, resistencia y control corporal con clases diseñadas específicamente para bailarines. Incluye Bum Bum Glúteos, Stretching, Pilates, Body Conditioning y Dance Barre. Entrenamientos funcionales que complementan tu práctica de baile, previenen lesiones y potencian tu rendimiento en cualquier estilo.',
  classCatMorningTitle: 'Clases de Baile por la Mañana',
  classCatMorningDesc:
    'Empieza tu día con energía y movimiento. Ofrecemos clases de Danza Contemporánea, Afro-Jazz, Sexy Reggaeton y Sexy Style en horario de mañana (10h-14h). Ideal para estudiantes, profesionales con horarios flexibles o quienes prefieren entrenar antes del mediodía. Grupos reducidos y ambiente motivador.',
  classCatWorldTitle: 'Danzas del Mundo y Exóticas',
  classCatWorldDesc:
    'Viaja por el mundo a través del baile: Kizomba, Semba y Kompa (danzas africanas), Flamenco y Sevillanas (tradición española), Pole Dance, Telas Aéreas y Acro-Yoga (disciplinas aéreas y acrobáticas). Descubre estilos únicos, amplía tu vocabulario de movimiento y explora nuevas culturas a través de la danza.',
  // Why FIDC
  ...
  videoTestimonialsCTA: 'Síguenos en Instagram',
  videoTestimonial1Title: 'Así se vive una clase',
  videoTestimonial2Title: 'Energía pura',
  videoTestimonial3Title: 'Nuestra comunidad',
  videoTestimonial4Title: 'El método en acción',
  videoTestimonial5Title: 'Transformación real',
  videoModalLoading: 'Cargando video...',
  videoModalClose: 'Cerrar video',
  videoModalCloseHint: 'Pulsa ESC o fuera del video para cerrar',
  // FinalCTA
  finalCtaTitle:
    'No te prometemos ser la mejor escuela de baile de Barcelona. Te prometemos algo mejor: resultados.',
  finalCtaSubtitleLine1:
    'Personas normales que hoy bailan increíble empezaron igual que tú: dudando.',
  ...
  danceClassesHub_style_afro_contemporaneo_desc:
    'Fusión única de movimientos afrocaribeños con técnica contemporánea, creando un lenguaje de danza rico y expresivo. Combina la energía y el ritmo de las danzas afro con la fluidez y libertad del contemporáneo. Desarrolla tu musicalidad, conexión con el suelo y presencia escénica a través de esta mezcla vibrante y poderosa.',
  danceClassesHub_style_afro_jazz_desc:
    'Jazz con raíces afrocaribeñas y técnica cubana que te hace vibrar desde el primer movimiento. Aprende pasos con influencia de la cultura africana, polirritmos complejos y desplazamientos dinámicos. Ideal para quienes buscan técnica jazz con sabor, energía tropical y expresión cultural auténtica.',
  danceClassesHub_style_ballet_clasico_desc:
    'Ballet clásico con metodología cubana reconocida mundialmente. Técnica impecable, elegancia refinada y expresividad única que caracteriza la Escuela Cubana de Ballet. Aprende port de bras fluido, trabajo de barra riguroso, giros limpios y saltos controlados con profesores formados en la Escuela Nacional de Arte de Cuba.',
  ...
  danceClassesHub_style_afrobeat_desc:
    'Energía africana pura con ritmos de Ghana y Nigeria que te hacen vibrar de pies a cabeza. Aprende movimientos explosivos de pecho, hombros y cadera con afrobeats contemporáneos. Desarrolla potencia física, coordinación compleja y conexión cultural mientras quemas calorías bailando al ritmo de Burna Boy, Wizkid y Davido.',
  danceClassesHub_style_dancehall_desc:
    'El estilo urbano más energético nacido en Kingston, Jamaica, que combina flow caribeño con cardio intenso y actitud imparable. Aprende steps auténticos como Wacky Dip, Willy Bounce, Log On y World Dance mientras desarrollas groove de cadera, musicalidad reggae y presencia escénica. Para todos los niveles, desde iniciación hasta avanzado.',
  danceClassesHub_style_femmology_heels_desc:
    'Técnica femenina en tacones que fusiona sensualidad, elegancia y fuerza en cada movimiento. Aprende isolaciones precisas, control corporal, aislaciones de cadera y presencia escénica mientras fortaleces piernas y core. Desarrolla confianza, feminidad y actitud con técnica segura y profesional en tacones.',
  danceClassesHub_style_hip_hop_desc:
    'La base de todas las danzas urbanas nacida en el Bronx de Nueva York. Aprende los fundamentos del street dance: bounce, groove, isolaciones, popping, locking y old school. Desarrolla tu propio flow, musicalidad urbana y estilo personal con las raíces auténticas del Hip Hop.',
  danceClassesHub_style_hip_hop_reggaeton_desc:
    'Fusión explosiva de Hip Hop americano y Reggaeton latino que combina groove urbano, bounce y flow caribeño en una sola clase. Desarrolla versatilidad, cardio intenso y ritmo completo mientras aprendes a fusionar dos mundos urbanos con técnica, musicalidad y actitud.',
  danceClassesHub_style_reggaeton_cubano_desc:
    'Reggaeton auténtico de La Habana: flow cubano, reparto, musicalidad y sabor caribeño directo de Cuba. Aprende la esencia original del Cubatón con técnica, clave, movimiento de cadera real y actitud del barrio. El reggaeton como nació en los solares habaneros.',
  danceClassesHub_style_sexy_reggaeton_desc:
    'Reggaeton sensual con técnica femenina que combina perreo, dembow y movimientos de cadera fluidos. Desarrolla sensualidad con control, confianza corporal y ritmo latino urbano mientras tonificas glúteos y core con actitud caribeña y feminidad potente.',
  danceClassesHub_style_sexy_style_desc:
    'Feminidad urbana con actitud que combina sensualidad, fuerza y presencia escénica potente. Aprende técnica en tacones, isolaciones sensuales, control de cadera y expresión sexy sin perder el respeto. Desarrolla elegancia, confianza y expresión femenina auténtica.',
  danceClassesHub_style_twerk_desc:
    'Fortalece y tonifica glúteos con técnica real de twerk. Más allá del cliché, aprende aislaciones precisas, control muscular selectivo, movimientos de impacto y bounce controlado. Entrenamiento físico exigente que mejora fuerza de core, aislamiento de cadera y autoestima corporal.',
  danceClassesHub_style_commercial_dance_desc:
    'Baile para videoclips, publicidad y redes sociales que fusiona Hip Hop, Jazz Funk y Heels con estética viral. Aprende coreografías pulidas, presencia de cámara, formaciones comerciales y técnica de performance profesional. Perfecto para aspirantes a bailarines profesionales y creadores de contenido.',
  danceClassesHub_style_k_pop_desc:
    'Baile comercial coreano con coreografías de precisión inspiradas en BTS, Blackpink, Stray Kids y tus grupos favoritos. Aprende sincronización perfecta, formaciones grupales, detalles faciales, gestos característicos y energía K-Pop. Ideal para amantes del K-Pop y danza comercial asiática.',
  ...
  danceClassesHub_style_salsa_cubana_desc:
    'Salsa auténtica de Cuba con sabor circular, alegre y social. Aprende Rueda de Casino, guapeo, pasos tradicionales cubanos y conexión de pareja con la técnica original de La Habana. Baile en pareja perfecto para fiestas, sociales y congresos internacionales. Aprende a bailar salsa con profesores cubanos formados en la tradición real.',
  danceClassesHub_style_bachata: 'Bachata',
  danceClassesHub_style_bachata_desc:
    'Baile sensual caribeño de República Dominicana que te conecta con tu pareja a través de ondas corporales, movimientos fluidos y ritmo romántico. Aprende conexión de pareja, técnica de cadera, giros suaves y musicalidad bachata. Desde tradicional hasta sensual moderna, para todos los niveles.',
  danceClassesHub_style_timba_cubana: 'Timba Cubana',
  danceClassesHub_style_timba_cubana_desc:
    'Salsa moderna de Cuba: rápida, enérgica y llena de actitud explosiva. Aprende despelotes, vacilones, pasos complejos y musicalidad avanzada con ritmo acelerado y energía imparable. El nivel más alto de la salsa cubana para bailarines que buscan desafío técnico y sabor auténtico.',
  danceClassesHub_style_folklore_cubano: 'Folklore Cubano',
  danceClassesHub_style_folklore_cubano_desc:
    'Raíces afrocubanas profundas: Rumba Guaguancó, Yambú, Columbia y danzas rituales de los Orishas (Yemayá, Oshún, Changó). Aprende el lenguaje corporal africano en Cuba, polirritmos de percusión, movimientos de suelo y conexión cultural espiritual con las tradiciones yoruba y bantú.',
  danceClassesHub_style_salsa_lady_style: 'Salsa Lady Style',
  danceClassesHub_style_salsa_lady_style_desc:
    'Técnica femenina individual de salsa cubana: giros múltiples, trabajo de brazos fluido, actitud femenina y presencia escénica potente. Aprende a brillar sola en la pista sin depender de pareja. Desarrolla musicalidad, gracia, velocidad de giros y expresión personal con la técnica cubana auténtica.',
  danceClassesHub_style_salsa_lady_timba: 'Salsa Lady Timba',
  danceClassesHub_style_salsa_lady_timba_desc:
    'Lady Style con la energía explosiva de la Timba cubana moderna. Combina técnica femenina individual con ritmo acelerado, despelotes, vacilones y actitud imparable. Para bailarinas avanzadas que buscan desafío técnico, velocidad extrema y presencia escénica de alto impacto.',
  danceClassesHub_style_son_cubano: 'Son Cubano',
  danceClassesHub_style_son_cubano_desc:
    'El padre de la salsa: elegante, clásico y lleno de tradición cubana auténtica de los años 40-50. Aprende la base original de todos los bailes latinos con pasos tradicionales, elegancia refinada, conexión de pareja clásica y musicalidad del son montuno. La esencia pura del baile cubano.',
  danceClassesHub_style_men_style_salsa: 'Men Style Salsa',
  danceClassesHub_style_men_style_salsa_desc:
    'Técnica masculina individual de salsa cubana: footwork complejo, actitud de líder, presencia escénica potente y musicalidad avanzada. Aprende a bailar solo con técnica impecable, desarrolla tu propio estilo masculino, domina pasos de casino, despelotes y giros mientras mejoras tu capacidad de liderazgo en pareja.',
  ...
  // World Dance Styles Descriptions
  ...
  danceClassesHub_categories_title: 'Categorías principales de nuestras clases de Baile',
  danceClassesHub_categories_description:
    'Explora por familias de estilos de baile. Cada categoría incluye enlaces a sus páginas y a los estilos más buscados.',
  danceClassesHub_featured_styles_label: 'Estilos destacados',
  danceClassesHub_all_styles_label: 'Estilos disponibles',
  danceClassesHub_faq_title: 'Preguntas Frecuentes sobre nuestras clases de baile en Barcelona',

  // Dance Classes Hub - What to Expect Section
  danceClassesHub_whatToExpect_title: '¿Qué encontrarás en nuestras clases de baile en Barcelona?',
  danceClassesHub_whatToExpect_p1:
    "En Farray's International Dance Center ofrecemos más de 25 estilos de baile diferentes: desde la técnica clásica de la Escuela Cubana (ballet clásico, afro contemporáneo, afro jazz) hasta las danzas urbanas más explosivas del momento (dancehall, k-pop, twerk, reggaeton, commercial dance), pasando por bailes de pareja con raíz latina (salsa cubana, bachata, timba) y entrenamiento físico específico para bailarines. Cada estilo está diseñado para que descubras el tuyo y desarrolles tus habilidades desde el primer día.",
  danceClassesHub_whatToExpect_p2:
    'Organizamos todos nuestros grupos por niveles reales: iniciación (nunca has bailado), básico (tienes experiencia básica), intermedio (tienes experiencia) y avanzado (dominas la técnica). Los principiantes absolutos son más que bienvenidos: nuestras clases de iniciación están pensadas para que te sientas cómodo desde el minuto uno, sin presión, con progresión clara y en un ambiente motivador. No importa si nunca has bailado: aquí empieza tu viaje.',
  danceClassesHub_whatToExpect_p3:
    'Estamos ubicados en el corazón de Barcelona, cerca de Plaza España y Estación de Sants con acceso directo desde Metro L1 y L5. Nuestra escuela es fácilmente accesible desde los barrios del Raval, Eixample, Gràcia, Sant Antoni, Ciutat Vella y toda el área metropolitana. Horarios flexibles de mañana, tarde y en breve fines de semana para que encuentres la clase que mejor encaje con tu agenda.',
  danceClassesHub_whatToExpect_p4:
    'Dentro de nuestro equipo de profesores encontrarás bailarines profesionales reconocidos a nivel global, formados en la Escuela Cubana, tanto en La Escuela Nacional de Arte de Cuba, como en La Escuela Nacional de Ballet, con trayectoria en compañías internacionales y experiencia pedagógica real. No solo dominan la técnica: saben transmitirla con pasión, paciencia y un método que funciona. Aprenderás de los mejores en un ambiente familiar, profesional e inclusivo que te hará sentir parte de nuestra comunidad desde el primer día.',

  // Dance Classes Hub - Which Category Table
  danceClassesHub_whichCategory_title: '¿Qué clase de baile elegir según tu objetivo?',
  danceClassesHub_whichCategory_intro:
    '¿No sabes por dónde empezar? Esta guía rápida te ayudará a encontrar la categoría perfecta según lo que buscas. Todas nuestras categorías tienen grupos de iniciación para principiantes.',
  danceClassesHub_whichCategory_tableHeader_goal: 'Tu objetivo',
  danceClassesHub_whichCategory_tableHeader_category: 'Categoría recomendada',
  danceClassesHub_whichCategory_tableHeader_why: 'Por qué es ideal para ti',

  danceClassesHub_whichCategory_couples_goal: 'Quiero bailar en pareja y socializar',
  danceClassesHub_whichCategory_couples_category: 'Salsa y Bachata',
  danceClassesHub_whichCategory_couples_why:
    'Aprenderás conexión, liderazgo/seguimiento, musicalidad y podrás bailar en sociales, fiestas y congresos. Ideal para conocer gente y disfrutar de la escena social del baile.',

  danceClassesHub_whichCategory_expression_goal: 'Busco expresión artística y técnica clásica',
  danceClassesHub_whichCategory_expression_category: 'Danza Contemporánea / Ballet Clásico',
  danceClassesHub_whichCategory_expression_why:
    'Desarrollarás técnica sólida (escuela cubana), control corporal, expresividad emocional y creatividad. Perfecto si buscas arte, disciplina y un nivel técnico profesional.',

  danceClassesHub_whichCategory_urban_goal: 'Quiero fitness, coreografías y energía urbana',
  danceClassesHub_whichCategory_urban_category: 'Danzas Urbanas (Dancehall, K-Pop, Twerk, Hip Hop)',
  danceClassesHub_whichCategory_urban_why:
    'Cardio intenso, coreografías de videoclip, música actual y mucha actitud. Quemarás calorías, aprenderás steps de moda y te divertirás con una de las comunidades urbanas más activas de Barcelona.',

  danceClassesHub_whichCategory_fitness_goal: 'Quiero tonificar mi cuerpo y mejorar como bailarín',
  danceClassesHub_whichCategory_fitness_category:
    'Entrenamiento para Bailarines (Bum Bum, Stretching, Pilates)',
  danceClassesHub_whichCategory_fitness_why:
    'Entrenamiento específico para las exigencias de la danza: flexibilidad, fuerza de core, glúteos potentes, postura correcta. Complementa tus clases de baile y previene lesiones.',

  danceClassesHub_whichCategory_beginner_goal: 'Soy principiante absoluto, nunca he bailado',
  danceClassesHub_whichCategory_beginner_category: 'Cualquier categoría con nivel INICIACIÓN',
  danceClassesHub_whichCategory_beginner_why:
    'Todas nuestras categorías tienen grupos de iniciación específicos para principiantes absolutos. No necesitas experiencia previa, pareja ni equipamiento especial. Prueba tu clase HOY mismo. Reserva tu plaza y descubre tu estilo de baile preferido.',

  danceClassesHub_whichCategory_morning_goal: 'Quiero bailar por las mañanas (horario temprano)',
  danceClassesHub_whichCategory_morning_category: 'Clases de Baile por las Mañanas',
  danceClassesHub_whichCategory_morning_why:
    'Horarios de mañana (10h-14h) con ambiente más tranquilo y grupos reducidos. Perfecto si trabajas por las tardes, estudias o prefieres empezar el día con energía bailando.',

  danceClassesHub_whichCategory_world_goal: 'Quiero explorar bailes del mundo y estilos exóticos',
  danceClassesHub_whichCategory_world_category:
    'Danzas del Mundo (Kizomba, Flamenco, Sevillanas, Telas Aéreas)',
  danceClassesHub_whichCategory_world_why:
    'Descubre ritmos africanos (kizomba, semba), tradición española (flamenco, sevillanas) o disciplinas aéreas (telas, aro). Estilos únicos con alta demanda y lista de espera activa.',

  // Which Category - Info Cards
  danceClassesHub_whichCategory_beginner_title: '¿Primera vez bailando?',
  danceClassesHub_whichCategory_beginner_text:
    'Todas nuestras categorías tienen grupos de iniciación específicos para principiantes absolutos. No necesitas experiencia previa, pareja ni equipamiento especial. Prueba tu clase HOY mismo. Reserva tu plaza y descubre tu estilo de baile preferido.',

  danceClassesHub_whichCategory_combine_title: '¿Puedo combinar varias categorías?',
  danceClassesHub_whichCategory_combine_text:
    '¡Por supuesto! Muchos de nuestros alumnos combinan técnica clásica (ballet/contemporáneo) con urbano (dancehall/k-pop) o añaden entrenamiento físico (bum bum/stretching) a sus clases de baile. Es la mejor forma de desarrollarte como bailarín completo. Consulta nuestros bonos combinados.',
  ...
  danceClassesHub_why_title:
    "¿Por qué elegir las clases de baile de Farray's International Dance Center Barcelona?",
  danceClassesHub_why_subtitle:
    'Somos mucho más que una escuela de baile. Somos un espacio profesional donde la técnica, la pasión y la calidad se combinan para ofrecerte la mejor experiencia de aprendizaje.',

  danceClassesHub_why_variety_title: '25+ estilos bajo un mismo techo',
  danceClassesHub_why_variety_content:
    'La escuela de baile más completa de Barcelona. Desde ballet clásico cubano hasta Reggaeton, dancehall, salsa, bachata, twerk, pilates y mucho más. Todo en un solo lugar, sin necesidad de ir a múltiples academias. Descubre tu estilo o combina varios: aquí tienes acceso a todo el universo de la danza.',

  danceClassesHub_why_farray_method_title: 'Método Farray®',
  danceClassesHub_why_farray_method_content:
    'Sistema de enseñanza exclusivo creado por Yunaisy Farray, bailarina de Street Dance 2 y maestra reconocida internacionalmente. Combina rigor técnico con creatividad para resultados rápidos y sólidos en todos los estilos de baile: desde danza clásica hasta urbano y latinos.',

  danceClassesHub_why_cuban_title: 'Profesores con formación profesional cubana',
  danceClassesHub_why_cuban_content:
    'Gran parte de nuestro equipo docente está formado en prestigiosas escuelas de danza de Cuba, reconocidas mundialmente por su excelencia técnica. Aprenderás con profesores que dominan la metodología cubana en ballet, contemporáneo, folklore, salsa y otras disciplinas. Técnica sólida, expresividad única y rigor profesional.',

  danceClassesHub_why_levels_title: 'Grupos por niveles reales (sin mezclas)',
  danceClassesHub_why_levels_content:
    'No mezclamos principiantes con avanzados. Cada grupo está organizado por nivel real: iniciación, intermedio, avanzado. Progresarás a tu ritmo, sin frustraciones, con compañeros de tu mismo nivel. Evaluaciones periódicas para asegurar que siempre estás en el grupo correcto y evolucionas de forma constante.',

  danceClassesHub_why_location_title: 'Ubicación Privilegiada',
  danceClassesHub_why_location_content:
    'Estamos ubicados en el corazón de Barcelona, a tan solo 5 minutos caminando de Plaza España y Estación de Sants. Fácilmente accesible en metro, autobús o a pie desde Raval, Eixample, Gràcia, Sant Antoni, Ciutat Vella y toda el área metropolitana. Instalaciones profesionales, salas amplias con suelo de danza, espejos y ambiente familiar.',

  danceClassesHub_why_schedule_title: 'Horarios flexibles de lunes a viernes',
  danceClassesHub_why_schedule_content:
    'Clases de mañana, tarde y noche adaptadas a tu rutina. Horarios de lunes a viernes para que encuentres el momento perfecto según tu disponibilidad. Múltiples clases semanales de cada estilo te permiten avanzar rápido. Consulta nuestro planning completo y encuentra tu horario ideal.',

  danceClassesHub_why_accreditation_title: 'Escuela acreditada por CID-UNESCO',
  danceClassesHub_why_accreditation_content:
    'Somos miembros oficiales del Consejo Internacional de la Danza (CID-UNESCO), organización que agrupa a las mejores escuelas y profesionales de danza del mundo. Esta acreditación garantiza la calidad de nuestra enseñanza, el rigor de nuestra metodología y el reconocimiento internacional de tu formación.',

  // Dance Classes Hub - CTAs
  danceClassesHub_cta1_title: 'Encuentra tu categoría ideal',
  ...
  danceClassesHub_cta2_stat2_label: 'Alumnos activos',
  danceClassesHub_cta2_stat3_number: '30+',
  danceClassesHub_cta2_stat3_label: 'Estilos de baile',
  danceClassesHub_cta2_stat4_number: '15+',
  danceClassesHub_cta2_stat4_label: 'Profesores cubanos',

  // Dance Classes Hub - Final CTA Section
  danceClassesHub_finalCTA_title: 'Tu Primera Clase de Baile en Barcelona Te Está Esperando',
  ...
  danceClassesHub_finalCTA_description:
    'Únete a cientos de estudiantes —desde principiantes absolutos hasta bailarines avanzados— que están descubriendo su pasión en más de 25 estilos de baile diferentes: salsa cubana, bachata, dancehall, hip hop, reggaeton, ballet clásico, danza contemporánea, k-pop, twerk y mucho más. Todo con el exclusivo Método Farray® creado por Yunaisy Farray (bailarina de Street Dance 2) y profesores formados en la Escuela Cubana en el corazón de Barcelona.',
...
**Farray's International Dance Center ofrece clases de Dancehall en una escuela valorada cerca del 5/5 en Google con cientos de reseñas positivas.**`,
  ...
  // ===== Prepara tu Primera Clase de Dancehall =====
  ...
  dhV3BreadcrumbUrban: 'Clases de Danzas Urbanas',
  ...
  dhV3WhatIsP1:
    'El Dancehall es una danza tradicional jamaicana que nació en los años 70 y refleja una cultura con fuertes raíces en el reggae, referencias africanas y caribeñas, y la energía del hip-hop y otras danzas urbanas.',
  dhV3WhatIsP2:
    'El Dancehall es mucho más que un baile: es una manera de andar, de hablar y de entender la vida; una declaración de quién eres. Es expresión pura, es ritmo, actitud y flow. En el Dancehall no hay que ser bueno, hay que ser tú.',
  dhV3WhatIsP3:
    'Los ritmos contagiosos del Dancehall se difundieron rápidamente por todo el mundo, junto con un estilo de baile atractivo, enérgico y sensual.',
  dhV3WhatIsP4:
    'Barcelona se ha convertido en uno de los focos de Dancehall más activos de Europa, donde la cultura y la diversidad se viven en cada barrio.',
  ...
  dhV3Identify1:
    'Estás tan harto/a de la rutina que ya ni el café te quiere. Necesitas algo que te despierte YA.',
  dhV3Identify2:
    'Quieres mirarte al espejo y ver confianza pura, actitud real y cero miedo al qué dirán.',
  dhV3Identify3:
    'Odias el gimnasio... y el gimnasio también te odia. No os soportáis. Nunca fue amor.',
  dhV3Identify4:
    'Te hace falta gente real, buen rollo, risas y un lugar donde ser tú sin filtros ni postureos.',
  dhV3Identify5:
    'La vibra de Jamaica te mueve por dentro, pero tu vida parece más un lunes eterno que una fiesta en Kingston.',
  dhV3Identify6:
  ...
  dhV3IdentifySolution:
    'Si quieres salir de la rutina, sentirte mejor contigo mismo/a, conocer gente nueva y ponerte en forma mientras te diviertes, este estilo caribeño es para ti.',
  ...
  dhV3WhyChoose2Desc:
    'Expertas en Dancehall Female, Twerk y cultura afrocaribeña. Clases con flow, técnica y autenticidad.',
  ...
  dhV3VideoDesc:
    "Conoce de primera mano cómo es vivir la experiencia Farray's. Aprenderás los movimientos auténticos del Dancehall jamaicano con nuestras profesoras expertas.",
  ...
  dhV3WhyTodayClosing2:
    'Te esperamos con música cañera, profesores con carisma y una energía única en Barcelona.',
  ...
  dhV3FaqA4:
    'Ropa cómoda y ligera que permita moverte con libertad, zapatillas limpias de uso exclusivo dentro del estudio, toalla y agua, porque bailarás intensamente y necesitas hidratarte.',
  dhV3FaqQ5: '¿Qué estilos de Dancehall enseñamos en nuestra escuela de Barcelona?',
  dhV3FaqA5:
    'Dancehall Female: Estilo tradicional jamaicano con movimientos auténticos. Sensualidad, actitud y flow. Dancehall Twerk: Integra movimientos de Twerk/Bootydance. Energía, sensualidad y feminidad.',
  ...
  dhV3FaqA13:
    'Nuestras clases están abiertas a todas las personas, sin importar el género o la experiencia previa. El Dancehall es para todos.',
  ...
  dhV3CourseSchemaDesc:
    'Aprende Dancehall auténtico de Jamaica con profesoras expertas. Clases para todos los niveles desde principiantes hasta avanzados.',
  ...
  danzaBarcelona_why_reason7_title: 'Método Farray®',
  danzaBarcelona_why_reason7_desc:
    'Sistema de enseñanza exclusivo creado por Yunaisy Farray, bailarina de Street Dance 2 y maestra reconocida internacionalmente. Combina rigor técnico con creatividad para resultados rápidos y sólidos.',
  ...
  danzaCTA_description:
    'Únete a cientos de estudiantes —desde principiantes absolutos hasta bailarines avanzados— que están descubriendo su pasión en ballet clásico, danza contemporánea, afro contemporáneo, jazz, danza moderna y mucho más. Todo con el exclusivo Método Farray® creado por Yunaisy Farray (bailarina de Street Dance 2) y profesores formados en la Escuela Cubana en el corazón de Barcelona.',
  ...
  salsaBachataBarcelona_why_title:
    '¿Por qué elegir nuestra Escuela de Salsa y Bachata en Barcelona?',
  ...
  salsaBachataWhyFarrayMethodTitle: 'Método Farray®',
  salsaBachataWhyFarrayMethodContent:
    'Sistema de enseñanza exclusivo creado por Yunaisy Farray, bailarina de Street Dance 2 y maestra reconocida internacionalmente. Combina rigor técnico cubano con creatividad para resultados rápidos y sólidos en salsa, bachata y bailes latinos.',
  ...
  salsaBachataCTA_description:
    'Únete a cientos de estudiantes —desde principiantes absolutos hasta bailarines avanzados— que están descubriendo su pasión en salsa cubana, bachata sensual, timba, folklore cubano, salsa lady style y mucho más. Todo con el exclusivo Método Farray® creado por Yunaisy Farray (bailarina de Street Dance 2) y profesores formados en la Escuela Cubana en el corazón de Barcelona.',
  ...
  salsaBachata_whatIs_salsa:
    'La Salsa Cubana es mucho más que un baile: es una expresión cultural nacida en Cuba que fusiona ritmos afrocaribeños (son, rumba, mambo, chachachá) con jazz y otros estilos. Se caracteriza por movimientos circulares en pareja (rueda de casino), juego de pies rápido, expresión corporal libre y una conexión profunda con la música. Es el estilo de salsa más social y festivo, perfecto para bailar en grupo y disfrutar de la improvisación.',
  salsaBachata_whatIs_bachata:
    'La Bachata es un baile sensual y romántico originario de República Dominicana. Nació en los barrios populares en los años 60 y evolucionó hasta convertirse en uno de los bailes latinos más populares del mundo. Se baila en pareja con movimientos de cadera marcados, pasos básicos sencillos (lateral con tap) y giros fluidos. Existen varios estilos: Bachata Dominicana (tradicional), Bachata Sensual (moderna, con olas corporales) y Bachata Fusion.',
  salsaBachata_whatIs_difference_title: 'Diferencia entre Salsa Cubana y Salsa en Línea',
  salsaBachata_whatIs_difference_text:
    'La Salsa Cubana se baila en círculo (rueda de casino), con movimientos más libres y afrocaribeños, ideal para fiestas y baile social. La Salsa en Línea (estilo LA o Nueva York) se baila en línea recta, con coreografías más técnicas y giros espectaculares, perfecta para shows y exhibiciones. Ambos estilos comparten la misma música, pero la filosofía de baile es diferente.',
  salsaBachata_whatIs_benefits:
    'Bailar Salsa y Bachata mejora tu coordinación, ritmo, condición física cardiovascular, confianza social y conexión cultural. Es una forma divertida de hacer ejercicio, conocer gente nueva y sumergirte en la cultura latina. Además, desarrollas musicalidad, expresión corporal y habilidades de liderazgo/seguimiento en pareja.',

  // Point 3 - Style SEO Cards
  salsaBachata_style_salsa_cubana_seo:
    'Aprende el estilo más social y festivo de salsa. Rueda de casino, movimientos afrocaribeños, juego de pies cubano y conexión auténtica con la música. Ideal para principiantes y baile en grupo.',
  salsaBachata_style_bachata_seo:
    'Domina el baile latino más sensual y romántico. Movimientos de cadera, pasos básicos, giros fluidos y conexión en pareja. Desde Bachata Dominicana tradicional hasta Bachata Sensual moderna.',
  salsaBachata_style_timba_cubana_seo:
    'Descubre la evolución explosiva de la salsa cubana. Ritmos complejos, energía intensa, improvisación avanzada y afrocubanismo puro. Para bailadores intermedios/avanzados que buscan desafío musical.',
  salsaBachata_style_son_cubano_seo:
    'Aprende la raíz tradicional de toda la salsa. Elegancia clásica, pasos de los años 50-60, contratiempo y sabor cubano auténtico. La base técnica de todo bailador de salsa.',
  salsaBachata_style_salsa_lady_style_seo:
    'Desarrolla tu estilo femenino en salsa: shines, movimientos de brazos, ondas corporales, actitud escénica y presencia. Baila sola con técnica, musicalidad y carisma profesional.',
  salsaBachata_style_bachata_lady_style_seo:
    'Perfecciona tu técnica femenina en bachata: aislamiento de cadera, fluidez corporal, styling sensual y expresión artística. Gana confianza, elegancia y control total de tu movimiento.',
  salsaBachata_style_salsa_lady_timba_seo:
    'Lleva tu salsa femenina al siguiente nivel con Timba. Ritmos rápidos, footwork complejo, desplantes afrocubanos y energía explosiva. Para bailadoras avanzadas que dominan la musicalidad.',
  salsaBachata_style_men_style_seo:
    'Perfecciona tu guía masculina en salsa y bachata: liderazgo claro, musicalidad, shines masculinos, presencia escénica y técnica de pasos. Conviértete en un bailador completo y versátil.',
  salsaBachata_style_folklore_cubano_seo:
    'Sumérgete en las raíces afrocubanas de la salsa: rumba guaguancó, columbia, yambú, danzón y bailes ceremoniales. Conexión cultural profunda, percusión corporal y espiritualidad del baile tradicional.',

  // Point 2 - Comparison Table
  salsaBachata_whichStyle_title: '¿Qué estilo de Salsa o Bachata elegir?',
  salsaBachata_whichStyle_intro:
    'Cada estilo de salsa y bachata tiene su propia personalidad, nivel técnico y propósito social. Esta tabla te ayudará a elegir según tu objetivo:',
  salsaBachata_whichStyle_tableHeader_goal: 'Tu objetivo',
  salsaBachata_whichStyle_tableHeader_style: 'Estilo recomendado',
  salsaBachata_whichStyle_tableHeader_why: '¿Por qué?',

  salsaBachata_whichStyle_social_goal: 'Bailar en fiestas y sociales',
  salsaBachata_whichStyle_social_style: 'Salsa Cubana + Bachata Dominicana',
  salsaBachata_whichStyle_social_why:
    'Ambos son los estilos más populares en eventos sociales latinos. Rueda de casino y bachata tradicional son perfectos para conectar con la comunidad latina y bailar toda la noche.',

  salsaBachata_whichStyle_romantic_goal: 'Bailar romántico en pareja',
  salsaBachata_whichStyle_romantic_style: 'Bachata Sensual',
  salsaBachata_whichStyle_romantic_why:
    'La Bachata Sensual es el estilo más íntimo y sensual de los bailes latinos. Movimientos fluidos, olas corporales y conexión profunda con tu pareja. Ideal para bailar canciones lentas y románticas.',

  salsaBachata_whichStyle_advanced_goal: 'Desafío técnico y musical',
  salsaBachata_whichStyle_advanced_style: 'Timba Cubana + Son Cubano',
  salsaBachata_whichStyle_advanced_why:
    'Timba tiene los ritmos más complejos y rápidos de la salsa. Son Cubano te enseña contratiempo y elegancia clásica. Perfectos para bailadores intermedios/avanzados que buscan profundidad musical.',

  salsaBachata_whichStyle_traditional_goal: 'Cultura y tradición afrocubana',
  salsaBachata_whichStyle_traditional_style: 'Folklore Cubano + Son Cubano',
  salsaBachata_whichStyle_traditional_why:
    'Folklore Cubano (rumba, guaguancó, columbia) te conecta con las raíces afrocubanas de la salsa. Son Cubano es la base histórica. Ideal para quienes valoran la cultura tradicional.',

  salsaBachata_whichStyle_solo_goal: 'Bailar sola/o con estilo',
  salsaBachata_whichStyle_solo_style: 'Salsa Lady Style / Men Style',
  salsaBachata_whichStyle_solo_why:
    'Lady Style y Men Style te enseñan shines, movimientos de brazos, presencia escénica y técnica individual. Perfectos para ganar confianza, musicalidad y bailar sin pareja cuando quieras.',

  salsaBachata_whichStyle_beginner_goal: 'Empezar desde cero',
  salsaBachata_whichStyle_beginner_style: 'Salsa Cubana Iniciación + Bachata Básica',
  salsaBachata_whichStyle_beginner_why:
    'Salsa Cubana tiene pasos básicos sencillos (guapea, dile que no, enchufla) y se baila en grupo, lo cual facilita el aprendizaje social. Bachata tiene el patrón más simple (4 pasos + tap) de todos los bailes latinos.',

  salsaBachata_whichStyle_beginner_title: '¿Primera vez en salsa o bachata? Empieza aquí',
  salsaBachata_whichStyle_beginner_text:
    'Si nunca has bailado salsa o bachata, recomendamos empezar con Salsa Cubana Nivel Iniciación para aprender los pasos básicos en un ambiente social divertido. También puedes probar Bachata Básica si buscas un patrón más simple y sensual desde el principio.',

  salsaBachata_whichStyle_adult_title:
    '¿Adulto que empieza de cero? Nuestras clases están diseñadas para ti',
  salsaBachata_whichStyle_adult_text:
    'Más del 70% de nuestros estudiantes de salsa y bachata son adultos que empiezan desde cero. Nuestras clases de Salsa Cubana Iniciación y Bachata Principiantes están específicamente diseñadas para adultos sin experiencia previa. Ambiente relajado, ritmo adaptado y grupos de tu edad.',

  salsaBachata_whichStyle_combine_title:
    '¿Puedo combinar Salsa Cubana y Bachata en la misma semana?',
  salsaBachata_whichStyle_combine_text:
    'Absolutamente. De hecho, lo recomendamos. Combinar Salsa Cubana y Bachata te da versatilidad social: podrás bailar cualquier canción en fiestas latinas. Muchos bailadores entrenan ambos estilos para ser más completos y disfrutar de todo el repertorio musical.',
  ...
  danzasUrbanas_whatIs_definition:
    'Las danzas urbanas son estilos de baile que nacieron en las calles, plazas y barrios de diferentes ciudades del mundo. Se llaman "urbanas" porque surgieron fuera de teatros y academias: en el Bronx (Hip Hop), Jamaica (Dancehall), Corea del Sur (K-Pop), Cuba (Reggaeton), Ghana y Nigeria (Afrobeat), y en clubes nocturnos de todo el mundo (Heels, Twerk, Sexy Style).',
  danzasUrbanas_whatIs_origin:
    'El término "danzas urbanas" agrupa una familia enorme de estilos que comparten ADN común: nacieron de la cultura popular, se transmitieron por imitación en las calles y evolucionaron con la música urbana contemporánea (rap, reggae, dancehall, trap, afrobeats). A diferencia de la danza clásica (ballet, contemporáneo, jazz), las danzas urbanas priorizan el groove, la musicalidad, la actitud y la expresión personal por encima de la técnica académica.',
  danzasUrbanas_whatIs_difference_title:
    'Diferencia entre "Danza Urbana", "Street Dance" y "Commercial Dance"',
  danzasUrbanas_whatIs_difference_urban:
    'Danza Urbana / Urban Dance: Término genérico para todos los estilos de baile nacidos en contextos urbanos y callejeros. Incluye Hip Hop, Breaking, Popping, Locking, Krump, House, Dancehall, Afrobeat, etc.',
  danzasUrbanas_whatIs_difference_street:
    'Street Dance: Se refiere específicamente a estilos bailados originalmente en la calle y en batallas (cyphers). Ej: Breaking, Popping, Locking, Krump. Estos estilos tienen códigos de batalla, improvisación (freestyle) y competición.',
  danzasUrbanas_whatIs_difference_commercial:
    'Commercial Dance: Estilo urbano coreografiado y pulido para la industria del entretenimiento: videoclips, conciertos, shows televisivos. Mezcla técnica de diferentes estilos urbanos con elementos de jazz, contemporáneo e influencias comerciales. Ej: coreografías de K-Pop, Heels, videoclips de artistas mainstream.',
  danzasUrbanas_whatIs_why_many_styles:
    'Existen tantos estilos diferentes porque cada uno nació en un contexto cultural, geográfico y musical único. El Hip Hop surgió en el Bronx de Nueva York con la cultura del rap y el breakdance. El Dancehall nació en Jamaica con los soundsystems y la música reggae. El K-Pop evolucionó en Corea del Sur fusionando pop occidental con estética asiática. El Afrobeat conecta con ritmos africanos modernos de Ghana, Nigeria y Sudáfrica. Cada estilo cuenta una historia diferente, tiene códigos propios y se baila con una energía distinta.',
  ...
  danzasUrbanas_styles_title: 'Estilos de bailes urbanos que ofrecemos',
  danzasUrbanas_styles_description:
    'Diferentes clases de danzas urbanas en Barcelona para principiantes hasta avanzados: Hip Hop, Dancehall, Afrodance, Reggaeton, Heels y más. Aprende técnica urbana real, mejora tu forma física sin aburrirte, desarrolla tu estilo propio y prepárate para competiciones con profesores especialistas. Cerca de Plaza España y Sants.',

  // Visible SEO text for each urban style card (Point 3)
  danzasUrbanas_style_dancehall_seo:
    'El estilo urbano más energético: nacido en Jamaica, combina flow caribeño con cardio intenso. Quemas calorías mientras desarrollas groove de cadera, actitud y musicalidad reggae. Para todos los niveles.',
  danzasUrbanas_style_hip_hop_seo:
    'La base de todas las danzas urbanas. Aprende los fundamentos del street dance: bounce, groove, isolaciones y old school. Fundado en el Bronx de Nueva York, es la puerta de entrada perfecta al mundo urbano.',
  danzasUrbanas_style_afrobeat_seo:
    'Energía africana pura: ritmos de Ghana y Nigeria con movimientos de pecho, hombros y cadera explosivos. Potencia física, coordinación y conexión cultural con afrobeats contemporáneos.',
  ...
  danzasUrbanas_style_sexy_reggaeton_seo:
    'Reggaeton sensual con técnica femenina: perreo, dembow y movimientos de cadera fluidos. Trabaja sensualidad, ritmo latino urbano y tonificación de glúteos con actitud caribeña.',
  danzasUrbanas_style_twerk_seo:
    'Fortalece y tonifica glúteos con técnica real. Más allá del cliché, el twerk es un entrenamiento físico exigente que mejora fuerza de core, aislamiento de cadera y autoestima corporal.',
  danzasUrbanas_style_commercial_dance_seo:
    'Baile para videoclips, publicidad y redes sociales. Fusión de estilos urbanos (Hip Hop, Jazz Funk, Heels) con estética viral. Perfecto para aspirantes a bailarines profesionales y creadores de contenido.',
  danzasUrbanas_style_hip_hop_reggaeton_seo:
    'Fusión explosiva de Hip Hop americano y Reggaeton latino. Combina groove urbano, bounce y flow caribeño en una sola clase. Ideal para desarrollar versatilidad, cardio intenso y ritmo completo.',
  danzasUrbanas_style_reggaeton_cubano_seo:
    'Reggaeton auténtico de La Habana: flow cubano, reparto, musicalidad y sabor caribeño directo de Cuba. Aprende la esencia original del reggaeton con técnica, actitud y cultura del barrio.',

  danzasUrbanas_why_title:
    'La Diferencia FIDC: ¿Por qué elegir nuestra Academia de danzas urbanas en Barcelona?',

  // Urban-specific cards content
  danzasUrbanasWhyFarrayMethodTitle: 'Método Farray®',
  danzasUrbanasWhyFarrayMethodContent:
    'Sistema de enseñanza exclusivo creado por Yunaisy Farray, bailarina de Street Dance 2 y maestra reconocida internacionalmente. Combina rigor técnico con creatividad para resultados rápidos y sólidos en hip hop, dancehall, reggaeton y todos los estilos urbanos.',

  urbanWhyInternationalTitle: 'Profesores Internacionales',
  urbanWhyInternationalContent:
    'Formación urbana en Barcelona con profesores que han pisado escenarios internacionales, videoclips y competiciones oficiales. Aprende Hip Hop, Dancehall, Afrodance, Reggaeton, Heels y más con quienes conocen la cultura desde dentro.',

  urbanWhyAuthenticStyleTitle: 'Estilos Urbanos Auténticos',
  urbanWhyAuthenticStyleContent:
    'Dancehall con esencia directa de Kingston y los steps que marcan tendencia. Hip Hop con fundamentos reales de Old School, New Style y Groove. Afrodance con raíces africanas y fusiones actuales. Reggaeton Cubano con flow, musicalidad y sabor de La Habana. Aprende cada estilo desde su origen, con técnica, cultura y la guía de profesores que viven la escena urbana por dentro.',
  ...
  danzasUrbanas_finalCTA_title: 'Aprende a Bailar Danzas Urbanas cómo siempre soñaste',
  danzasUrbanas_finalCTA_subtitle:
    'No dejes pasar más tiempo. Cada semana que esperas es una semana menos bailando.',
  danzasUrbanas_finalCTA_description:
    'Únete a cientos de estudiantes —desde principiantes absolutos hasta bailarines avanzados— que están descubriendo su pasión en hip hop, dancehall, reggaeton, k-pop, twerk, commercial dance, afrobeat, heels y mucho más. Todo con el exclusivo Método Farray® creado por Yunaisy Farray (bailarina de Street Dance 2) y profesores internacionales con experiencia en la escena urbana global en el corazón de Barcelona.',
  ...
  prepFisica_breadcrumb_classes: 'Clases de Baile en Barcelona',
  ...
  prepFisica_activity_bum_bum_gluteos_desc:
    'Entrenamiento intenso enfocado en glúteos fuertes, tonificados y levantados con técnicas específicas de activación muscular. Sentadillas, hip thrusts, trabajo de resistencia y ejercicios de aislamiento para esculpir y potenciar la zona. Potencia, estética y resultados visibles garantizados.',

  prepFisica_activity_bum_bum_fit_title: 'Bum Bum Cuerpo Fit',
  prepFisica_activity_bum_bum_fit_desc:
    'Entrenamiento completo de cuerpo entero que combina cardio, tonificación muscular y quema de grasa. Trabaja piernas, glúteos, abdomen, brazos y espalda en sesiones dinámicas y energizantes. Quema calorías, tonifica músculos, mejora tu condición física y transforma tu silueta.',

  prepFisica_activity_yoga_flow_title: 'Yoga Flow',
  prepFisica_activity_yoga_flow_desc:
    'Secuencias dinámicas de yoga (Vinyasa Flow) para mejorar flexibilidad, equilibrio, fuerza interna y conexión cuerpo-mente. Fluye entre asanas con respiración consciente, desarrolla estabilidad en inversiones y mejora tu alineación corporal. Ideal para bailarines que buscan centrarse y estirar profundamente.',

  prepFisica_activity_dance_barre_title: 'Dance Barre',
  prepFisica_activity_dance_barre_desc:
    'Fusión de ballet clásico, pilates y fitness en la barra para bailarines. Ejercicios de barra, pliés, relevés, trabajo de piernas y abdomen para fortalecer, estilizar la figura y mejorar tu técnica de danza. Elegancia, postura y músculos alargados al estilo de las bailarinas profesionales.',

  prepFisica_activity_mate_pilates_title: 'Mate Pilates',
  prepFisica_activity_mate_pilates_desc:
    'Pilates en colchoneta (Mat Pilates) para fortalecer el core profundo, mejorar la postura, desarrollar control corporal y estabilidad. Ejercicios de abdomen, espalda, equilibrio y respiración siguiendo el método clásico de Joseph Pilates. Cuerpo fuerte, alargado y alineado desde el centro.',

  prepFisica_viewMore: 'Ver más →',

  // Which Activity to Choose Section
  prepFisica_whichActivity_title:
    '¿Qué Actividad de Entrenamiento Elegir? Encuentra tu Clase Perfecta',
  prepFisica_whichActivity_intro:
    'Cada actividad de preparación física tiene objetivos y beneficios específicos. Usa esta guía para descubrir qué clase se adapta mejor a tus necesidades como bailarín.',
  prepFisica_whichActivity_tableHeader_goal: 'Si buscas…',
  prepFisica_whichActivity_tableHeader_activity: 'Actividad Recomendada',
  prepFisica_whichActivity_tableHeader_why: 'Por qué',

  // Table rows
  prepFisica_whichActivity_flexibility_goal: 'Ganar flexibilidad y amplitud de movimiento',
  prepFisica_whichActivity_flexibility_activity: 'Stretching / Yoga Flow',
  prepFisica_whichActivity_flexibility_why:
    'Estiramientos profundos, técnicas PNF y movilidad articular. Ideal para conseguir splits, extensiones altas y prevenir lesiones por rigidez.',

  prepFisica_whichActivity_strength_goal: 'Fuerza funcional específica para danza',
  prepFisica_whichActivity_strength_activity: 'Body Conditioning For Dancers',
  prepFisica_whichActivity_strength_why:
    'Fortalece músculos bailarines usan más: core, piernas, glúteos. Mejora saltos, giros y resistencia en coreografías sin ganar volumen.',

  prepFisica_whichActivity_glutes_goal: 'Tonificar y fortalecer glúteos intensamente',
  prepFisica_whichActivity_glutes_activity: 'Bum Bum Glúteos Maravillosos',
  prepFisica_whichActivity_glutes_why:
    'Entrenamiento focalizado en glúteos con ejercicios de potencia, resistencia y activación. Resultados estéticos y funcionales garantizados.',

  prepFisica_whichActivity_fullBody_goal: 'Entrenamiento completo de todo el cuerpo',
  prepFisica_whichActivity_fullBody_activity: 'Bum Bum Cuerpo Fit',
  prepFisica_whichActivity_fullBody_why:
    'Cardio + tonificación muscular de cuerpo entero. Quema calorías, acelera metabolismo y transforma tu físico. Perfecto para fitness general.',

  prepFisica_whichActivity_balance_goal: 'Equilibrio, respiración y conexión mente-cuerpo',
  prepFisica_whichActivity_balance_activity: 'Yoga Flow',
  prepFisica_whichActivity_balance_why:
    'Secuencias dinámicas de yoga que mejoran flexibilidad, equilibrio, control respiratorio y consciencia corporal. Reduce estrés y mejora enfoque mental.',

  prepFisica_whichActivity_technique_goal: 'Técnica de ballet y postura perfecta',
  prepFisica_whichActivity_technique_activity: 'Dance Barre',
  prepFisica_whichActivity_technique_why:
    'Fusión de ballet, pilates y fitness en la barra. Fortalece piernas, mejora postura, alineación y técnica de danza. Estiliza la silueta.',

  prepFisica_whichActivity_core_goal: 'Core fuerte y control corporal profundo',
  prepFisica_whichActivity_core_activity: 'Mate Pilates',
  prepFisica_whichActivity_core_why:
    'Pilates en colchoneta enfocado en core, estabilidad lumbo-pélvica y control muscular. Base esencial para todos los movimientos de danza.',

  prepFisica_whichActivity_beginner_title: '¿Primera vez en preparación física? Empieza aquí',
  prepFisica_whichActivity_beginner_text:
    'Si nunca has hecho preparación física para danza, empieza con Stretching (flexibilidad básica), Body Conditioning (fuerza funcional) o Yoga Flow (control y equilibrio). Son las bases perfectas para cualquier bailarín.',

  prepFisica_whichActivity_complement_title: '¿Cómo complementar tus clases de danza?',
  prepFisica_whichActivity_complement_text:
    'Ballet y Contemporáneo: Stretching + Dance Barre + Pilates. Urban y Dancehall: Body Conditioning + Bum Bum Glúteos. Salsa y Bachata: Yoga Flow + Stretching + Body Conditioning. Combina actividades para resultados completos.',

  prepFisica_whichActivity_combine_title: '¿Puedo combinar varias actividades?',
  ...
  prepFisica_why_farray_method_content:
    'Sistema de entrenamiento exclusivo creado por Yunaisy Farray, bailarina de Street Dance 2 y maestra reconocida internacionalmente. Combina preparación física específica para bailarines con técnicas de prevención de lesiones y optimización del rendimiento. Resultados rápidos y seguros.',

  prepFisica_why_specialized_title: 'Entrenamiento Especializado para Bailarines',
  prepFisica_why_specialized_content:
    'No es fitness genérico. Cada ejercicio está diseñado pensando en las demandas específicas de la danza: saltos, giros, extensiones, control corporal. Entrenamos movimientos que usas en clase.',

  prepFisica_why_injury_title: 'Prevención de Lesiones Efectiva',
  prepFisica_why_injury_content:
    'Fortalecemos tobillos, rodillas, cadera y core para reducir el riesgo de lesiones comunes en bailarines. Trabajo correctivo, propiocepción y ejercicios funcionales que protegen tu cuerpo.',

  prepFisica_why_performance_title: 'Mejora tu Rendimiento en Clase',
  prepFisica_why_performance_content:
    'Salta más alto, gira con más control, mantén extensiones más tiempo, aguanta coreografías completas sin fatigarte. La preparación física se traduce directamente en mejor ejecución técnica.',

  prepFisica_why_flexibility_title: 'Flexibilidad y Rango de Movimiento',
  prepFisica_why_flexibility_content:
    'Trabaja stretching activo, PNF y movilidad articular para conseguir splits, extensiones altas y movimientos amplios con control. Flexibilidad funcional, no pasiva.',

  prepFisica_why_strength_title: 'Fuerza Funcional sin Volumen',
  prepFisica_why_strength_content:
    'Desarrolla fuerza explosiva y resistencia muscular sin ganar volumen excesivo. Entrenamiento diseñado para crear cuerpos fuertes, ágiles y estéticos, perfectos para la danza.',

  prepFisica_why_holistic_title: 'Enfoque Integral Cuerpo-Mente',
  prepFisica_why_holistic_content:
    'Combinamos entrenamiento físico con consciencia corporal, respiración y control mental. No solo entrenas músculos, entrenas el sistema completo que te permite bailar con excelencia.',

  // FAQ - Preparación Física
  prepFisica_faq_title: 'Preguntas frecuentes sobre entrenamiento para bailarines',

  prepFisicaFaqQ1:
    '¿Qué es la preparación física para bailarines y en qué se diferencia del gimnasio?',
  prepFisicaFaqA1:
    'Es entrenamiento específico diseñado para las necesidades de los bailarines: fuerza explosiva para saltos, core para giros, flexibilidad activa, resistencia para coreografías y prevención de lesiones. A diferencia del gimnasio convencional, cada ejercicio tiene aplicación directa en la danza.',

  prepFisicaFaqQ2: '¿Necesito experiencia previa en entrenamiento físico?',
  prepFisicaFaqA2:
    'No. Las clases están adaptadas a todos los niveles. Si bailas, ya tienes la base. Te enseñamos la técnica correcta de cada ejercicio desde cero y progresamos según tu nivel físico actual.',

  prepFisicaFaqQ3:
    '¿Cuántas veces a la semana debería entrenar preparación física si ya tomo clases de baile?',
  prepFisicaFaqA3:
    'Ideal: 2-3 sesiones semanales de 45-60 minutos. Si bailas 4-5 veces por semana, con 2 sesiones de preparación física es suficiente para ver mejoras significativas en fuerza, flexibilidad y prevención de lesiones.',

  prepFisicaFaqQ4: '¿La preparación física me ayudará a prevenir lesiones?',
  prepFisicaFaqA4:
    'Sí. Fortalecemos zonas vulnerables (tobillos, rodillas, cadera, lumbares), corregimos desequilibrios musculares, mejoramos propiocepción y enseñamos patrones de movimiento seguros. Reduces drásticamente el riesgo de lesiones comunes.',

  prepFisicaFaqQ5: '¿Voy a ganar mucho volumen muscular con este entrenamiento?',
  prepFisicaFaqA5:
    'No. El entrenamiento está diseñado para desarrollar fuerza funcional, explosividad y resistencia muscular sin hipertrofia excesiva. Consigues un cuerpo fuerte, ágil y estético, perfecto para bailar.',

  prepFisicaFaqQ6: '¿Puedo mejorar mi flexibilidad con la preparación física?',
  prepFisicaFaqA6:
    'Sí. Incluimos sesiones específicas de flexibilidad con stretching activo, PNF, movilidad articular y ejercicios de rango de movimiento. Muchos estudiantes consiguen splits y extensiones que antes no tenían.',

  prepFisicaFaqQ7: '¿Este entrenamiento me ayudará a saltar más alto y girar mejor?',
  prepFisicaFaqA7:
    'Absolutamente. Trabajamos fuerza explosiva en piernas para saltos, core y estabilidad para giros controlados, y propiocepción para equilibrio. Verás mejoras directas en tu técnica de danza.',

  prepFisicaFaqQ8: '¿Qué ropa y calzado necesito para las clases de preparación física?',
  prepFisicaFaqA8:
    'Ropa deportiva cómoda (mallas, camiseta técnica) y zapatillas de entrenamiento con buena amortiguación. Para ejercicios de flexibilidad, muchos prefieren entrenar descalzos o con calcetines antideslizantes.',

  prepFisicaFaqQ9: '¿Puedo combinar preparación física con mis clases de baile?',
  prepFisicaFaqA9:
    'Sí, es muy recomendable. La preparación física complementa tu entrenamiento de danza: mejora tu rendimiento técnico, previene lesiones y acelera tu progreso. Muchos bailarines combinan 3-4 clases de baile + 2 de preparación física semanales.',

  prepFisicaFaqQ10: '¿Dónde se realizan las clases de preparación física?',
  prepFisicaFaqA10:
    'En nuestras instalaciones de Calle Entença 100, Barcelona, a 5 minutos de Plaza España y Sants. Salas amplias de 700 m² con suelo profesional, equipamiento específico y ambiente especializado en danza.',

  // Final CTA
  prepFisica_finalCTA_title: 'Transforma tu Cuerpo, Eleva tu Danza',
  prepFisica_finalCTA_subtitle: 'Entrena como un bailarín profesional. No como un atleta genérico.',
  prepFisica_finalCTA_description:
    'Únete a cientos de estudiantes —desde principiantes absolutos hasta bailarines avanzados— que están mejorando su rendimiento en stretching, body conditioning, pilates, yoga flow, dance barre y mucho más. Todo con el exclusivo Método Farray® creado por Yunaisy Farray (bailarina de Street Dance 2) y entrenamiento especializado para las exigencias de la danza en el corazón de Barcelona.',
  ...
  about_description:
    "Conoce la historia de Farray's International Dance Center, nuestra misión, valores y el sueño que Yunaisy Farray convirtió en realidad en el corazón de Barcelona.",
  about_slogan: 'Donde los sueños se bailan',
  ...
  about_story_p1:
    "Hay quienes buscan una escuela de baile parecida a las que ya conocen, y no hay nada de malo en eso. Y hay quienes buscan la escuela que siempre soñaron. En Farray's somos de este segundo grupo.",
  about_story_p2:
    'Pero como esta escuela todavía no existía en Barcelona, decidimos crearla y está funcionando. Como no sabíamos que era imposible, lo hicimos. No sabíamos que era imposible levantarla en un local abandonado durante 10 años. Tampoco sabíamos que era mala idea reformarlo a mano, sin presupuesto, solo con Yunaisy, Fábio, amigos, profesores y una brigada improvisada. No sabíamos nada de "lo imposible". Así que simplemente lo hicimos.',
  about_story_p3:
    "Farray's International Dance Center, más que un proyecto, es un sueño. Un sueño hecho realidad por la bailarina internacional cubana Yunaisy Farray. Considerada una de las mayores referencias en la danza femenina cubana y una de las mejores bailarinas dentro del panorama internacional, en el momento cumbre de su carrera artística y profesional decide dar un paso adelante en su vida: abrir un gran centro de danza en la ciudad que le tiene enamorada, Barcelona.",
  about_story_highlight:
    "Porque Farray's no nació de un plan de negocio: nació de una historia de amor. Del amor entre Yunaisy y Fábio, del amor por la danza y del amor por la gente.",

  // Vision Section
  about_vision_title: 'La Visión de Yunaisy',
  about_vision_p1:
    "Desde su origen, Farray's International Dance Center nace con una vocación clara: no ser solo una escuela de baile, sino un club deportivo y artístico con un papel integrador social, donde la danza, el deporte y la cultura se utilicen como herramientas para mejorar la sociedad, fomentando un estilo de vida saludable y el bienestar físico, mental y emocional de las personas de su comunidad.",
  about_vision_p2:
  ...
  about_today_intro:
    "Hoy, Farray's International Dance Center es un espacio de más de 700 m² en el corazón de Barcelona donde conviven clases de baile y danza para todos los niveles, entrenamientos técnicos, preparación física, desarrollo de competiciones, actividades de bienestar y proyectos artísticos.",
  about_stat_space: 'de espacio en Barcelona',
  about_stat_active_students: 'estudiantes activos',
  about_stat_total_students: 'alumnos en 8 años',
  about_today_description:
    'Actualmente cuenta con más de 1500 estudiantes en activo y en tan solo 8 años, por sus salas han pasado más de 15.000 alumnos, lo que lo consolida como uno de los centros de referencia en danza y baile en Barcelona.',
  ...
  about_social_title: 'Nuestro Compromiso Social',
  about_social_p1:
  ...
  about_value_love_content:
    'Todo lo que hacemos nace del amor: amor entre las personas, amor por la danza y amor por nuestra comunidad. No es un eslogan, es nuestra realidad.',

  about_value_community_title: 'Familia y Comunidad',
  about_value_community_content:
    'Aquí se respira familia porque así lo construimos. Cada estudiante, profesor y visitante forma parte de una comunidad única en Barcelona.',

  about_value_wellbeing_title: 'Bienestar Integral',
  about_value_wellbeing_content:
    'Ofrecemos servicios variados dirigidos a un fin común: el bienestar físico, mental y emocional completo de todas las personas que acuden a nosotros.',

  about_value_opportunities_title: 'Generación de Oportunidades',
  about_value_opportunities_content:
    'Hacemos realidad los sueños de quienes aspiran a bailar, crecer y expresarse, formando bailarines y artistas de nivel mundial de todas las edades.',

  about_value_social_title: 'Integración Social',
  about_value_social_content:
    'Ayudamos a sectores especiales de la comunidad a reencontrarse consigo mismos mediante la danza, con un marcado componente integrador y social.',

  about_value_excellence_title: 'Excelencia y Profesionalidad',
  about_value_excellence_content:
    'Método Farray® creado por Yunaisy Farray (bailarina de Street Dance 2) y profesores formados en escuelas de prestigio internacional garantizan la máxima calidad.',

  // Closing Statement
  about_closing_statement:
    'Yunaisy Farray y su equipo hacen precisamente eso: encienden una llama de luz, salud y esperanza en cada una de las personas que pasan por su escuela, contribuyendo a que en la sociedad haya gente más sana física y mentalmente, más equilibrada, con más control sobre sí mismos y sus emociones.',
  about_closing_tagline: 'En definitiva, gente más feliz.',
  ...
  contact_schedule_weekdays: 'Lunes a Viernes',
  contact_schedule_saturday: 'Sábado',
  contact_schedule_sunday: 'Domingo',
  contact_schedule_closed: 'Cerrado',
  ...
  contact_form_subject_classes: 'Información sobre clases',
  contact_form_subject_schedule: 'Horarios y disponibilidad',
  ...
  merchandising_page_description:
    "Descubre la colección oficial de merchandising de Farray's International Dance Center. Camisetas, sudaderas, bolsas y más.",
  ...
  merchandising_hero_subtitle:
    "Lleva el estilo de Farray's contigo. Descubre nuestra colección oficial.",
  merchandising_products_title: 'Nuestros Productos',
  merchandising_products_subtitle:
    "Productos de alta calidad con el logo de Farray's International Dance Center",
  merchandising_category_clothing: 'Ropa',
  merchandising_category_accessories: 'Accesorios',
  merchandising_category_bags: 'Bolsas',
  ...
  notFound_subtitle: 'Lo sentimos, la página que buscas no existe.',
  notFound_description: 'Es posible que la URL esté mal escrita o que la página haya sido movida.',
  notFound_backHome: 'Volver al Inicio',
  notFound_classes: 'Ver Clases',
  ...
  yunaisyFarray_meta_description:
    "Conoce a Yunaisy Farray, fundadora de Farray's International Dance Center, maestra CID-UNESCO, bailarina de Street Dance 2, finalista de Got Talent España y referente mundial en danza cubana.",
  yunaisyFarray_breadcrumb_home: 'Inicio',
  yunaisyFarray_breadcrumb_current: 'Yunaisy Farray',
  yunaisyFarray_hero_title: 'Conoce a Yunaisy Farray',
  yunaisyFarray_hero_subtitle:
    'Para muchos, Yunaisy Farray sigue siendo la nº1 mundial en el ámbito de los festivales de danza cubana. Pero su grandeza va mucho más allá del escenario: es maestra, creadora, activista, líder y defensora incansable de la mujer y de los derechos de los animales.',

  yunaisyFarray_intro_title: 'Yunaisy Farray',
  yunaisyFarray_intro_subtitle: "Fundadora y directora de Farray's International Dance Center",
  yunaisyFarray_intro_p1:
    'Maestra del CID-UNESCO (Consejo Internacional de la Danza de la UNESCO), bailarina de la película Street Dance 2, finalista de Got Talent España, miembro del equipo de casting artístico del programa de televisión "The Dancer", colaboradora habitual en el programa de Toni Rovira y presencia fija en los festivales de danza cubana más importantes del mundo.',
  yunaisyFarray_intro_p2:
    'Para muchos, Yunaisy Farray sigue siendo la nº1 mundial en el ámbito de los festivales de danza cubana. Pero su grandeza va mucho más allá del escenario: es maestra, creadora, activista, líder y defensora incansable de la mujer y de los derechos de los animales.',

  yunaisyFarray_roots_title: 'Raíces en La Habana y formación de élite',
  yunaisyFarray_roots_p1:
    'Nacida en La Habana (Cuba), en una familia donde la danza lo atraviesa todo, Yunaisy empieza ballet con solo 5 años en el Instituto de Televisión Cubana. A los 7 entra en la Escuela Elemental de Ballet Alejo Carpentier, y sigue su formación en la prestigiosa Escuela Nacional de Danza Moderna y Contemporánea de Cuba (ENA), donde su talento la sitúa desde muy joven en la élite de la danza contemporánea cubana.',
  yunaisyFarray_roots_p2:
    'Continúa sus estudios en la Academia Nacional de Espectáculos Musicales (ENEM), graduándose como cantante, actriz y bailarina. En paralelo se especializa en Danza Teatro e incursiona en el mundo del circo, construyendo una base técnica y artística excepcional.',
  ...
  yunaisyFarray_career_p3:
    'Con el auge de la salsa en Italia, sus raíces afrocubanas vuelven a hablar más fuerte y Yunaisy se convierte en una de las maestras y artistas de referencia del país. Su estilo, su técnica y su capacidad para formar bailarines impactan tanto que la Federación Italiana de Bailes Deportivos (FIDS) la reconoce oficialmente otorgándole el título de maestra y juez por sus méritos de carrera y artísticos.',
  yunaisyFarray_career_p4:
    'En paralelo, junto a Seo Fernández, forma parte del grupo Latin Black, con el que alcanza fama mundial y consolida su figura como una de las grandes embajadoras de la danza cubana en el panorama internacional.',
  ...
  yunaisyFarray_barcelona_p1:
    'Después de un período en Alemania, donde crea su primera escuela, AYA Latin Dance Academy, se traslada a Barcelona en 2013 para iniciar una nueva etapa profesional.',
  yunaisyFarray_barcelona_p2:
    'Recién llegada, el maestro Chucho Valdés la elige para dirigir y coreografiar el homenaje a Bebo Valdés, "Rumba para Bebo", en el 45º Voll Damm Festival Internacional de Jazz de Barcelona. El proyecto es aclamado por el público y por las instituciones culturales de la ciudad.',
  yunaisyFarray_barcelona_p3:
    'Figuras como Albert Torres y Eddie Torres la consideran "la nueva Celia Cruz de la salsa". Desde Barcelona, Yunaisy se convierte en una de las bailarinas que está revolucionando el mercado del baile, gracias a su estudio profundo del movimiento femenino y su capacidad para unir técnica, emoción y verdad escénica.',
  ...
  yunaisyFarray_method_p1:
    'Yunaisy es la creadora del Método Farray, un sistema de trabajo que permite obtener resultados rápidos, sólidos y comprobados, tanto a nivel técnico como corporal y emocional.',
  yunaisyFarray_method_p2:
    'Su preparación técnica y física, unida a un conocimiento profundo del folclore cubano y de la biomecánica del cuerpo de la mujer, hacen de sus clases una experiencia única. Ha sido pionera en la introducción de clases técnicas (como la danza contemporánea de técnica cubana) en los festivales de baile social alrededor del mundo, integrando estos elementos en sus clases, workshops y espectáculos.',
  yunaisyFarray_method_p3:
    'Entre sus citas favoritas destaca una del legendario boxeador cubano Félix Savón, que resume su filosofía de trabajo:',
  yunaisyFarray_method_quote: '"La técnica es la técnica… y sin técnica, no hay técnica."',
  yunaisyFarray_method_p4:
    'En el universo de los shows, ha sido y sigue siendo una impulsora de espectáculos que son arte, piezas que cuentan historias y transmiten un mensaje. Frente a la tendencia habitual de coreografías vacías de contenido, Yunaisy defiende un baile que tenga fundamento, fondo y alma.',

  yunaisyFarray_equality_title: 'Igualdad, mujer y baile: mucho más que un escenario',
  yunaisyFarray_equality_p1:
    'Yunaisy ha sido una voz clave en la lucha por la igualdad de derechos entre hombres y mujeres en el mundo del espectáculo. Durante años fue "normal" presentar a la pareja de baile como: nombre del bailarín + "su bailarina", omitiendo el nombre de la mujer.',
  yunaisyFarray_equality_p2: 'Ella ha alzado la voz contra estas prácticas y ha luchado por:',
  yunaisyFarray_equality_point1: 'Nombrar y reconocer a las bailarinas por su nombre y apellido',
  yunaisyFarray_equality_point2: 'Reclamar igualdad de condiciones económicas',
  ...
  yunaisyFarray_online_p1:
    'Durante la pandemia, Yunaisy y su escuela fueron pioneros en las clases online, e inspiración para todo el mundo, manteniendo vivo el vínculo con cientos de alumnos en todo el mundo cuando todo lo demás se detenía.',
  yunaisyFarray_online_p2:
    "Desde Farray's International Dance Center se desarrollaron programas, cursos y formaciones online que permitieron a bailarines de diferentes países seguir creciendo, conectando y encontrando en la danza un refugio y un motor para seguir adelante.",

  yunaisyFarray_social_title: 'Compromiso social y proyectos solidarios',
  yunaisyFarray_social_intro:
    'La labor de Yunaisy también se extiende al terreno solidario. Entre sus iniciativas destacan:',
  ...
  yunaisyFarray_social_point4:
    'Considerada una de las personas más influyentes de España en Change.org en la defensa de los derechos de los animales.',
  yunaisyFarray_social_point5:
    'Actividades de inserción social para personas con discapacidad y/o en riesgo de exclusión social.',
  yunaisyFarray_social_point6:
    'Talleres gratuitos para mujeres presas, utilizando la danza como herramienta de dignidad, autoestima y esperanza.',
  yunaisyFarray_social_point7:
    'Implicación constante en ayudar a las personas de su entorno, creando red, apoyo y oportunidades a través de la danza.',

  yunaisyFarray_today_title: 'Hoy',
  yunaisyFarray_today_p1:
    "Hoy, Yunaisy sigue viajando por el mundo, impartiendo clases magistrales, participando en festivales, trabajando en televisión, cine, videoclips y proyectos escénicos de alto nivel; y, al mismo tiempo, continúa formando a nuevas generaciones de bailarinas y bailarines desde Barcelona, a través de Farray's International Dance Center.",
  yunaisyFarray_today_p2:
    'Respira Danza: hace de la técnica un lenguaje y del corazón su forma de enseñar.',
  yunaisyFarray_final_quote:
    '"Cuando todo parece imposible y el camino parece difícil… no te olvides de respirar."',

  yunaisyFarray_cta_title: "Forma Parte de la Familia Farray's",
  yunaisyFarray_cta_subtitle:
    'Únete a la escuela donde Yunaisy Farray transmite su pasión, técnica y experiencia.',
  yunaisyFarray_cta_classes: 'Ver Clases',
  ...
  regalaBaile_breadcrumb_current: 'Regala Baile',
  regalaBaile_hero_title: 'Regala Baile, Regala Vida',
  regalaBaile_hero_subtitle: 'El regalo más original y memorable que puedes hacer',
  regalaBaile_hero_description:
    'Regala una experiencia transformadora: clases de baile en el corazón de Barcelona. Más que un regalo, es una puerta a la felicidad, la salud, la confianza y nuevas amistades.',
  regalaBaile_cta_button: 'Comprar Tarjeta Regalo',
  regalaBaile_view_classes: 'Ver Clases Disponibles',
  regalaBaile_benefits_title: '¿Por Qué Regalar Baile?',
  regalaBaile_benefits_subtitle: 'Un regalo que va mucho más allá de una simple clase',
  regalaBaile_benefit1_title: 'Regala Salud y Bienestar',
  regalaBaile_benefit1_desc:
    'El baile mejora la salud cardiovascular, tonifica el cuerpo, reduce el estrés y libera endorfinas. Es el regalo perfecto para quien quieres que se sienta mejor física y emocionalmente.',
  regalaBaile_benefit2_title: 'Regala Confianza',
  ...
  regalaBaile_benefit5_title: 'Regala Flexibilidad Total',
  regalaBaile_benefit5_desc:
    'La persona que reciba el regalo podrá elegir el estilo que más le guste: salsa, bachata, dancehall, contemporáneo, reggaetón, heels y mucho más. Se adapta a todos los niveles y horarios.',
  regalaBaile_benefit6_title: 'Regala Validez de 1 Año',
  regalaBaile_benefit6_desc:
    'Nuestras tarjetas regalo tienen validez de 1 año desde la fecha de compra. Tiempo más que suficiente para que la persona que lo recibe pueda disfrutarlo sin prisas.',
  regalaBaile_how_title: '¿Cómo Funciona?',
  regalaBaile_how_subtitle: 'Regalar baile es fácil, rápido y súper especial',
  regalaBaile_step1_title: 'Elige el Importe',
  regalaBaile_step1_desc:
    'Selecciona el valor de la tarjeta regalo según tu presupuesto. La tarjeta se puede canjear por bonos de clases o mensualidad. Tú decides cuánta felicidad quieres regalar.',
  regalaBaile_step2_title: 'Personaliza tu Regalo (Opcional)',
  regalaBaile_step2_desc:
    'Recibe el comprobante de compra por email. Si quieres una tarjeta personalizada de alta calidad para imprimir, escríbenos a info@farrayscenter.com y te la enviaremos en un plazo de 48 horas.',
  regalaBaile_step3_title: 'Entrega tu Regalo',
  regalaBaile_step3_desc:
    'Puedes enviar el comprobante por email, imprimirlo o presentarlo en un sobre bonito. Si pediste tarjeta personalizada, la recibirás lista para imprimir en alta calidad.',
  regalaBaile_step4_title: 'Canjeo en la Escuela',
  regalaBaile_step4_desc:
    'La persona que recibe el regalo pasa por la escuela para canjear su tarjeta por bonos de clases o mensualidad. Allí elige el estilo que más le guste y empieza a bailar.',
  regalaBaile_occasions_title: 'Ocasiones Perfectas para Regalar Baile',
  regalaBaile_occasions_subtitle: 'Cualquier momento es bueno para regalar alegría y movimiento',
  regalaBaile_occasion1: 'Cumpleaños',
  regalaBaile_occasion2: 'San Valentín',
  regalaBaile_occasion3: 'Graduaciones',
  regalaBaile_occasion4: 'Navidad',
  regalaBaile_occasion5: 'Aniversarios',
  ...
  regalaBaile_faq1_a:
    'Sí, las tarjetas regalo tienen una validez de 1 año desde la fecha de compra. Es tiempo más que suficiente para que la persona que reciba el regalo pueda canjearlo y disfrutarlo sin prisas.',
  regalaBaile_faq2_q: '¿Por qué se puede canjear la tarjeta regalo?',
  regalaBaile_faq2_a:
    'La tarjeta regalo se puede canjear por bonos de clases o por mensualidad. Una vez canjeada en la escuela, la persona podrá elegir el estilo de baile que más le guste: salsa, bachata, kizomba, dancehall, reggaetón, heels, contemporáneo, street heels, preparación física y más.',
  regalaBaile_faq3_q: '¿Cómo recibo la tarjeta regalo después de comprarla?',
  regalaBaile_faq3_a:
    'Recibirás un comprobante de compra por email con un código único. Si deseas una tarjeta regalo personalizada de alta calidad para imprimir (con diseño profesional, foto de calidad, etc.), escríbenos a info@farrayscenter.com y te la enviaremos en un plazo de 48 horas.',
  regalaBaile_faq4_q: '¿Puedo personalizar el diseño de la tarjeta?',
  regalaBaile_faq4_a:
    'Sí, si quieres una tarjeta regalo personalizada y de alta calidad para imprimir, escríbenos a info@farrayscenter.com con tu pedido y te crearemos una tarjeta personalizada que te enviaremos por email en un plazo máximo de 48 horas.',
  regalaBaile_faq5_q: '¿Cómo se canjea la tarjeta regalo?',
  regalaBaile_faq5_a:
    'La persona que recibe el regalo debe pasar por la escuela (Calle Entença nº 100, Barcelona) para canjear su tarjeta por bonos de clases o mensualidad. Allí nuestro equipo le ayudará a elegir la mejor opción según sus preferencias.',
  regalaBaile_faq6_q: '¿Puedo enviar la tarjeta directamente a la persona que la recibe?',
  regalaBaile_faq6_a:
    'Sí, puedes reenviar el comprobante de compra que recibes por email directamente a la persona que recibirá el regalo, o bien recibirlo tú para entregarlo personalmente. Si pides tarjeta personalizada, podrás imprimirla y entregarla en mano.',
  regalaBaile_faq7_q: '¿Qué pasa si la persona no puede asistir a una clase reservada?',
  regalaBaile_faq7_a:
    'Las clases se pueden cancelar con antelación desde nuestra plataforma de reservas online sin ningún problema. La clase se mantiene en su bono para usar en otra ocasión.',
  regalaBaile_final_cta_title: '¿List@ para Regalar Felicidad?',
  regalaBaile_final_cta_subtitle: 'Haz un regalo que recordarán para siempre',
  regalaBaile_final_cta_description:
    'Compra tu tarjeta regalo ahora y sorprende a esa persona especial con una experiencia transformadora',
  regalaBaile_contact_us: 'Contactar',
  regalaBaile_cta_note: '¿Necesitas ayuda? Contacta con nosotros y te asesoramos personalmente',

  // Gift Options Section
  regalaBaile_options_title: '¿Qué Quieres Regalar?',
  regalaBaile_options_subtitle:
    '¿No sabes qué escoger? Tenemos experiencias de baile para todos los bolsillos y todos los gustos. Elige la que más te guste y regala momentos inolvidables.',
  regalaBaile_options_intro:
    'Porque sabemos lo difícil que es escoger un regalo original que realmente emocione, te ofrecemos la experiencia de bailar con el Método Farray. ¡Vamos!',

  // Pack Categories
  regalaBaile_category_group_classes: 'Clases Grupales',
  regalaBaile_category_private_classes: 'Clases Particulares',
  regalaBaile_category_couples: 'Clases en Pareja',
  regalaBaile_category_friends: 'Clases con Amigos',
  ...
  regalaBaile_pack_feeling_desc:
    'Explora tu feminidad y confianza con las clases más vibrantes de sexy style, reggaetón o dancehall en Barcelona. Para quien quiere sentirse empoderado y radiante.',
  regalaBaile_pack_feeling_includes: 'Incluye: Sexy Style, Reggaetón, Dancehall',

  // Pack: 100% Urban
  regalaBaile_pack_urban_title: '100% Urban',
  regalaBaile_pack_urban_desc:
    'Si lo suyo son las danzas urbanas, este es el pack perfecto. Pura energía de la calle con profesores de talla mundial.',
  regalaBaile_pack_urban_includes: 'Incluye: Hip Hop, Commercial, Shuffle, Urban Styles',

  // Pack: Ballet / Contemporáneo
  regalaBaile_pack_ballet_title: 'Ballet / Contemporáneo',
  regalaBaile_pack_ballet_desc:
    'Si quien recibe el regalo es incondicional del ballet o de la danza contemporánea, este pack le enamorará. Técnica, expresión y arte en movimiento.',
  regalaBaile_pack_ballet_includes: 'Incluye: Ballet, Danza Contemporánea',

  // Pack: Just 4 You (Clases Particulares)
  regalaBaile_pack_just4you_title: 'Just 4 You',
  regalaBaile_pack_just4you_desc:
    'Regala una o varias clases particulares del estilo que más le gusta y en el horario que mejor le encaje. Un profesor dedicado 100% a su progreso. Siempre nos adaptamos al nivel y horario.',
  regalaBaile_pack_just4you_includes:
    'Incluye: Cualquier estilo, horario flexible, atención personalizada',

  // Pack: Bailar Pegados Premium (Pareja)
  regalaBaile_pack_couple_title: 'Bailar Pegados Premium',
  regalaBaile_pack_couple_desc:
    'Clases de baile en pareja de una hora con un profesor exclusivo. La opción más premium para aprender salsa, bachata, kizomba o el estilo que elijan. ¡Conexión y química garantizadas!',
  regalaBaile_pack_couple_includes: 'Incluye: Salsa, Bachata, Kizomba, Tango',

  // Pack: Clase con Amigos
  regalaBaile_pack_friends_title: 'Clase con Amigos',
  regalaBaile_pack_friends_desc:
    'Con este pack podréis bailar en grupo hasta 12 personas por clase, el día, hora y estilo que elijáis. Tendremos en cuenta todos los niveles. ¡Compartir es vivir!',
  regalaBaile_pack_friends_includes:
    'Incluye: Hasta 12 personas, estilo a elegir, todos los niveles',

  // Price Options
  regalaBaile_price_2classes: '2 clases - 49€',
  regalaBaile_price_4classes: '4 clases - 89€',
  regalaBaile_price_6classes: '6 clases - 109€',
  regalaBaile_price_2classes_ballet: '2 clases - 59€',
  regalaBaile_price_4classes_ballet: '4 clases - 99€',
  regalaBaile_price_6classes_ballet: '6 clases - 129€',
  regalaBaile_price_1private: '1 clase - 79€',
  regalaBaile_price_3private: '3 clases - 199€',
  regalaBaile_price_5private: '5 clases - 259€',
  regalaBaile_price_1hour_friends: '1 clase de 1 hora - 169€',
  regalaBaile_price_1_5hour_friends: '1 clase de 1.5 horas - 209€',
  regalaBaile_price_2hour_friends: '2 clases de 1 hora - 269€',

  // Buttons
  regalaBaile_buy_button: 'Comprar Pack',
  regalaBaile_more_info: 'Más Información',

  // Delivery Section
  regalaBaile_delivery_title: '¿Cómo Recibo Mi Tarjeta Regalo?',
  regalaBaile_delivery_subtitle: 'Elige la opción que más te convenga',
  regalaBaile_delivery_school_title: 'Recogida en la Escuela',
  regalaBaile_delivery_school_desc:
    'Recoge tu tarjeta regalo de forma totalmente gratuita en la secretaría de la escuela, Calle Entença nº 100, Barcelona. Horario: Lunes a Viernes de 10:00 a 21:00h.',
  regalaBaile_delivery_email_title: 'Envío por Email',
  regalaBaile_delivery_email_desc:
    'Recibirás el comprobante de compra por email al instante. Si quieres una tarjeta personalizada de alta calidad, escríbenos a info@farrayscenter.com y te la enviamos en 48h.',
  ...
  particularesPage_benefit1_title: 'Profesor 100% Dedicado a Ti',
  particularesPage_benefit1_desc:
    'Toda la clase enfocada en ti: correcciones personalizadas, ritmo adaptado y atención exclusiva en cada movimiento.',

  particularesPage_benefit2_title: 'Aprende 3x Más Rápido',
  particularesPage_benefit2_desc:
    'Con atención exclusiva del profesor, avanzas en 1 clase particular lo mismo que en 3-4 clases regulares grupales.',

  particularesPage_benefit3_title: 'Horarios Totalmente Flexibles',
  particularesPage_benefit3_desc:
    'Elige el día y hora que mejor te convengan: mañanas, tardes, fines de semana. Nos adaptamos a tu agenda.',

  particularesPage_benefit4_title: 'Graba Tu Clase',
  particularesPage_benefit4_desc:
    'Llévate la clase contigo: graba para repasar en casa, practicar y no olvidar ningún paso.',
  ...
  particularesPage_faqQ1: '¿Es necesario tener experiencia previa para tomar clases particulares?',
  particularesPage_faqA1:
    'No, para nada. Las clases particulares son ideales tanto para principiantes absolutos como para bailarines avanzados. El profesor adapta el contenido, ritmo y dificultad a tu nivel actual. Si nunca has bailado, empezaremos desde cero con fundamentos básicos. Si ya tienes experiencia, trabajaremos en perfeccionar técnica, coreografías complejas o preparación para audiciones.',

  particularesPage_faqQ2: '¿Se paga por clase o por alumno?',
  particularesPage_faqA2:
    'El precio es por clase, no por alumno. Si vienes solo, pagas el precio de 1 clase particular. Si vienes con un compañero (máximo 2 personas), el precio de la clase varía según el nivel de profesor: Profesor Regular pasa de 65€/hora (1 alumno) a 80€/hora (2 alumnos), y Profesor Premium de 75€/hora (1 alumno) a 100€/hora (2 alumnos). Aun así, os sale más económico por persona compartiéndola con pareja, amigo o familiar.',

  particularesPage_faqQ3: '¿Cuántos profesores hay por clase?',
  particularesPage_faqA3:
    'Hay 1 profesor por clase particular. En las clases premium de grupo reducido (3-6 personas) también hay 1 profesor, pero el enfoque sigue siendo mucho más personalizado que en clases regulares grupales de 15-20 alumnos.',

  particularesPage_faqQ4:
    'Mi horario es muy complicado, ¿puedo cambiar cada semana el horario de la clase?',
  particularesPage_faqA4:
    'Sí, totalmente. Las clases particulares están diseñadas para adaptarse a horarios cambiantes: turnos laborales, viajes frecuentes, agendas variables. Simplemente coordina con tu profesor y recepción con antelación para agendar cada clase en el horario que mejor te convenga esa semana. Flexibilidad total.',

  particularesPage_faqQ5:
    'Mi privacidad es muy importante, ¿las clases son abiertas a otras personas?',
  particularesPage_faqA5:
    'No. Las clases particulares son 100% privadas. Solo estarás tú (o tú + 1 acompañante si lo deseas), el profesor y nadie más. Nadie observa, nadie interrumpe. Privacidad total garantizada. Ideal si prefieres aprender sin presión social o miradas externas.',

  particularesPage_faqQ6:
    'No puedo acercarme a la escuela, ¿existe opción de hacer las clases online?',
  particularesPage_faqA6:
    'Sí. Ofrecemos clases particulares online vía Zoom o Google Meet. Necesitarás espacio suficiente para moverte (mínimo 2x2 metros), conexión estable a internet y dispositivo con cámara. El profesor te corrige en tiempo real igual que en presencial. Perfectas si vives lejos, viajas frecuentemente o prefieres entrenar desde casa.',

  particularesPage_faqQ7: '¿Qué diferencia hay entre las clases online y presenciales?',
  particularesPage_faqA7:
    'Presencial: El profesor puede tocar y ajustar tu postura físicamente, correcciones más precisas, sensación de energía compartida, acceso a espejo de estudio. Online: Flexibilidad total de ubicación, ahorras desplazamiento, grabas fácilmente tu pantalla, entrenas desde casa. Ambas son igual de efectivas si te comprometes. Elige según tu preferencia y circunstancias.',

  // Final CTA
  particularesPage_finalCta_title: 'Tu Clase Particular de Baile Te Está Esperando',
  particularesPage_finalCta_subtitle:
    'No dejes pasar más tiempo. Cada semana que esperas es una semana menos bailando a tu ritmo.',
  particularesPage_finalCta_description:
    'Clases particulares de baile en Barcelona hechas a tu medida para avanzar de verdad y a tu ritmo. Trabajamos 100% enfocado en tus objetivos con el Método Farray®: salsa cubana, bachata, dancehall, hip hop, reggaeton, ballet clásico, danza contemporánea y más, de la mano de Yunaisy Farray (bailarina de Street Dance 2) y profesores con certificación y experiencia. Más de 8 años de experiencia en el corazón de Barcelona.',
  particularesPage_finalCta_button: 'Reservar Mi Clase Particular',
  particularesPage_finalCta_button_secondary: 'Consultar Disponibilidad',

  // What to Expect Section
  particularesPage_whatToExpect_title: '¿Qué Esperar de Tus Clases Particulares?',
  particularesPage_whatToExpect_p1:
    "En Farray's International Dance Center, nuestras clases particulares de baile están diseñadas para maximizar tu progreso en el menor tiempo posible. Cada sesión de 60 minutos es 100% personalizada: tu profesor dedica toda su atención a corregir tu técnica, adaptar el ritmo a tu nivel y enfocarse en tus objetivos específicos, ya sea dominar un estilo, prepararte para una actuación o simplemente ganar confianza en la pista.",
  particularesPage_whatToExpect_p2:
    'A diferencia de las clases grupales regulares donde el profesor debe dividir su atención entre 15-20 estudiantes, en las clases particulares tú eres el único foco. Esto significa que aprenderás de 3 a 4 veces más rápido: en una sola clase particular avanzas lo que normalmente te llevaría 3-4 clases grupales. Es la forma más eficiente de aprender a bailar, especialmente si tienes horarios complicados, objetivos ambiciosos o simplemente valoras tu tiempo.',
  particularesPage_whatToExpect_p3:
    'Nuestros profesores están altamente cualificados en más de 25 estilos de baile: desde Salsa Cubana, Bachata y Kizomba hasta Hip Hop, Dancehall, Contemporary y Ballet. Puedes elegir enfocarte en un solo estilo o combinar varios según tus intereses. Además, ofrecemos total flexibilidad: elige horarios que se adapten a tu agenda (mañanas, tardes, fines de semana), graba tus clases para repasar en casa, y decide si prefieres clases presenciales en nuestro centro de Barcelona, online vía Zoom, o incluso a domicilio.',

  // Redesigned Benefits Section
  particularesPage_benefitsTitle: '¿Por Qué Elegir Clases Particulares de Baile?',
  ...
  particularesPage_whyChoose_p2:
    'Además, somos el único centro de baile en Barcelona acreditado por el CID-UNESCO (International Dance Council), lo que garantiza estándares de enseñanza de nivel mundial. Nuestras instalaciones cuentan con salas equipadas con espejos profesionales, suelos de madera especializados para danza, sistemas de audio de alta calidad y espacios climatizados para tu máximo confort.',
  particularesPage_whyChoose_p3:
    'Ya sea que busques prepararte para una audición, mejorar tu técnica, aprender coreografías complejas, o simplemente disfrutar del baile en un ambiente seguro y profesional, nuestras clases particulares están diseñadas para ayudarte a alcanzar tus objetivos específicos. Flexibilidad total, resultados comprobados, y la experiencia de aprender con los mejores profesionales de Barcelona.',

  // Redesigned Packs Section
  particularesPage_packsTitle: 'Nuestros Niveles de Profesores',
  particularesPage_packsSubtitle:
    'Elige el nivel de profesor que mejor se adapte a tus objetivos y presupuesto. Precios competitivos con total transparencia.',

  particularesPage_pack_regular_title: 'Profesor Regular',
  particularesPage_pack_regular_desc:
    'Profesores cualificados con sólida experiencia en enseñanza. Perfectos para principiantes y nivel intermedio.',
  particularesPage_pack_regular_feature1: 'Desde 65€/hora (1 alumno)',
  particularesPage_pack_regular_feature2: 'Desde 80€/hora (2 alumnos)',
  particularesPage_pack_regular_feature3: 'Dominio de estilos principales',
  particularesPage_pack_regular_feature4: 'Bonos disponibles con descuento',
  particularesPage_pack_regular_feature5: 'Enseñanza adaptada a tu nivel',

  particularesPage_pack_premium_title: 'Profesor Premium',
  particularesPage_pack_premium_desc:
    'Profesores de élite: bailarines profesionales activos con carreras internacionales. Para quienes buscan excelencia y máximo nivel técnico.',
  particularesPage_pack_premium_feature1: 'Desde 75€/hora (1 alumno)',
  particularesPage_pack_premium_feature2: 'Desde 100€/hora (2 alumnos)',
  particularesPage_pack_premium_feature3: 'Trayectoria internacional demostrable',
  particularesPage_pack_premium_feature4: 'Dominio avanzado de múltiples estilos',
  particularesPage_pack_premium_feature5: 'Preparación para audiciones y competencias',

  // Buttons
  particularesPage_contactButton: 'Contactar',

  // Placeholders
  particularesPage_imagePlaceholder: '[Imagen: Clase particular de baile]',

  // Stats Section
  particularesPage_stats_title: 'Nuestro Impacto en Números',
  particularesPage_stat1_value: '1500+',
  particularesPage_stat1_label: 'Estudiantes activos',
  particularesPage_stat2_value: '25+',
  particularesPage_stat2_label: 'Estilos de baile',
  particularesPage_stat3_value: '8 años',
  particularesPage_stat3_label: 'De experiencia',
  particularesPage_stat4_value: '3x',
  particularesPage_stat4_label: 'Más rápido que clases grupales',

  // FAQ Section - New Title
  particularesPage_faqTitle: 'Preguntas Frecuentes sobre Clases Particulares de Baile',
  ...
  faq_category_cuenta_title: 'Gestión de Cuenta y Pagos',
  faq_category_otras_title: 'Otras Cuestiones',

  // FAQ - Reservas/Altas
  faq_reservas_1_q: '¿Cómo me doy de alta si es la primera vez?',
  faq_reservas_1_a:
    '<p>Si es la primera vez que te registras en la academia, para comprar suscripciones o paquetes de clases, entra en el enlace de nuestra web <a href="https://www.farrayscenter.com/alta" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">www.farrayscenter.com/alta</a> y sigue los pasos.</p><p class="mt-3">Si ya eres estudiante o ya tienes cuenta en Momence con nosotros, debes iniciar sesión en tu cuenta de cliente de Momence en este enlace: <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a> &gt; luego haz clic encima del logo de Farray\'s, donde se te abrirá la pestaña de registro rápido para que puedas realizar la compra. Localiza el artículo a comprar en "Selecciona Una De Las Siguientes Opciones" y sigue los pasos para comprarlo.</p>',

  faq_reservas_2_q: '¿Dónde puedo descargar la aplicación de Momence?',
  faq_reservas_2_a:
    '<p>Puedes descargar la aplicación móvil pulsando en el enlace correspondiente al sistema operativo de tu móvil:</p><ul class="mt-2 ml-6 space-y-1"><li><strong>Apple:</strong> <a href="https://apps.apple.com/us/app/momence/id1577856009" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para iOS</a></li><li><strong>Android:</strong> <a href="https://play.google.com/store/apps/details?id=com.ribbon.mobileApp&hl=en_SG&pli=1" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para Android</a></li></ul><p class="mt-3">Si prefieres acceder desde el ordenador, puedes hacerlo a través del siguiente enlace: <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a></p><p class="mt-3">Si es la primera vez que te registras, date de alta aquí: <a href="https://www.farrayscenter.com/alta" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">www.farrayscenter.com/alta</a></p>',

  faq_reservas_3_q: '¿Hay que hacer "Check-in" en la academia?',
  faq_reservas_3_a:
    '<p>A partir de Octubre, todos los estudiantes tendrán que hacer "check-in" en recepción y luego, dentro de cada sala, los profesores pasarán lista. Por lo tanto es obligatorio que todos los estudiantes tengan sus reservas gestionadas de manera correcta para que todo funcione de manera correcta.</p><p class="mt-3">Para poder hacer el "check-in" se requerirá el uso de la aplicación de la academia.</p><p class="mt-3">Puedes descargar la aplicación móvil pulsando en el enlace correspondiente al sistema operativo de tu móvil:</p><ul class="mt-2 ml-6 space-y-1"><li><strong>Apple:</strong> <a href="https://apps.apple.com/us/app/momence/id1577856009" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para iOS</a></li><li><strong>Android:</strong> <a href="https://play.google.com/store/apps/details?id=com.ribbon.mobileApp&hl=en_SG&pli=1" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para Android</a></li></ul><p class="mt-3">Si es la primera vez que te registras en Farray\'s Center, date de alta aquí: <a href="https://www.farrayscenter.com/alta" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">www.farrayscenter.com/alta</a></p>',

  faq_reservas_4_q: '¿La reserva de las clases es obligatoria? ¿Quién debe gestionar las reservas?',
  faq_reservas_4_a:
    '<p>Por supuesto. Todas las cancelaciones y reservas deben ser administradas por cada estudiante a través de la aplicación móvil o del entorno de escritorio. Hemos invertido muchos recursos para configurar un sistema perfecto para que todos puedan hacerlo por su cuenta y no gestionamos reservas de forma manual, sea en recepción, por teléfono, email o whatsapp.</p><p class="mt-3">Nuestro objetivo es enfocarnos en daros una mejor atención al cliente, en vez de perder tiempo en engorrosos procesos administrativos que no contribuyen para el crecimiento de la academia.</p>',

  faq_reservas_5_q: '¿Cómo reservo las clases?',
  faq_reservas_5_a:
    '<p>Para reservar tus clases, primero debes abrir el al horario digital que podrás acceder de diferentes formas:</p><ol class="mt-2 ml-6 space-y-2"><li><strong>1.</strong> A través del siguiente enlace y luego localizar la clase que quieres reservar, pulsar en "Book Now" y luego hacer login arriba a la derecha: <a href="https://www.farrayscenter.com/horarios" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">www.farrayscenter.com/horarios</a></li><li><strong>2.</strong> Haciendo login en el siguiente enlace y a posteriori pulsar en el logo de Farray\'s Center y luego localizar la clase que quieres reservar y pulsar en "Book Now" y seguir los pasos: <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a></li><li><strong>3.</strong> Una vez que hayas realizado una compra con tu cuenta de Momence, te aparecerá Farray\'s Center en la aplicación móvil. Selecciona Farray\'s Center y luego verás la opción con el horario de las clases. Localiza tu clase y procede a reservar.</li></ol><p class="mt-3">Recuerda que si haces varios cursos, encuentra las diferentes clases y haz la correspondiente reserva.</p><p class="mt-3"><strong>PD.:</strong> Si tienes una membresía recuerda dejar seleccionada la opción "Auto-Reservar Series Completas". De esa forma solo tienes que entrar en la primera clase para reservar de forma recurrente para el futuro, sin tener que ir clase por clase.</p>',

  faq_reservas_6_q: '¿Si cancelo una clase, luego puedo recuperarla?',
  faq_reservas_6_a:
    '<p>Si tienes una membresía y cancelas una clase y luego quieres recuperarla, ten en cuenta que tienes <strong>30 DÍAS PARA HACERLO</strong>, contando desde la fecha de la clase cancelada.</p><p class="mt-3">Si tienes un abono de horas, eres tú quien gestionas tus clases de manera flexible y solamente debes cancelar tu clase y reservarla para otro día cuando así lo desees, antes que termine el periodo de caducidad.</p><p class="mt-3">Podrás recuperar clases siempre y cuando se respecten los siguientes puntos:</p><ol class="mt-2 ml-6 space-y-2"><li><strong>1.</strong> Debes ser tú quien gestione la cancelación de la clase desde tu cuenta en Momence (<a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a>) o desde la aplicación. Sí o Sí. Por favor, no escribas a la academia, no llames, no envíes un whatsapp, porque te invitaremos a que uses la plataforma de reservas. Se acabaron las reservas por whatsapp, teléfono o por email.</li><li><strong>2.</strong> Las clases se deben cancelar con una antelación mínima de 2 horas. Caso contrario el sistema registrará una cancelación tardía que es lo mismo que si hubieses hecho la clase, y no se te devuelve en ningún caso. Es importante que entiendas este punto, porque si no cancelas tu clase con el tiempo debido, no nos das oportunidad de suplir tu plaza con otra persona y eso no es sostenible para la academia.</li><li><strong>3.</strong> Una vez canceles la clase debes ser tú quien la reserve para otro día. Puedes elegir una clase diferente de la que haces habitualmente, respetando siempre el nivel del curso.</li></ol><p class="mt-3"><strong>IMPORTANTE A TENER EN CUENTA:</strong></p><ul class="mt-2 ml-6 space-y-1 list-disc"><li>Solo se pueden recuperar clases de forma puntual. Si empiezas a faltar de forma recurrente y a hacer un uso inadecuado del sistema, se te cancelará la suscripción mensual y se te invitará a comprar la tarifa de abonos de horas que permite tener la flexibilidad que necesites.</li><li>Ten en cuenta que el hecho de faltar una clase no exime de que el día de cobro correspondiente de cada mes sea el mismo.</li><li>Si faltas a una clase, ese crédito de clase quedará en tu cuenta y tienes 30 DÍAS PARA USARLO, caso contrario DESAPARECERÁ para siempre y NO SE DEVOLVERÁ en ningún caso.</li><li>En ningún caso se acumularán clases para los meses siguientes. Si no se usan los créditos de clase en el período debido, no se acumulan y desaparecerán.</li><li>Las clases se deben cancelar con una antelación mínima de 2 horas. Caso contrario el sistema registrará una cancelación tardía que es lo mismo que si hubieses hecho la clase, y no se te devuelve en ningún caso. Este punto sirve tanto para membresías como para abonos de horas.</li><li>Solo podrán recuperar clases los estudiantes con una membresía/abono activo en la escuela. Después de la fecha de fin de contrato no se permitirá recuperación de clases.</li></ul>',

  faq_reservas_7_q: '¿Cómo cancelo una clase desde el móvil o ordenador?',
  faq_reservas_7_a:
    '<p><strong>Desde el móvil:</strong> Inicia sesión en la aplicación. Verás inmediatamente tus próximas clases. Utiliza el botón rojo "Cancelar".</p><p class="mt-3"><strong>Desde el ordenador:</strong> Inicia sesión en tu cuenta (<a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a>). Verás inmediatamente tus próximas clases. Utiliza este menú desplegable para encontrar el botón "Cancelar".</p><p class="mt-3">Una vez hayas cancelado tu clase dentro del tiempo reglamentario (2 horas antes de empezar la clase), tendrás a tu disposición la clase para que la reserves para otro día. Te recordamos que tienes <strong>30 DÍAS</strong> para usar ese crédito de clase, contando desde la fecha de la clase cancelada.</p>',

  faq_reservas_8_q: '¿Cuánto tiempo tengo para recuperar una clase?',
  faq_reservas_8_a:
    '<p>Si tienes una membresía y vas a faltar a una clase, debes primero cancelarla para que ese crédito de clase se quede en tu cuenta y luego, tienes <strong>30 DÍAS PARA USARLO</strong> desde la fecha de la clase cancelada, caso contrario DESAPARECERÁ para siempre y NO SE DEVOLVERÁ en ningún caso.</p><p class="mt-3">En ningún caso se acumularán clases para los meses siguientes.</p>',

  faq_reservas_9_q:
    'Si cancelo clases y no las uso, ¿estas clases se me acumulan para otros meses?',
  faq_reservas_9_a:
    '<p>No. En ningún caso se acumularán clases para los meses siguientes. Si no se usan los créditos de clase en el período debido, no se acumulan y desaparecerán. Sin excepciones.</p>',

  faq_reservas_10_q: 'Tengo un pack de horas ¿Cómo sé cuántos créditos tengo?',
  faq_reservas_10_a:
    '<p><strong>Desde el ordenador:</strong> Haz clic en Membresías &gt; Mis membresías &gt; Créditos de dinero o Créditos de clase/cita.</p><p class="mt-3"><strong>Desde la App:</strong> Haz clic en Membresías &gt; Busca tu membresía. Al lado sale los créditos que tienes pendientes y su fecha de caducidad.</p>',

  faq_reservas_11_q: 'Tengo un abono de horas. ¿Qué caducidad tiene?',
  faq_reservas_11_a:
    '<p>Los abonos de horas tienen una caducidad de <strong>6 meses</strong> desde su activación que se efectúa solamente con la primera reserva que hagas. Puedes ver la fecha de caducidad de tu pack de horas entrando en la aplicación móvil de Momence, o desde el ordenador accediendo a tu cuenta aquí: <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a></p>',

  faq_reservas_12_q: '¿Si tengo una suscripción mensual, puedo cambiar de clase cada semana?',
  faq_reservas_12_a:
    '<p>No. Si tienes una suscripción mensual, debes venir cada semana a los cursos que tienes contratados. La única excepción en que puedes hacer clases diferentes a las cuales estás matriculad@, es por motivo de recuperación de alguna clase que hayas faltado de forma puntual.</p>',

  faq_reservas_13_q: '¿Si tengo un abono de horas, puedo cambiar de clase de manera libre?',
  faq_reservas_13_a:
    '<p>Sí. Si tienes un abono de horas podrás elegir hacer clases diferentes, sin compromiso, hasta un número total correspondiente al abono que has comprado, siempre respetando el periodo de expiración de tu abono.</p>',

  // FAQ - Gestión de Cuenta y Pagos
  faq_cuenta_1_q:
    'Actualmente soy estudiante. ¿Cómo accedo a mi cuenta y veo mis membresías/abonos?',
  faq_cuenta_1_a:
    '<p>Si todavía tienes membresías provenientes de la plataforma anterior Goteamup, usa el mismo correo electrónico en Momence que usaste en la plataforma anterior.</p><p class="mt-3">Desde <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a>, haz clic en "Forgot your password?" &gt; ingresa tu correo electrónico, haz clic en Reset Password, luego revisa tu bandeja de entrada de email &gt; haz clic en el enlace para crear la contraseña, envíala y luego dirígete a <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a> e inicia sesión.</p><p class="mt-3">Para ver información de membresía, haz clic en Mis membresías.</p><p class="mt-3">Puedes descargar la aplicación móvil aquí:</p><ul class="mt-2 ml-6 space-y-1"><li><strong>Apple:</strong> <a href="https://apps.apple.com/us/app/momence/id1577856009" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para iOS</a></li><li><strong>Android:</strong> <a href="https://play.google.com/store/apps/details?id=com.ribbon.mobileApp&hl=en_SG&pli=1" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para Android</a></li></ul>',

  faq_cuenta_2_q: 'No puedo iniciar sesión. ¿Qué hago?',
  faq_cuenta_2_a:
    '<p>Si anteriormente efectuaste un registro en nuestro sistema, desde <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a>, haz clic en "Forgot your password?" &gt; ingresa tu correo electrónico, haz clic en Reset Password, luego revisa tu bandeja de entrada de email &gt; haz clic en el enlace para crear la contraseña, envíala y luego dirígete a <a href="https://momence.com/sign-in?hostId=36148" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">https://momence.com/sign-in?hostId=36148</a> e inicia sesión.</p><p class="mt-3">Para ver información de membresía, haz clic en Mis membresías.</p><p class="mt-3">Puedes descargar la aplicación móvil aquí:</p><ul class="mt-2 ml-6 space-y-1"><li><strong>Apple:</strong> <a href="https://apps.apple.com/us/app/momence/id1577856009" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para iOS</a></li><li><strong>Android:</strong> <a href="https://play.google.com/store/apps/details?id=com.ribbon.mobileApp&hl=en_SG&pli=1" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Descargar para Android</a></li></ul><p class="mt-3">Si sigues sin poder hacer login contacta el equipo de soporte de momence <a href="mailto:support@momence.com" class="text-primary-accent hover:underline">support@momence.com</a> y explícales tu caso y de qué estudio se trata.</p>',

  faq_cuenta_3_q: '¿Cómo edito la información de pago de mi cuenta de cliente?',
  faq_cuenta_3_a:
    "<p>Inicia sesión en tu cuenta de cliente de Momence &gt; haz clic en 'Mi cuenta' en la parte inferior izquierda &gt; agrega y elimina métodos de pago.</p>",

  faq_cuenta_4_q: '¿Cómo agrego una nueva tarjeta o actualizo mi contraseña?',
  faq_cuenta_4_a:
    '<p>Después de iniciar sesión como cliente, haz clic en la pestaña "My account" en la parte inferior izquierda de tu Panel de cliente.</p><p class="mt-3">Desde esta página tendrás la oportunidad de:</p><ul class="mt-2 ml-6 space-y-1 list-disc"><li>Agregar una tarjeta de débito o crédito;</li><li>Actualizar tu contraseña.</li></ul>',

  faq_cuenta_5_q: '¿Cómo actualizo el nombre de mi cuenta, mi correo electrónico o contraseña?',
  faq_cuenta_5_a:
    '<p>Para actualizar cualquiera de los anteriores, inicia sesión como cliente y luego haz clic en tu nombre en la parte superior derecha. Selecciona la opción "Manage account".</p><p class="mt-3">Encontrarás campos para nombre y correo electrónico en la parte superior. Para restablecer o cambiar tu contraseña, desplázate hacia abajo.</p>',

  faq_cuenta_6_q:
    '¿Cómo subo una foto de perfil a mi cuenta de Momence a través de la aplicación móvil?',
  faq_cuenta_6_a:
    "<p>Como estudiante, para que te identifiquemos correctamente, debes usar tu aplicación móvil Momence para cargar tu fotografía tocando: 'Cuenta' (abajo a la derecha) &gt; Editar foto &gt; eligiendo una foto de la Biblioteca o tomando una.</p>",

  faq_cuenta_7_q: '¿Cómo cancelo mi suscripción mensual?',
  faq_cuenta_7_a:
    '<p>Para cancelar tu suscripción debes escribirnos al email <a href="mailto:info@farrayscenter.com" class="text-primary-accent hover:underline">info@farrayscenter.com</a>. Te enviaremos un formulario para que lo completes y listo.</p><p class="mt-3">Ten en cuenta para darse de baja hay que notificar por escrito con una antelación mínima de 15 días. Si no se respeta este plazo se pasará igualmente a cobro el siguiente recibo. Sin excepciones.</p>',

  faq_cuenta_8_q:
    '¿Con cuánto tiempo de antelación debo notificar a la academia si me quiero dar de baja?',
  faq_cuenta_8_a:
    '<p>Para darse de baja y evitar el siguiente cobro, hay que notificar por escrito al email <a href="mailto:info@farrayscenter.com" class="text-primary-accent hover:underline">info@farrayscenter.com</a>, con una antelación mínima de 15 días.</p><p class="mt-3">Si no se respeta este plazo se pasará igualmente a cobro el siguiente recibo. Sin excepciones.</p>',

  faq_cuenta_9_q: '¿Puedo pausar/suspender mi suscripción mensual?',
  faq_cuenta_9_a:
    '<p>Para suspender tu suscripción debes escribirnos al email <a href="mailto:info@farrayscenter.com" class="text-primary-accent hover:underline">info@farrayscenter.com</a> y te lo gestionamos. Coste de manutención de matrícula: 15 euros mensuales.</p><p class="mt-3">Por favor, ten en cuenta que aunque nos pidas que te pausemos la suscripción, hay que notificar por escrito con una antelación mínima de 15 días. Si no se respeta este plazo se pasará igualmente a cobro el siguiente recibo. Sin excepciones.</p><p class="mt-3">En estos casos, excepcionalmente, usaremos la mensualidad que se cobra para sustituir el pago de la mensualidad correspondiente al mes en que te vas a incorporar de nuevo a las clases.</p>',
  ...
  faq_otras_5_q: '¿Tenéis coste de matrícula?',
  faq_otras_5_a:
    '<p>Sí, tenemos una matrícula de 60 euros el primer año. Para los años posteriores, el precio de la matrícula para los estudiantes es de 20 euros y se cobrará de forma automática el 1 de agosto de cada año.</p><p class="mt-3">Esa cuota reducida de 20 euros, solo se mantiene, siempre y cuando el estudiante esté dado de alta de forma continuada, a lo largo de los años.</p>',

  faq_otras_6_q: '¿Puedo hacer clases de prueba?',
  faq_otras_6_a:
    '<p>Sí. Las reservas de las clases de prueba se deben hacer por internet a través de nuestra plataforma digital de reservas o a través de la aplicación móvil. Verás que es muy fácil, rápido y cómodo. Te tardará menos de un minuto en reservar una clase.</p>',
  ...
  serviciosBaile_metaDescription:
    "Servicios de baile en Barcelona: alquiler de salas, clases particulares, eventos corporativos, estudio de grabación y más. Farray's International Dance Center.",
  serviciosBaile_breadcrumb_home: 'Inicio',
  serviciosBaile_breadcrumb_current: 'Servicios de Baile',
  serviciosBaile_h1: 'Servicios de Baile en Barcelona',
  serviciosBaile_intro:
    "Descubre todos los servicios que Farray's International Dance Center tiene para ti. Desde alquiler de salas hasta clases particulares, eventos corporativos y mucho más.",
  serviciosBaile_services_title: 'Nuestros Servicios',
  serviciosBaile_services_subtitle:
    'Encuentra el servicio perfecto que se adapte a tus necesidades',
  serviciosBaile_finalCTA_title: '¿Listo para comenzar?',
  ...
  estudioGrabacion_cta_secondary: 'Ver Salas Disponibles',

  // Problem Section
  estudioGrabacion_problem_title: '¿Cansado de Estudios Genéricos y Espacios Sin Personalidad?',
  estudioGrabacion_problem_p1:
    'Buscar un estudio de grabación o un espacio para fotografía en Barcelona puede ser un dolor de cabeza: precios inflados, instalaciones pequeñas, mala iluminación, sonido mediocre y cero flexibilidad para personalizar tu proyecto.',
  estudioGrabacion_problem_p2:
    'Muchos estudios te limitan con reglas rígidas, horarios imposibles y espacios sin alma. Tu creatividad se ahoga antes de empezar. Necesitas un lugar donde tu visión artística pueda fluir sin obstáculos.',
  estudioGrabacion_problem_p3:
    "En Farray's International Dance Center, transformamos esa frustración en posibilidad.",

  // Solution Section
  estudioGrabacion_solution_title: 'Un Espacio Diseñado para Tu Creatividad',
  estudioGrabacion_solution_subtitle:
    'Todo lo que necesitas para producir contenido de nivel profesional',

  estudioGrabacion_service1_title: 'Videoclips y Reels',
  estudioGrabacion_service1_desc:
    'Graba videoclips musicales, reels de Instagram/TikTok y contenido viral con espacios amplios, espejos profesionales y fondos versátiles.',
  estudioGrabacion_service2_title: 'Producciones Audiovisuales',
  ...
  estudioGrabacion_service5_title: 'Contenido para Redes Sociales',
  estudioGrabacion_service5_desc:
    'Crea contenido de alto impacto para tus redes sociales: tutoriales, challenges, colaboraciones y campañas con la calidad que tus seguidores merecen.',
  estudioGrabacion_service6_title: 'Proyectos Artísticos',
  estudioGrabacion_service6_desc:
    'Dale vida a tus proyectos creativos más ambiciosos: cortometrajes, performances grabadas, videoarte y cualquier idea que tengas en mente.',

  // Stats Section
  estudioGrabacion_stats_title: 'Números que Hablan por Sí Solos',
  estudioGrabacion_stat1_label: 'metros cuadrados de espacio profesional',
  estudioGrabacion_stat2_label: 'salas completamente equipadas',
  estudioGrabacion_stat3_label: 'producciones realizadas',
  ...
  estudioGrabacion_benefit6_title: 'Precios Competitivos',
  estudioGrabacion_benefit6_desc:
    'Tarifas transparentes sin costes ocultos. Descuentos para reservas recurrentes, packs de horas y proyectos de larga duración.',

  // Equipment Section
  estudioGrabacion_equipment_title: 'Equipamiento Profesional Incluido',
  estudioGrabacion_equipment_subtitle: 'Todo lo que necesitas para una producción de calidad',

  estudioGrabacion_equipment_item1: 'Sistema de sonido profesional',
  estudioGrabacion_equipment_item2: 'Espejos de pared completa en todas las salas',
  estudioGrabacion_equipment_item3: 'Suelos de madera flotante y linóleo profesional',
  estudioGrabacion_equipment_item4: 'Iluminación LED regulable y focos direccionales',
  estudioGrabacion_equipment_item5: 'Aire acondicionado en todas las salas',
  estudioGrabacion_equipment_item6: 'WiFi de alta velocidad (fibra óptica 600MB)',
  estudioGrabacion_equipment_item7: 'Vestuarios y zonas de maquillaje',
  estudioGrabacion_equipment_item8: 'Almacenamiento temporal de equipos',
  estudioGrabacion_equipment_item9: 'Posibilidad de oscurecer completamente las salas',
  estudioGrabacion_equipment_item10: 'Acceso a zonas comunes y sala de espera',

  // Ideal For Section
  estudioGrabacion_idealFor_title: 'Ideal Para',
  estudioGrabacion_idealFor_item1: 'Artistas y Músicos',
  estudioGrabacion_idealFor_item2: 'Influencers y Creadores',
  estudioGrabacion_idealFor_item3: 'Marcas y Agencias',
  estudioGrabacion_idealFor_item4: 'Fotógrafos Profesionales',
  estudioGrabacion_idealFor_item5: 'Productoras Audiovisuales',
  estudioGrabacion_idealFor_item6: 'Bailarines y Coreógrafos',
  estudioGrabacion_idealFor_item7: 'Diseñadores de Moda',
  estudioGrabacion_idealFor_item8: 'Proyectos Independientes',

  // Process Section
  estudioGrabacion_process_title: 'Cómo Funciona',
  estudioGrabacion_process_subtitle: 'Reservar tu espacio es rápido y sencillo',

  estudioGrabacion_process_step1_title: 'Contáctanos',
  estudioGrabacion_process_step1_desc:
    'Envíanos un mensaje contándonos tu proyecto: tipo de producción, fecha, duración y necesidades especiales. Te respondemos en menos de 24 horas.',
  estudioGrabacion_process_step2_title: 'Planificamos Juntos',
  estudioGrabacion_process_step2_desc:
    'Revisamos tu proyecto y te recomendamos la sala ideal. Hablamos de horarios, equipamiento adicional y cualquier detalle técnico que necesites.',
  estudioGrabacion_process_step3_title: 'Reserva y Confirma',
  estudioGrabacion_process_step3_desc:
    'Confirmamos disponibilidad, cerramos presupuesto y bloqueamos tu fecha. Recibirás toda la información de acceso y contacto del equipo de soporte.',
  estudioGrabacion_process_step4_title: 'Crea Sin Límites',
  estudioGrabacion_process_step4_desc:
    'Llega, monta tu equipo y empieza a crear. Nuestro equipo estará disponible si necesitas ayuda técnica o algún ajuste durante la sesión.',

  // FAQ Section
  estudioGrabacion_faq_title: 'Preguntas Frecuentes',
  estudioGrabacion_faq_subtitle: 'Respuestas a las dudas más comunes sobre alquiler de estudio',

  estudioGrabacion_faq1_q: '¿Cuánto cuesta alquilar el estudio?',
  estudioGrabacion_faq1_a:
    'Los precios varían según la sala y el tipo de uso (ensayo, clase, grabación, evento). Las tarifas van desde 14€/hora hasta 50€/hora. Contáctanos para un presupuesto personalizado y descuentos por packs de horas.',
  ...
  estudioGrabacion_faq5_q: '¿Cuánto tiempo de antelación necesito para reservar?',
  estudioGrabacion_faq5_a:
    'Recomendamos reservar con al menos 1 semana de antelación para asegurar disponibilidad, especialmente en fines de semana. Para proyectos urgentes, contáctanos y haremos lo posible por acomodarte.',
  estudioGrabacion_faq6_q: '¿Hay parking cerca del estudio?',
  estudioGrabacion_faq6_a:
    'Sí, estamos en el corazón de Barcelona entre Plaza España y Sants. Hay parking público a 2 minutos caminando y excelentes conexiones de metro (Entença, Rocafort) y tren (Sants).',
  ...
  estudioGrabacion_finalCTA_subtitle:
    'Deja de conformarte con estudios mediocres. Alquila un espacio donde tu creatividad puede brillar sin límites.',
  estudioGrabacion_finalCTA_button_primary: 'Solicitar Presupuesto',
  estudioGrabacion_finalCTA_button_secondary: 'Ver Salas Disponibles',

  // Room Rental Page
  roomRental_pageTitle:
    "Alquiler de Salas de Baile en Barcelona | Farray's International Dance Center",
  roomRental_metaDescription:
    'Alquila salas de baile en Barcelona totalmente equipadas, en el corazón de la ciudad, entre Plaza España y Sants. Espacios profesionales para ensayos, clases, workshops, castings, rodajes y eventos.',
  roomRental_hero_title: 'Alquiler de Salas de Baile en Barcelona',
  roomRental_hero_subtitle:
    'Alquila salas de baile en Barcelona totalmente equipadas, en el corazón de la ciudad, entre Plaza España y Sants. Espacios profesionales para ensayos, clases, workshops, castings, rodajes y eventos, con suelos específicos de danza, sonido y opción de retransmisión online.',
  roomRental_hero_cta_primary: 'Solicitar Presupuesto',
  roomRental_hero_cta_secondary: 'Ver Salas Disponibles',
  ...
  roomRental_forWhom_footer:
    'Si necesitas un espacio de baile en Barcelona con buena imagen para tu marca, aquí encaja.',
  ...
  roomRental_whyFarrays_footer:
    'Trato cercano, humano y organizado. No solo alquilas una sala: te conectas con un centro de referencia en danza y baile en Barcelona.',
  ...
  roomRental_room1_weekday_classes: 'Clases',
  ...
  roomRental_cta_title: '¿Quieres Alquilar una Sala de Baile en Barcelona?',
  ...
  roomRental_cta_contact: 'Contactar Ahora',
  ...
  roomRental_whyFarrays_footer2:
    'No solo alquilas una sala; te conectas con un centro de referencia en danza y baile en Barcelona.',
  ...
  roomRental_discounts_explain:
    'Cuéntanos qué necesitas (día, horario, tipo de actividad, número de personas) y te preparamos un presupuesto a medida.',
  roomRental_cta_custom_quote: 'Solicitar presupuesto a medida',
  ...
  facilitiesRoom1Desc:
    'Nuestra sala más grande, ideal para clases numerosas, ensayos de compañías, workshops internacionales y eventos especiales. Capacidad para más de 40 bailarines.',
  ...
  facilitiesRoom2Desc:
    'Diseñada específicamente para ballet, danza contemporánea y danza moderna. Equipada con barras de ballet a lo largo de toda la sala y espejos de pared completa.',
  ...
  twerkFaqQ1: '¿Cómo funcionan nuestras clases de Twerk y Twerking en Barcelona?',
  twerkFaqA1:
    'En nuestras clases de Twerk en Barcelona cada sesión dura 1 hora e incluye: Calentamiento (preparación del cuerpo con ejercicios específicos para glúteos y caderas), Técnica de Twerking (aislamientos, vibraciones, bounces y trabajo de suelo) y Coreografía (secuencias dinámicas que combinan movimientos tradicionales de Twerk dance con tu propio estilo).',
  twerkFaqQ2: '¿Puedo empezar desde cero si nunca he bailado Twerk?',
  twerkFaqA2:
    'Claro. Los alumnos que nunca han hecho Twerking antes eligen los cursos de nivel principiante y quienes tienen algo de experiencia en algún tipo de baile eligen el nivel básico. Nuestras clases de Twerk están diseñadas para que cualquiera pueda seguir el ritmo desde el primer día.',
  twerkFaqQ3: '¿Qué pasa si no tengo buena coordinación para el Twerking?',
  twerkFaqA3:
    'No te preocupes, la coordinación se desarrolla con la práctica. Nuestras profesoras de Twerk te guiarán paso a paso y el ambiente es muy acogedor. Lo importante es ser constante y disfrutar del proceso de aprender a bailar Twerk.',
  twerkFaqQ4: '¿Qué necesito traer para las clases de Twerk en Barcelona?',
  twerkFaqA4:
    'Ropa cómoda y ligera que permita moverte con libertad (shorts, mallas, top deportivo), zapatillas limpias de uso exclusivo dentro del estudio, toalla y agua, porque bailarás Twerking intensamente y necesitas hidratarte.',
  twerkFaqQ5: '¿Qué niveles de Twerk tenemos en nuestra escuela de Barcelona?',
  twerkFaqA5:
    'Principiantes: Para empezar a bailar Twerk desde cero, aprender paso a paso y con buen ambiente. Básico: Para quienes ya tienen algo de experiencia en Twerking u otras danzas urbanas. Intermedio: Para mejorar técnica de Twerk, coordinación y musicalidad con movimientos más complejos.',
  twerkFaqQ6: '¿Puedo unirme a las clases de Twerk en cualquier momento del año?',
  twerkFaqA6:
    'Sí. Puedes empezar a bailar Twerk cuando quieras. Consulta nuestro calendario para ver las próximas clases de Twerking disponibles. Si tienes dudas sobre el nivel o el grupo, escríbenos y te orientamos.',
  twerkFaqQ7: '¿Tenéis algún descuento especial para clases de Twerk?',
  twerkFaqA7:
  ...
  twerkFaqQ10: 'Si falto a una clase de Twerk, ¿puedo recuperarla haciendo otro estilo?',
  twerkFaqA10:
    'Puedes recuperarla haciendo la misma clase de Twerking otro día o seleccionar otro estilo de baile, siempre que respetes el nivel de la clase y gestiones la recuperación desde la aplicación de la escuela.',
  twerkFaqQ11: '¿Organizáis eventos o talleres especiales de Twerk?',
  twerkFaqA11:
    'Sí. Organizamos talleres de Twerk dance, masterclasses de Twerking y eventos sociales durante el año. Síguenos en redes o consulta la web para estar al día de nuestras actividades de baile.',
  twerkFaqQ12: '¿Las clases de Twerk son solo para mujeres o también para hombres?',
  twerkFaqA12:
    'Nuestras clases de Twerking están abiertas a todas las personas, sin importar el género o la experiencia previa. El Twerk dance es para todos.',
  twerkFaqQ13: '¿El Twerk es un buen ejercicio físico?',
  twerkFaqA13:
  ...
  // What Is Section
  twerkWhatIsTitle: '¿Qué es el Twerk y por qué está arrasando en Barcelona?',
  twerkWhatIsP1:
    'El Twerk es mucho más que un baile viral de redes sociales. Es un estilo de danza urbana que nació en Nueva Orleans, fusionando ritmos africanos, bounce music y cultura hip hop. Un movimiento que celebra el cuerpo, la confianza y la libertad de expresión.',
  twerkWhatIsP2:
  ...
  twerkIdentify1: 'Quieres ponerte en forma pero el gimnasio te aburre mortalmente',
  twerkIdentify2: 'Buscas una actividad donde puedas liberar el estrés y sentirte poderosa',
  twerkIdentify3: 'Te encanta la música urbana y quieres bailar sin complejos',
  twerkIdentify4: 'Quieres mejorar tu autoestima y conexión con tu cuerpo',
  twerkIdentify5: 'Necesitas un espacio donde nadie te juzgue y puedas ser tú misma',
  twerkIdentify6: 'Buscas una comunidad de mujeres que te apoyen y te inspiren',
  twerkIdentifyTransition: 'Si has dicho "sí" a alguno de estos puntos, ya sabes lo que necesitas.',
  twerkNeedEnrollTitle: 'Necesitas apuntarte a clases de Twerk en una academia de baile',
  ...
  // Transform Section
  twerkTransformTitle: 'Imagina tu antes y después',
  twerkTransform1Title: 'Vuelves a tener energía y ganas',
  twerkTransform1Desc: 'Las clases te sacan de la rutina y te devuelven la vida.',
  twerkTransform2Title: 'Ganas seguridad sin darte cuenta',
  twerkTransform2Desc: 'Te sueltas, te liberas y empiezas a gustarte más.',
  twerkTransform3Title: 'Te pones en forma sin aburrirte',
  twerkTransform3Desc:
    'Cada clase es distinta. Te diviertes mientras fortaleces tus glúteos y caderas.',
  twerkTransform4Title: 'Conoces gente real',
  twerkTransform4Desc: 'Nada forzado: buen rollo, comunidad y gente como tú.',
  twerkTransform5Title: 'Conectas con la música urbana',
  ...
  twerkWhyChoose1Desc:
    'Dirigida por Yunaisy Farray, actriz de Street Dance 2 y una de las maestras más reconocidas del mundo.',
  twerkWhyChoose2Title: 'Ubicación inmejorable',
  twerkWhyChoose2Desc:
    'Calle Entença 100, entre Plaza España y Sants, a 5 minutos de Plaça Espanya y Sants. Metro, buses y tren a la puerta. Fácil llegar. Fácil volver.',
  twerkWhyChoose3Title: 'Ambiente familiar, con la profesionalidad que necesitas',
  twerkWhyChoose3Desc:
    'Cercano, inclusivo y sin juicios ni comparaciones, pero con la profesionalidad que necesitas para evolucionar de verdad.',
  twerkWhyChoose4Title: 'Instalaciones preparadas de verdad',
  twerkWhyChoose4Desc:
    'Más de 700 m², salas amplias, espejos, sonido profesional, aire acondicionado y ventilación centralizada para entrenar a gusto todo el año.',
  twerkWhyChoose5Title: 'Academia multidisciplinar',
  twerkWhyChoose5Desc:
    'Más de 25 estilos para que nunca te aburras y puedas crecer a tu ritmo: urbanos, bailes latinos, contemporáneo, técnica, estiramiento y mucho más.',
  twerkWhyChoose6Title: 'Gala anual + workshops potentes',
  twerkWhyChoose6Desc:
    'Brilla en un teatro profesional, participa en workshops internacionales y vive experiencias que no encontrarás en ninguna otra escuela.',
  twerkWhyChoose7Title: 'Profesoras especializadas en Twerk',
  twerkWhyChoose7Desc:
  ...
  // Schedule Section
  twerkScheduleTitle: 'Horarios de nuestras clases de Twerk',
  twerkScheduleSubtitle: 'Tres niveles para que encuentres tu clase perfecta',
  ...
  twerkWhyTodayFullTitle:
    '¿Por qué hoy es el mejor momento para empezar a bailar Twerk con nosotros?',
  twerkWhyToday1:
    'Porque sigues esperando "el momento perfecto" pero lo único perfecto es empezar hoy.',
  twerkWhyToday2:
    'Porque estás a tan solo UNA clase de cambiar tu rutina y sentirte mejor que ayer.',
  twerkWhyToday3: 'Porque esto no va de bailar bien, sino de sentirte bien bailando.',
  twerkWhyTodayClosing1: "En Farray's no vendemos clases. Creamos experiencias.",
  twerkWhyTodayClosing2:
    'Te esperamos con música cañera, profesores con carisma y una energía única en Barcelona.',

  // Final CTA Section
  twerkFinalCTATitle: 'Únete a la comunidad de Twerk más activa de Barcelona',
  twerkFinalCTASubtitle: 'Da el paso.',
  twerkFinalCTADesc: 'Reserva tu plaza ahora y no dejes que te lo cuenten… ni que te lo bailen.',
  twerkFinalCTAFunny: 'Las plazas vuelan más rápido que un "Booty Pop" en viernes por la noche.',

  // FAQ Title
  twerkFaqTitle: 'Preguntas Frecuentes sobre el Twerking Dance en Barcelona',

  // ===== Prepara tu Primera Clase de Twerk =====
  ...
  // Hero
  afroHeroTitle: 'Clases de Afrobeats y Afrodance en Barcelona',
  afroHeroSubtitle: 'Disfruta de los ritmos africanos más divertidos del momento',
  afroHeroDesc: 'África se mueve, ¿te mueves con ella?',
  afroHeroLocation:
    'Viaja a África sin salir de Barcelona | Clases de Afrobeats y Afrodance desde iniciación hasta intermedio, entre Plaza España y Sants',
  ...
  // What is Afrobeats
  afroWhatIsTitle: '¿Por qué está arrasando el Afrobeats en Barcelona?',
  afroWhatIsP1:
    'El Afrobeats es mucho más que un estilo musical: es el latido contemporáneo de África, una explosión de energía y creatividad que fusiona la herencia africana con sonidos globales.',
  afroWhatIsP2:
    'Nacido en Nigeria y Ghana a finales de los años 90, el Afrobeats recoge la esencia de ritmos tradicionales africanos como el highlife y la música yoruba, y los mezcla con influencias de funk, hip hop, dancehall, electrónica y pop internacional.',
  afroWhatIsP3:
    'Bailar Afrobeats es sumergirse en una cultura apasionante y en constante evolución, donde la tradición y la modernidad están en continua interacción.',
  afroWhatIsP4:
    'Cada paso, cada gesto, es una celebración de la identidad africana, de la libertad de expresión y de la alegría de vivir.',
  afroWhatIsP4Highlight:
    'En Afrobeats no hay reglas estrictas: lo importante es sentir la música, conectar con el «groove» y dejar que tu cuerpo hable por ti.',
  afroWhatIsP5:
    'El fenómeno Afrobeats ha conquistado el mundo, inspirando a millones de personas y creando una comunidad global unida por la pasión por la música y la danza africanas. Y Barcelona se ha convertido en uno de los focos de Afrobeats más activos de Europa.',
  afroWhatIsQuestionTitle: '¿Te preguntas si es para ti?',
  afroWhatIsQuestionAnswer: 'Sí, lo es.',
...
**Farray's International Dance Center ofrece clases de Afrobeats en una escuela valorada cerca del 5/5 en Google con cientos de reseñas positivas.**`,
  ...
  afroIdentify1:
    'Estás tan harto/a de la rutina que ya ni el café te quiere. Necesitas algo que te despierte YA.',
  afroIdentify2:
    'Buscas una forma de expresarte y conectar con tu cuerpo de manera diferente y divertida.',
  afroIdentify3:
    'Odias el gimnasio... y el gimnasio también te odia. No os soportáis. Nunca fue amor.',
  afroIdentify4:
    'Te hace falta conocer gente real, buen rollo, risas y un lugar donde ser tú sin filtros ni postureos.',
  afroIdentify5:
    'Sientes que la música y la esencia africana te mueve por dentro pero nunca has tenido la oportunidad de aprender a bailarla.',
  afroIdentify6:
    'Te encanta bailar, pero necesitas más flow, más actitud y menos coreografías de robot sin batería.',
  ...
  // Transformation
  afroTransformTitle: 'Imagina tu antes y después',
  afroTransform1Title: 'Vuelves a tener energía y ganas',
  afroTransform1Desc: 'Las clases te sacan de la rutina y te devuelven la vida.',
  afroTransform2Title: 'Ganas seguridad sin darte cuenta',
  afroTransform2Desc: 'Te sueltas, te liberas y empiezas a gustarte más.',
  afroTransform3Title: 'Te pones en forma sin aburrirte',
  afroTransform3Desc: 'Cada clase es distinta. Te ríes, sudas y disfrutas.',
  afroTransform4Title: 'Conoces gente real',
  afroTransform4Desc: 'Nada forzado: buen rollo, comunidad y gente como tú.',
  afroTransform5Title: 'Viajas a África sin salir de Barcelona',
  afroTransform5Desc: 'Ritmo, energía y esencia africana real en cada clase.',
  ...
  afroWhyChoose1Desc:
    'Dirigida por Yunaisy Farray, actriz de Street Dance 2 y una de las maestras más reconocidas del mundo.',
  afroWhyChoose2Title: 'Profesores con raíces africanas',
  afroWhyChoose2Desc:
    'Nuestros profesores de Afrobeats vienen de Tanzania y Cuba, trayendo autenticidad y conocimiento cultural profundo a cada clase.',
  afroWhyChoose3Title: 'Ubicación inmejorable',
  afroWhyChoose3Desc:
    'Calle Entença 100, entre Plaza España y Sants, a 5 minutos de Plaça Espanya y Sants. Metro, buses y tren a la puerta. Fácil llegar. Fácil volver.',
  afroWhyChoose4Title: 'Ambiente familiar, con la profesionalidad que necesitas',
  afroWhyChoose4Desc:
    'Aquí no eres un número. Te conocemos, te cuidamos y te acompañamos en cada paso de tu evolución.',
  afroWhyChoose5Title: 'Instalaciones preparadas de verdad',
  afroWhyChoose5Desc:
    'Más de 700 m², salas amplias, espejos, sonido profesional, aire acondicionado y ventilación centralizada para entrenar a gusto todo el año.',
  afroWhyChoose6Title: 'Academia multidisciplinar',
  afroWhyChoose6Desc:
    'Además de Afrobeats, ofrecemos más de 25 estilos. Puedes complementar tu formación con Dancehall, Hip Hop, Salsa, Bachata y mucho más.',
  afroWhyChoose7Title: 'Gala anual + workshops potentes',
  afroWhyChoose7Desc:
  ...
  afroTeacher2Specialty: '+5 años como experto en Afrobeats y Danzas Africanas',
  afroTeacher2Bio:
    'Charlie Breezy, maestro internacional y bailarín cubano. Nació en un país donde la cultura africana está totalmente arraigada. Formado en la ENA (Escuela Nacional de Arte de Cuba), Charlie es un bailarín polifacético que, además de dominar diferentes estilos de danza africana, destaca en contemporáneo, ballet y un amplio abanico de danzas urbanas.',
  afroTeachersClosing:
    'Nuestros profesores no solo enseñan pasos: transmiten cultura, historia y pasión por el Afrodance.',

  // Schedule
  afroScheduleTitle: 'Horarios de nuestras clases de Afrobeats',
  afroScheduleSubtitle: 'Clases disponibles varias veces por semana',

  // Video
  afroVideoTitle: 'Mira cómo bailamos Afrobeats y Afrodance',
  afroVideoDesc:
    'Descubre la energía y el ritmo de nuestras clases de Afrobeats y Afrodance en Barcelona',

  // Why Today
  afroWhyTodayFullTitle: '¿Por qué hoy es el mejor momento para empezar a bailar Afrobeats?',
  afroWhyToday1:
    'Porque sigues esperando "el momento perfecto" pero lo único perfecto es empezar hoy.',
  afroWhyToday2:
    'Porque estás a tan solo UNA clase de cambiar tu rutina y sentirte mejor que ayer.',
  afroWhyToday3: 'Porque esto no va de bailar bien, sino de sentirte bien bailando.',
  afroWhyTodayClosing1: "En Farray's no vendemos clases. Creamos experiencias.",
  afroWhyTodayClosing2:
    'Y la experiencia Afrobeats es algo que solo puedes entender cuando la vives.',

  // FAQ
  afroFaqTitle: 'Preguntas frecuentes sobre nuestras clases de Afrodance en Barcelona',
  afroFaqQ1: '¿Puedo empezar desde cero si nunca he bailado Afrobeats?',
  afroFaqA1:
    '¡CLARO! Los alumnos que nunca bailaron antes eligen los cursos de nivel principiante y los que tienen algo de experiencia en algún tipo de baile eligen el nivel básico. Nuestras clases están diseñadas para que cualquiera pueda seguir el ritmo desde el primer día.',
  afroFaqQ2: '¿Qué pasa si no tengo buena coordinación?',
  afroFaqA2:
    'No te preocupes, la coordinación se desarrolla con la práctica. Nuestros profesores te guiarán paso a paso y el ambiente es muy acogedor. ¡Lo importante es que seas constante y disfrutes del proceso!',
  ...
  afroFaqA6:
    '¡Sí! Puedes empezar cuando quieras. Consulta nuestro calendario para ver las próximas clases disponibles. Si tienes dudas sobre el nivel o el grupo, escríbenos y te orientamos.',
  afroFaqQ7: '¿Tenéis algún descuento especial?',
  afroFaqA7:
    'Sí, ofrecemos descuentos si te apuntas a más de un curso. Consulta nuestra web o pregúntanos directamente para más detalles.',
  ...
  afroFaqQ10:
    '¿Si falto a una clase debo recuperarla haciendo el mismo estilo, o puedo hacer otro diferente?',
  afroFaqA10:
    'Puedes recuperar tu clase cancelada haciendo otro estilo diferente, siempre y cuando respetes el nivel de la clase y gestiones la recuperación desde la aplicación de la escuela.',
  afroFaqQ11: '¿Organizáis eventos o talleres especiales?',
  afroFaqA11:
  ...
  // Final CTA
  afroFinalCTATitle: 'Únete a la comunidad de Afrobeats más activa de Barcelona',
  afroFinalCTASubtitle: 'Da el paso.',
  afroFinalCTADesc: 'Reserva tu plaza ahora y no dejes que te lo cuenten… ni que te lo bailen.',
  afroFinalCTAFunny: '¡Las plazas vuelan más rápido que un «Shaku Shaku» en viernes por la noche!',
  ...
  // ===== Prepara tu Primera Clase de Afrobeat =====
  ...
  afroCitableDefinicion:
    '**"Afrobeats (en plural) es una corriente musical urbana que surge a finales de los 90 y principios de los 2000 entre Nigeria y Ghana. Mezcla ritmos africanos tradicionales con highlife, hip hop, R&B, dancehall y pop, creando un sonido reconocible: percusión marcada, bajos potentes, melodías pegadizas y estribillos inolvidables."**',
  afroCitableOrigen:
    '**"Afrobeats surge a finales de los 90 en Nigeria y Ghana como fusión urbana de ritmos africanos, highlife, hip hop, R&B y dancehall, diferenciándose del Afrobeat (singular) de Fela Kuti de los 60-70s que era jazz-funk con protesta social."**',
  afroCitableFelaKuti:
    '**"En los años 60 y 70, Fela Kuti revolucionó la música nigeriana originando el Afrobeat (singular): fusión de jazz, funk, highlife y ritmos yoruba con mensajes de protesta social, canciones extensas y estructuras instrumentales inmersivas."**',
  afroCitableAfrodance:
    '**"Afrodance incluye estilos como Azonto (Ghana: caderas y gestos cotidianos), Shaku Shaku/Zanku/Legwork (Nigeria: trabajo de pies y rebote de rodillas), y Ntcham/Tcham Bolo (Gabón: expresión urbana de Libreville), todos viralizados globalmente por YouTube, TikTok e Instagram."**',
  afroCitableExpansion:
    '**"Artistas como Wizkid, Davido, Tiwa Savage y Burna Boy han globalizado el Afrobeats desde los 2000s mediante colaboraciones internacionales con estrellas de pop y rap, transformando el género en símbolo de la nueva cultura africana."**',
  afroCitableFact1:
    'Una clase de Afrobeats activa puede quemar entre 300 y 480 calorías por hora según peso e intensidad, similar a bailes aeróbicos con alto rebote y flow.',
  afroCitableFact2:
    'Estudios científicos sobre danza señalan que bailar mejora la coordinación, la propiocepción y la condición física general, además de reducir el estrés y mejorar el estado de ánimo.',
  afroCitableFact3:
    "Farray's International Dance Center ofrece clases de Afrobeats con profesores de raíces africanas (Redblueh, Charlie Breezy) en una escuela valorada cerca del 5/5 en Google con cientos de reseñas positivas.",
  ...
  hhrBreadcrumbClasses: 'Clases de Baile',
  hhrBreadcrumbUrban: 'Danzas Urbanas',
  hhrBreadcrumbCurrent: 'Clases de Hip Hop Reggaeton',
  ...
  hhrFlowGuaranteed: 'Flow garantizado',

  // What Is Section
  hhrWhatIsTitle: '¿Qué es Hip Hop Reggaeton y por qué está arrasando en Barcelona?',
  hhrWhatIsP1:
    'El Hip Hop Reggaeton es una fusión única y explosiva que mezcla lo mejor del hip-hop con la energía del reggaeton.',
  hhrWhatIsP2:
    "En las clases de Hip Hop Reggaeton de Farray's aprenderás a bailar mezclando estos dos estilos en una fusión moderna, informal y exclusiva de nuestra academia.",
  hhrWhatIsP3:
    'Disfruta de un estilo único con mucho "flow", donde fusionarás movimientos propios del hip-hop con elementos del reggaeton y recursos técnicos de la danza.',
  hhrWhatIsP4:
    'Este estilo lo lleva a un nivel informal, sensual y atrevido que te permitirá expresarte de forma auténtica.',
  hhrWhatIsQuestionTitle: '¿Te preguntas si es para ti?',
  hhrWhatIsQuestionAnswer: 'Sí, lo es.',
...
Las últimas tendencias y estilos se fusionan en nuestras clases de forma variada, dinámica y divertida. Incorporamos elementos de videoclips actuales, movimientos virales de redes sociales y la esencia de ambos géneros para crear coreografías frescas y originales cada semana.`,
  ...
  hhrIdentify4:
    'Te hace falta gente real, buen rollo, risas y un lugar donde ser tú sin filtros ni postureos.',
  hhrIdentify5:
    'El reggaeton y el hip-hop te mueven por dentro, pero tu rutina parece más un lunes eterno que un viernes de fiesta.',
  hhrIdentify6:
    'Te encanta bailar, pero necesitas más flow, más actitud y menos coreografías de robot sin batería.',

  // Necesitas apuntarte Section
  hhrIdentifyTransition: 'Si has dicho "sí" a alguno de estos puntos, ya sabes lo que necesitas.',
  hhrNeedEnrollTitle: 'Necesitas apuntarte a clases de Hip Hop Reggaeton en una academia de baile',
  hhrIdentifyAgitate1:
    'Sientes que tu cuerpo te pide algo diferente... ¿pero haces algo para sentirte mejor?',
  hhrIdentifySolution:
    'Si quieres salir de la rutina, sentirte mejor contigo mismo/a, conocer gente nueva y ponerte en forma mientras te diviertes, este estilo pleno de flow es para ti.',
  hhrIdentifyClosing:
    'Aprenderás a incorporar a tu baile grandes dosis de creatividad e improvisación para que puedas crear tu estilo propio, diferente y único.',

  // Transformation Section
  hhrTransformTitle: 'Imagina tu antes y después',
  hhrTransform1Title: 'Recuperas energía e ilusión',
  hhrTransform1Desc: 'Las clases te sacan de la rutina y te devuelven la motivación.',
  hhrTransform2Title: 'Desarrollas tu propio estilo',
  hhrTransform2Desc: 'Aprendes a improvisar y crear movimientos únicos.',
  hhrTransform3Title: 'Te pones en forma sin aburrirte',
  hhrTransform3Desc: 'Cada clase es diferente. Te diviertes mientras quemas un montón de calorías.',
  hhrTransform4Title: 'Conoces a gente con tu misma pasión',
  hhrTransform4Desc: 'Buen rollo, comunidad y gente que comparte tu gusto por la música urbana.',
  hhrTransform5Title: 'Conectas con la música urbana',
  hhrTransform5Desc: 'Ritmo, flow y capacidad de improvisación en cada clase.',
  ...
  hhrWhyChoose2Title: 'Ubicación inmejorable',
  hhrWhyChoose2Desc:
    'Calle Entença 100, entre Plaza España y Sants, a 5 minutos de metro. Fácil llegar, fácil volver.',
  hhrWhyChoose3Title: 'Ambiente familiar con profesionalismo',
  hhrWhyChoose3Desc:
    'Acogedor, inclusivo y sin juicios, pero con la exigencia que necesitas para evolucionar de verdad.',
  hhrWhyChoose4Title: 'Instalaciones preparadas de verdad',
  hhrWhyChoose4Desc:
    'Más de 700 m², salas amplias, espejos, sonido profesional, climatización y ventilación centralizada.',
  hhrWhyChoose5Title: 'Academia multidisciplinar',
  hhrWhyChoose5Desc:
    'Más de 25 estilos para que nunca te aburras: urbanos, latinas, contemporáneo, técnica, stretching y mucho más.',
  hhrWhyChoose6Title: 'Gala anual + workshops potentes',
  hhrWhyChoose6Desc:
    'Brilla en un teatro profesional, participa en workshops internacionales y vive experiencias únicas.',
  hhrWhyChoose7Title: 'Profesor especializado: Charlie Breezy',
  hhrWhyChoose7Desc:
    'Charlie Breezy es experto en Hip Hop Reggaeton con años de experiencia. Técnica, flow y energía contagiosa en cada clase.',

  // Logos Section
  hhrLogosTitle: 'Has podido vernos en…',
  hhrLogosIntlFestivalsText: 'y en los mejores festivales de baile de todo el mundo',
  ...
  hhrTeachersClosing:
    'Con Charlie Breezy no solo aprendes a bailar Hip Hop Reggaeton: descubres tu propio estilo y conectas con tu creatividad.',

  // Schedule Section
  hhrScheduleTitle: 'Horario de clases de Hip Hop Reggaeton',
  hhrScheduleSubtitle: 'Varios niveles para que encuentres tu clase perfecta',
  ...
  hhrWhyToday2: 'Porque estás a UNA clase de cambiar tu rutina y sentirte mejor que ayer.',
  ...
  hhrWhyTodayClosing2:
    'Te esperamos con música pegadiza, el flow de Charlie Breezy y una energía única en Barcelona.',

  // Final CTA Section
  hhrFinalCTATitle: 'Únete a la comunidad de Hip Hop Reggaeton más activa de Barcelona',
  hhrFinalCTASubtitle: 'Da el paso.',
  hhrFinalCTADesc: 'Reserva tu plaza ahora y no dejes que te lo cuenten… ni que te lo bailen.',
  hhrFinalCTAFunny:
    'Las plazas vuelan más rápido que un paso de Hip Hop Reggaeton un viernes por la noche.',

  // FAQ Section
  hhrFaqTitle: 'Preguntas Frecuentes sobre Hip Hop Reggaeton en Barcelona',
  hhrFaqQ1: '¿Cómo funcionan las clases de Hip Hop Reggaeton en Barcelona?',
  hhrFaqA1:
    'En nuestras clases de Hip Hop Reggaeton en Barcelona enseñamos coreografías que fusionan hip-hop y reggaeton, pero también trabajamos la improvisación. Cada sesión dura 1 hora e incluye: Calentamiento (preparación del cuerpo con ejercicios específicos), Coreografía (secuencias dinámicas que combinan pasos de hip-hop con el flow del reggaeton) e Improvisación (trabajo de creatividad para llevar tu baile a un nivel informal, expresivo y con personalidad).',
  hhrFaqQ2: '¿Puedo empezar desde cero si nunca he bailado Hip Hop Reggaeton?',
  hhrFaqA2:
    'Claro. Los alumnos que nunca han bailado antes eligen los cursos de nivel principiante y quienes tienen algo de experiencia en algún tipo de baile eligen el nivel básico. Nuestras clases están diseñadas para que cualquiera pueda seguir el ritmo desde el primer día.',
  hhrFaqQ3: '¿Qué pasa si no tengo buena coordinación?',
  hhrFaqA3:
    'No te preocupes, la coordinación se desarrolla con la práctica. Nuestros profesores te guiarán paso a paso y el ambiente es muy acogedor. Lo importante es ser constante y disfrutar del proceso.',
  hhrFaqQ4: '¿Qué necesito traer a las clases de Hip Hop Reggaeton?',
  hhrFaqA4:
    'Ropa cómoda y ligera que permita moverte con libertad, zapatillas limpias de uso exclusivo dentro del estudio, toalla y agua, porque bailarás intensamente y necesitas hidratarte.',
  hhrFaqQ5: '¿Qué niveles de Hip Hop Reggaeton tenéis?',
  hhrFaqA5:
    'Principiantes: Para empezar desde cero, aprender paso a paso y con buen ambiente. Básico: Para quienes ya tienen algo de experiencia en Hip Hop Reggaeton u otras danzas urbanas. Intermedio: Para mejorar técnica, coordinación y musicalidad con pasos más complejos. Avanzado: Para llevar tu nivel al máximo y consolidar tu estilo.',
  hhrFaqQ6: '¿Puedo unirme a las clases en cualquier momento del año?',
  hhrFaqA6:
    'Sí. Puedes empezar cuando quieras. Consulta nuestro calendario para ver las próximas clases disponibles. Si tienes dudas sobre el nivel o el grupo, escríbenos y te orientamos.',
  hhrFaqQ7: '¿Tenéis algún descuento especial?',
  hhrFaqA7:
    'Sí. Ofrecemos descuentos si te apuntas a más de un curso. Consulta la web o pregúntanos directamente para más detalles.',
  ...
  hhrFaqA9:
    'Si tienes una membresía y cancelas una clase, dispones de 30 días para recuperarla desde la fecha de la clase cancelada. Si tienes un abono de horas, gestionas tus clases de forma flexible: cancela y reserva otro día dentro del periodo de caducidad. Todas las gestiones se realizan exclusivamente desde la aplicación digital de la academia.',
  hhrFaqQ10: 'Si falto a una clase de Hip Hop Reggaeton, ¿puedo recuperarla haciendo otro estilo?',
  hhrFaqA10:
    'Puedes recuperarla haciendo la misma clase otro día o seleccionar otro estilo, siempre que respetes el nivel de la clase y gestiones la recuperación desde la aplicación de la escuela.',
  hhrFaqQ11: '¿Organizáis eventos o talleres especiales?',
  hhrFaqA11:
    'Sí. Organizamos talleres, masterclasses y eventos sociales durante el año. Síguenos en redes o consulta la web para estar al día.',
  hhrFaqQ12: '¿Las clases son solo para mujeres o también para hombres?',
  hhrFaqA12:
    'Nuestras clases están abiertas a todas las personas, sin importar el género o la experiencia previa. El Hip Hop Reggaeton es para todos.',
  hhrFaqQ13: '¿Qué diferencia el Hip Hop Reggaeton de otros estilos de baile urbano?',
  hhrFaqA13:
  ...
  // Keys para LevelCardsSection (usadas por el template)
  hhrLevelBeginnerTitle: 'Hip Hop Reggaeton Principiante',
  hhrLevelBeginnerDesc:
    'Tu primer contacto con el Hip Hop Reggaeton. Aprenderás groove básico, bounce, coordinación y los fundamentos del estilo urbano. Perfecto si nunca has bailado.',
  hhrLevelInterTitle: 'Hip Hop Reggaeton Intermedio',
  hhrLevelInterDesc:
    'Ya dominas lo básico y quieres más. Coreografías estilo videoclip, combinaciones más complejas, improvisación y desarrollo de tu propio estilo.',
  hhrLevelAdvancedTitle: 'Hip Hop Reggaeton Avanzado',
  hhrLevelAdvancedDesc:
    'Para bailarines experimentados. Coreografías intensivas, técnica avanzada, freestyle y preparación para shows o competiciones.',

  // ===== Prepara tu Primera Clase de Hip Hop Reggaeton =====
  ...
  hhrCitableDefinicion:
    '**"Hip Hop Reggaeton es un estilo de danza urbana que fusiona la técnica, el groove y el swagger del hip-hop estadounidense con la sensualidad, el ritmo y el dembow característico del reggaeton latinoamericano."**',
  hhrCitableOrigenHipHop:
    '**"El hip-hop nació en el Bronx de Nueva York en los años 70, como expresión artística de las comunidades afroamericanas y latinas. DJ Kool Herc, Afrika Bambaataa y Grandmaster Flash son considerados pioneros del movimiento."**',
  hhrCitableOrigenReggaeton:
    '**"El reggaeton surgió en Puerto Rico a finales de los años 80 y principios de los 90, fusionando el reggae jamaicano (especialmente el dancehall) con ritmos latinos, hip-hop y música electrónica. Su característico ritmo dembow proviene del tema \'Dem Bow\' de Shabba Ranks (1990)."**',
  hhrCitableFusion:
    '**"La fusión hip-hop y reggaeton combina elementos técnicos del breaking, popping y locking con movimientos de perreo, body roll y aislaciones sensuales, creando un estilo versátil para música urbana contemporánea."**',
  hhrCitableFact1:
    'Una clase de Hip Hop Reggaeton de alta intensidad puede quemar entre 400 y 600 calorías por hora, dependiendo del peso corporal y la intensidad de los movimientos.',
  hhrCitableFact2:
    'El hip-hop y el reggaeton son dos de los géneros musicales más escuchados a nivel mundial según Spotify, con billones de reproducciones anuales combinadas.',
  hhrCitableFact3:
...
Actualmente, el Sexy Reggaeton se enseña en Farray\'s Center con un enfoque equilibrado entre técnica, actitud y diversión, buscando que quienes lo practican se sientan seguras y confiadas, más allá de la mera ejecución de movimientos.`,
  ...
  // ===== Prepara tu Primera Clase de Sexy Reggaeton =====
  ...
  // Image Alt
  sxrImageAlt:
    'Clases de Sexy Reggaeton en Barcelona - Estudiantes bailando perreo y body roll en la academia',

  // ===== GEO OPTIMIZATION: Citable Statistics for Sexy Reggaeton =====
  sxrCitableDefinicion:
    '**"Sexy Reggaeton es una evolución contemporánea del perreo clásico puertorriqueño que combina movimientos sensuales con técnicas de baile femenino refinadas, incluyendo body rolls, disociación corporal, perreo y bajadas controladas al suelo (drops)."**',
  sxrCitableOrigen:
    '**"El reggaeton nació en los años 90 entre Panamá y Puerto Rico, surgido de la mezcla del reggae jamaicano, el hip hop estadounidense y ritmos latinos caribeños. El dembow panameño constituye la base rítmica esencial del género."**',
  sxrCitableTecnicas:
    '**"Las técnicas principales del Sexy Reggaeton incluyen: body roll (ondulación fluida del torso), perreo (movimientos de cadera hacia abajo), disociación corporal (control independiente de partes del cuerpo), y drops (bajadas al suelo controladas)."**',
  sxrCitableEmpoderamiento:
    '**"El Sexy Reggaeton moderno combina técnica con empoderamiento femenino, promovido por artistas como Karol G, Anitta, Bad Bunny y Daddy Yankee, que han difundido globalmente bailes sensuales coreografiados que celebran la confianza corporal."**',
  sxrCitableFact1:
    'Una clase de Sexy Reggaeton puede quemar entre 300 y 450 calorías por hora, trabajando piernas, core, flexibilidad y resistencia mediante movimientos de perreo, drops y body roll.',
  sxrCitableFact2:
    'El Sexy Reggaeton fusiona elementos del reggaeton puertorriqueño, dancehall jamaicano y twerk, adaptándose tanto como actividad lúdica como entrenamiento físico completo.',
  sxrCitableFact3:
    "Farray's International Dance Center ofrece clases de Sexy Reggaeton con Yunaisy Farray, directora de la academia y especialista en danzas urbanas sensuales reconocida por CID-UNESCO.",
...
**Farray's International Dance Center enseña Reggaeton Cubano auténtico con profesores cubanos formados en la Escuela Nacional de Arte (ENA) de La Habana.** Las clases mantienen la esencia callejera del estilo mientras ofrecen una progresión técnica estructurada para todos los niveles.`,
  ...
  // ===== Prepara tu Primera Clase de Reggaeton Cubano =====
  ...
  rcbCitableDefinicion:
    '**"El Reggaeton Cubano (también conocido como Cubatón o Reparto) es una variante del reggaeton que nació en los barrios populares de La Habana, Cuba, fusionando el reggaeton puertorriqueño con ritmos afrocubanos, rumba, son y elementos de la cultura callejera habanera."**',
  rcbCitableOrigen:
  ...
  rcbCitableFact1:
    'El Reggaeton Cubano incorpora elementos de la rumba (guaguancó, columbia), son cubano y danzas yoruba, creando un estilo único que lo diferencia del reggaeton puertorriqueño.',
  rcbCitableFact2:
    'Una clase de Reggaeton Cubano puede quemar entre 350 y 550 calorías por hora debido a la intensidad del tembleque y los movimientos de disociación corporal.',
  rcbCitableFact3:
    "Farray's International Dance Center enseña Reggaeton Cubano auténtico con Alejandro Miñoso y Charlie Breezy, bailarines cubanos formados en la Escuela Nacional de Arte (ENA) de La Habana.",
  ...
  heelsBarcelona_styles_description:
    'Dos disciplinas únicas para expresar tu feminidad y sensualidad a través del movimiento. Elige tu estilo o combínalos para un desarrollo completo.',

  // Style Cards SEO Text
  heelsBarcelona_style_femmology_title: 'Femmology Heels',
  heelsBarcelona_style_femmology_seo:
    'La disciplina exclusiva creada por Yunaisy Farray que fusiona técnica de tacones, sensualidad elegante, expresión corporal y empoderamiento femenino. Aprende a moverte con gracia, presencia y confianza.',
  ...
  heelsBarcelona_whichStyle_sexystyle_subtitle: 'Libertad Expresiva + Diversión',
  ...
  heelsBarcelona_whichStyle_femmology_cta: 'Descubre Femmology',
  heelsBarcelona_whichStyle_sexystyle_cta: 'Descubre Sexy Style',

  // Comparison Table
  heelsBarcelona_table_aspect: 'Aspecto',
  heelsBarcelona_table_femmology: 'Femmology',
  heelsBarcelona_table_sexystyle: 'Sexy Style',
  heelsBarcelona_table_heels: 'Uso de tacones',
  heelsBarcelona_table_heels_fem: 'Obligatorio',
  heelsBarcelona_table_heels_sexy: 'Opcional (puedes empezar sin)',
  heelsBarcelona_table_level: 'Exigencia técnica',
  heelsBarcelona_table_level_fem: 'Alta',
  heelsBarcelona_table_level_sexy: 'Media-Baja',
  heelsBarcelona_table_focus: 'Enfoque principal',
  heelsBarcelona_table_focus_fem: 'Danzaterapia + Técnica',
  heelsBarcelona_table_focus_sexy: 'Diversión + Expresión',
  heelsBarcelona_table_emotional: 'Trabajo emocional',
  heelsBarcelona_table_emotional_fem: 'Sí, es el core de la clase',
  heelsBarcelona_table_emotional_sexy: 'No, centrado en baile',
  heelsBarcelona_table_teacher: 'Profesora',
  heelsBarcelona_table_teacher_fem: 'Yunaisy Farray (creadora)',
  heelsBarcelona_table_teacher_sexy: 'Yasmina Fernández',
  heelsBarcelona_table_ideal: 'Ideal para',
  heelsBarcelona_table_ideal_fem: 'Transformación personal profunda',
  heelsBarcelona_table_ideal_sexy: 'Pasarlo bien bailando sensual',

  heelsBarcelona_whichStyle_combine_title: '¿Puedo combinar ambos estilos?',
  ...
  heelsBarcelona_why_reason2_title: 'Yunaisy Farray - Creadora del Método',
  heelsBarcelona_why_reason2_desc:
    'Aprende con la creadora del Método Farray®, actriz de Street Dance 2 y referente internacional en danza femenina. Experiencia y pasión en cada clase.',
  heelsBarcelona_why_reason3_title: 'Enfoque en Feminidad y Empoderamiento',
  heelsBarcelona_why_reason3_desc:
    'Nuestras clases van más allá de la técnica: trabajamos autoestima, expresión corporal y conexión con tu feminidad en un ambiente seguro y respetuoso.',
  heelsBarcelona_why_reason4_title: 'Técnica Segura para Tus Articulaciones',
  heelsBarcelona_why_reason4_desc:
    'Enseñamos a bailar en tacones sin dañar tus rodillas ni tobillos. Calentamiento específico, técnica correcta y ejercicios de fortalecimiento incluidos.',
  heelsBarcelona_why_reason5_title: 'Instalaciones de 700 m²',
  heelsBarcelona_why_reason5_desc:
    'Salas amplias con suelo profesional, espejos de pared completa, barras, aire acondicionado y vestuarios equipados. Todo para que te enfoques en brillar.',
  heelsBarcelona_why_reason6_title: 'Ubicación Céntrica',
  heelsBarcelona_why_reason6_desc:
    'Calle Entença 100, a 5 minutos de Plaza España y Sants. Fácil acceso en metro, tren y bus. Fácil llegar, fácil volver.',

  // Stats Section
  heelsBarcelona_stats_title: 'La Academia de Heels de Referencia en Barcelona',
  ...
  heelsFaqA1:
    'No necesitas experiencia previa. Tenemos niveles desde principiante absoluto hasta avanzado. Lo importante es venir con ganas de explorar tu feminidad y disfrutar del movimiento en tacones.',

  heelsFaqQ2: '¿Qué tacones necesito para las clases?',
  heelsFaqA2:
    'Para principiantes recomendamos tacones de 7-9 cm con plataforma para mayor estabilidad. Si nunca has bailado en tacones, puedes empezar con tacón grueso. Te guiaremos sobre qué modelo elegir en tu primera clase.',

  heelsFaqQ3: '¿Las clases de Heels son solo para mujeres?',
  heelsFaqA3:
    'Nuestras clases de Heels están abiertas a todas las personas que quieran explorar este estilo de baile, sin importar género. Lo importante es la actitud y las ganas de aprender.',

  heelsFaqQ4: '¿Qué diferencia hay entre Femmology y Sexy Style?',
  heelsFaqA4:
    'Femmology Heels se enfoca en elegancia, técnica de caminar en tacones, postura y sensualidad refinada. Sexy Style es más libre, con más movimiento de cadera, ondas corporales y trabajo de suelo. Ambos desarrollan feminidad pero con diferentes enfoques.',

  heelsFaqQ5: '¿Es peligroso bailar en tacones? ¿Puedo lesionarme?',
  heelsFaqA5:
    'Con la técnica correcta, bailar en tacones es seguro. En nuestras clases enseñamos calentamiento específico, alineación correcta y fortalecimiento de tobillos y rodillas. Nunca forzamos y respetamos el ritmo de cada alumna.',

  heelsFaqQ6: '¿Puedo venir con tacones bajos o sin tacones al principio?',
  heelsFaqA6:
    'Sí. Si eres principiante o tienes alguna molestia, puedes empezar con tacones más bajos o incluso sin tacones para aprender la técnica básica. El objetivo es que te sientas cómoda y segura.',

  heelsFaqQ7: '¿Cuánto tiempo tardo en poder bailar bien en tacones?',
  heelsFaqA7:
    'Con constancia (2 clases por semana), notarás mejoras significativas en equilibrio, postura y confianza en 4-6 semanas. En 3 meses ya podrás bailar coreografías completas con soltura.',

  heelsFaqQ8: '¿Qué ropa debo llevar a las clases de Heels?',
  heelsFaqA8:
    'Ropa que te haga sentir bien y permita libertad de movimiento: shorts, leggins, body, top. Lo importante es que puedas verte en el espejo y sentirte cómoda. Trae tus tacones y rodilleras si tienes.',

  heelsFaqQ9: '¿Organizan showcases o eventos donde pueda bailar?',
  heelsFaqA9:
    'Sí. Cada año organizamos una Gala Anual en un teatro profesional de Barcelona donde las alumnas de Heels pueden presentar coreografías preparadas durante el curso. Es una experiencia única de empoderamiento.',

  heelsFaqQ10: '¿Dónde está la escuela y cómo contacto?',
  heelsFaqA10:
    'Estamos en Calle Entença 100, 08015 Barcelona (a 5 min de Plaza España y Sants).<br/><br/>📞 <strong>Teléfono:</strong> <a href="tel:+34622247085" class="text-primary-accent hover:underline">+34 622 247 085</a><br/>📧 <strong>Email:</strong> <a href="mailto:info@farrayscenter.com" class="text-primary-accent hover:underline">info@farrayscenter.com</a><br/>🌐 <strong>Web:</strong> <a href="https://www.farrayscenter.com/contacto" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">www.farrayscenter.com/contacto</a>',

  heelsFaqQ11: '¿Cuál es la mejor clase de Heels para principiantes en Barcelona?',
  heelsFaqA11:
    'Para principiantes recomendamos empezar con <strong>Sexy Style</strong>, ya que permite comenzar sin tacones y tiene menor exigencia técnica. Una vez te sientas cómoda, puedes probar <strong>Femmology</strong> con Yunaisy Farray para un trabajo más profundo de técnica y desarrollo personal.',

  heelsFaqQ12: '¿Qué beneficios tiene bailar en tacones para mi cuerpo y mente?',
  heelsFaqA12:
    'Bailar en tacones fortalece piernas, glúteos y core, mejora la postura y el equilibrio. A nivel mental, aumenta la confianza, la autoestima y la conexión con tu feminidad. En Femmology además trabajamos miedos, inseguridades y bloqueos emocionales a través de la danzaterapia.',
  ...
  heelsCitableDefinicion:
    '**"Heels Dance (baile en tacones) es una disciplina de danza urbana que se realiza con zapatos de tacón alto, combinando técnica de baile con elegancia, sensualidad y empoderamiento femenino. Incluye estilos como Femmology y Sexy Style."**',
  heelsCitableFemmologyOrigen:
    '**"Femmology es una metodología de danza en tacones creada por Yunaisy Farray en Barcelona que combina danzaterapia, técnica de baile y trabajo emocional. El Método Farray® es exclusivo de su academia y reconocido por CID-UNESCO."**',
  heelsCitableSexyStyleDefinicion:
    '**"Sexy Style es un estilo de baile en tacones con enfoque lúdico y de libertad expresiva, que incluye movimientos de cadera, ondas corporales, floorwork y coreografías sensuales sin la exigencia técnica del Femmology."**',
  heelsCitableTecnicas:
    '**"Las técnicas principales del Heels Dance incluyen: uso correcto del pelo, floorwork (trabajo en el suelo), disociación corporal, body rolls, ondas, caminar en tacones con elegancia, y expresión corporal sensual."**',
  heelsCitableFact1:
    'Una clase de Heels Dance puede quemar entre 250 y 400 calorías por hora, fortaleciendo piernas, glúteos y core mientras mejora postura, equilibrio y coordinación.',
  heelsCitableFact2:
    'Femmology fue creado por Yunaisy Farray, bailarina cubana formada en la Escuela Nacional de Arte (ENA) de La Habana y actriz de la película Street Dance 2 (2012).',
  heelsCitableFact3:
    "Farray's International Dance Center es la única academia en Barcelona que ofrece el Método Farray® original de Femmology, con reconocimiento de CID-UNESCO.",
...
Actualmente, Femmology se imparte exclusivamente en Farray\'s Center bajo la dirección de Yunaisy Farray, quien ha formado a cientos de mujeres en esta disciplina transformadora.`,
  ...
  femCitableDefinicion:
    '**"Femmology es una metodología de danza en tacones creada por Yunaisy Farray que combina danzaterapia, técnica de baile y trabajo emocional. El Método Farray® es exclusivo de Farray\'s International Dance Center y reconocido por CID-UNESCO."**',
  femCitableCreadora:
    '**"Yunaisy Farray es la creadora del Femmology. Bailarina cubana formada en la Escuela Nacional de Arte (ENA) de La Habana, actriz de la película Street Dance 2 (2012) y directora de Farray\'s International Dance Center en Barcelona."**',
  femCitableMetodologia:
    '**"El Método Farray® de Femmology incluye: trabajo emocional y de autoestima, técnica de tacones segura para articulaciones, uso del pelo como elemento expresivo, floorwork, disociación corporal, y coreografías que potencian la feminidad."**',
  femCitableBeneficios:
    '**"Femmology trabaja el empoderamiento femenino a través de la danza, mejorando postura corporal, equilibrio, coordinación, confianza personal y aceptación del propio cuerpo mediante una metodología de danzaterapia."**',
  femCitableFact1:
    'El Femmology se practica obligatoriamente con tacones, a diferencia de otros estilos como Sexy Style donde su uso es opcional.',
  femCitableFact2:
    'Una clase de Femmology combina trabajo técnico y emocional, siendo el único estilo de danza en tacones con enfoque de danzaterapia en Barcelona.',
  femCitableFact3:
    "Farray's International Dance Center es la única academia en el mundo donde se enseña el Método Farray® original de Femmology.",
  ...
  // ===== Prepara tu Primera Clase de Femmology =====
  ...
  sexystyleMetaDescription:
    'Clases de Sexy Style en Barcelona con Yasmina Fernández. Aprende a expresarte con sensualidad, confianza y movimiento. Todos los niveles. ¡Reserva tu clase de prueba!',

  // Breadcrumb (4 niveles: Home > Clases > Urbanas > Current)
  sexystyleBreadcrumbHome: 'Inicio',
  sexystyleBreadcrumbClasses: 'Clases de Baile',
  sexystyleBreadcrumbUrban: 'Danzas Urbanas',
  sexystyleBreadcrumbCurrent: 'Clases de Sexy Style',

  // Hero
  sexystyleHeroTitle: 'Clases de Sexy Style en Barcelona',
  sexystyleHeroSubtitle: 'Despierta tu sensualidad bailando',
  sexystyleHeroDesc:
    'Descubre el poder de tu cuerpo a través del movimiento. Sin vergüenza, sin juicios, solo tú y tu expresión.',
  sexystyleHeroLocation:
    'Clases desde nivel principiante hasta avanzado, entre Plaza España y Sants',

  // Stats
  sexystyleSensualityStat: '~500',
  sexystyleEmpowerment: 'Calorías Quemadas',
  sexystyleConfidenceGuaranteed: 'Sensualidad garantizada',
  ...
  // What Is Section
  sexystyleWhatIsTitle: '¿Qué es el Sexy Style y por qué está revolucionando Barcelona?',
  sexystyleWhatIsP1:
    'El Sexy Style es mucho más que un baile: es una forma de reconectar con tu cuerpo, tu sensualidad y tu poder interior.',
  sexystyleWhatIsP2:
    'A través de movimientos fluidos, ondulaciones y coreografías diseñadas para despertar tu expresión corporal, aprenderás a moverte con confianza y actitud.',
  sexystyleWhatIsP3: '«No se trata de cómo te ven los demás, sino de cómo te sientes tú»',
  sexystyleWhatIsP4:
    'En cada clase trabajamos técnica, musicalidad y, sobre todo, la conexión contigo misma. Saldrás sintiéndote más fuerte, más libre y más sexy.',
  sexystyleWhatIsQuestionTitle: '¿Te preguntas si es para ti?',
...
Hoy, el Sexy Style en Farray's se vive como un espacio de aprendizaje técnico y, a la vez, como un laboratorio de autoconfianza donde cada alumna puede construir su propia versión de lo que significa ser sensual, fuerte y libre.`,
  ...
  sexystyleIdentify1:
    'Sientes que vives en piloto automático y casi no te reconoces en el espejo ni te ves sensual',
  sexystyleIdentify2:
    'Quieres soltarte cuando suena la música, pero tu cuerpo se queda rígido y la vergüenza te bloquea, aunque ya hayas ido a clases',
  sexystyleIdentify3:
    'Has probado otros bailes, pero eran solo pasos y técnica: no sentías placer ni más poder al salir',
  sexystyleIdentify4:
    'Ves a tus artistas favoritas en tacones y piensas "yo no podría", porque crees que te falta cuerpo, edad o talento',
  sexystyleIdentify5:
    'Deseas un estudio donde jugar con tu sensualidad frente al espejo, sin miradas juzgonas ni comentarios sobre tu cuerpo',
  sexystyleIdentify6:
    'Necesitas un rato a la semana solo para ti, para subirte a los tacones, soltar la rutina y salir sintiéndote viva, empoderada y muy sexy',
  sexystyleIdentifyTransition:
    'Si has dicho "sí" a alguno de estos puntos, ya sabes lo que necesitas.',

  // Need Enroll Section
  sexystyleNeedEnrollTitle: 'Necesitas apuntarte a clases de Sexy Style',
  ...
  sexystyleTransformTitle: 'Imagina tu antes y después',
  sexystyleTransform1Title: 'De desconectada a presente',
  sexystyleTransform1Desc:
    'Dejas de pensar en todo lo demás. Durante una hora, solo existes tú, la música y tu cuerpo.',
  sexystyleTransform2Title: 'De rígida a fluida',
  sexystyleTransform2Desc:
    'Tu cuerpo aprende a moverse con soltura. Lo que antes te costaba, ahora fluye natural.',
  sexystyleTransform3Title: 'De "solo pasos" a disfrutar de verdad',
  sexystyleTransform3Desc:
    'Antes ibas a clase, seguías la coreo y ya. Cansada, pero igual por dentro. Ahora cada coreografía es una excusa para sentirte mejor que nunca.',
  sexystyleTransform4Title: 'De "yo no podría" a "mírame hacerlo"',
  sexystyleTransform4Desc:
    'Antes veías a tus artistas favoritas y dudabas de ti; ahora, cuando te miras en el espejo, reconoces a una mujer que se mueve con actitud y confianza.',
  sexystyleTransform5Title: 'De esconderte a brillar',
  sexystyleTransform5Desc:
    'Antes te costaba moverte si alguien miraba. Ahora el espejo es tu aliado y el estudio tu escenario: un espacio donde tu sensualidad es bienvenida, celebrada y nunca juzgada.',
  ...
  sexystyleWhyChoose1Desc:
    'Dirigida por Yunaisy Farray, actriz de Street Dance 2 y una de las profesoras más reconocidas del mundo.',
  sexystyleWhyChoose2Title: 'Ambiente seguro y sin juicios',
  sexystyleWhyChoose2Desc:
    'Un espacio donde puedes ser tú misma, experimentar y soltarte sin miedo a la mirada de otros.',
  sexystyleWhyChoose3Title: 'Metodología progresiva',
  sexystyleWhyChoose3Desc:
    'Empezamos desde cero. Cada movimiento se descompone para que lo integres a tu ritmo.',
  sexystyleWhyChoose4Title: 'Ubicación inmejorable',
  sexystyleWhyChoose4Desc:
    'Calle Entença 100, a 5 minutos de Plaza España y Sants. Metro, bus y tren en la puerta.',
  sexystyleWhyChoose5Title: 'Instalaciones de primera',
  sexystyleWhyChoose5Desc:
    'Más de 700 m², salas amplias con espejos, sonido profesional y climatización.',
  sexystyleWhyChoose6Title: 'Profesora especializada',
  sexystyleWhyChoose6Desc:
    'Yasmina Fernández: experta en Sexy Style con años de experiencia. Técnica, flow y energía contagiosa.',
  sexystyleWhyChoose7Title: 'Gala anual + workshops potentes',
  sexystyleWhyChoose7Desc:
    'Brilla en un teatro profesional, participa en workshops internacionales y vive experiencias que no encontrarás en ninguna otra escuela.',

  // Logos Section
  sexystyleLogosTitle: 'Has podido vernos…',
  sexystyleLogosIntlFestivalsText: 'y en los mejores festivales de baile del mundo',
  ...
  // Schedule Section
  sexystyleScheduleTitle: 'Horario de clases de Sexy Style',
  sexystyleScheduleSubtitle: 'Varios niveles para que encuentres tu clase perfecta',
  ...
  sexystyleWhyToday1:
    'Porque cada día que esperas es un día menos sintiéndote a gusto en tu propio cuerpo.',
  sexystyleWhyToday2: 'Porque tu cuerpo ya está listo, aunque tu mente te diga que no.',
  ...
  sexystyleWhyTodayClosing2:
    'Te esperamos con música alta, tacones listos y una profe dispuesta a sacar tu versión más poderosa en un ambiente en el que te vas a sentir en casa.',

  // Final CTA Section
  sexystyleFinalCTATitle: 'Únete a la comunidad de Sexy Style más empoderada de Barcelona',
  sexystyleFinalCTASubtitle: 'Da el paso.',
  sexystyleFinalCTADesc:
    'Reserva tu plaza ahora y descubre todo lo que tu cuerpo es capaz de decir cuando baila.',
  sexystyleFinalCTAFunny: 'Las plazas se llenan antes de que termine la próxima coreo.',

  // FAQ Title
  sexystyleFaqTitle: 'Preguntas Frecuentes sobre nuestras clases de Sexy Style en Barcelona',

  // 15 FAQs
  sexystyleFaqQ1: '¿Qué es exactamente el Sexy Style?',
  sexystyleFaqA1:
    'El Sexy Style es un estilo de baile urbano que combina movimientos sensuales, ondulaciones, expresión corporal y coreografía. Se enfoca en la conexión con tu cuerpo y tu feminidad, trabajando la confianza y la actitud.',

  sexystyleFaqQ2: '¿Necesito experiencia previa para empezar?',
  sexystyleFaqA2:
    'No, para nada. El 85% de nuestras alumnas empiezan sin experiencia. Tenemos clases para principiantes donde se trabaja desde lo más básico.',

  sexystyleFaqQ3: '¿Qué ropa debo llevar a las clases? ¿Es obligatorio el uso de tacones?',
  sexystyleFaqA3:
    'Ropa cómoda que te permita moverte con libertad: leggings o pantalón corto, top o camiseta ajustada. El uso de tacones NO es obligatorio. Puedes empezar con bambas y, cuando te sientas preparada, dar el salto a los tacones. Si decides usarlos, los más recomendados son tipo stiletto con suela antideslizante y tira en el tobillo, de entre 7 y 10 cm.',

  sexystyleFaqQ4: '¿Las clases son solo para mujeres?',
  sexystyleFaqA4:
    'Nuestras clases de Sexy Style están abiertas a todas las personas que quieran explorar su expresión corporal. La mayoría de participantes son mujeres, pero el espacio es inclusivo.',

  sexystyleFaqQ5: '¿Qué diferencia hay entre Sexy Style y Femmology?',
  sexystyleFaqA5:
    'El Sexy Style se centra en la expresión personal y el empoderamiento, con un enfoque más libre y fluido. Las clases de Femmology, en cambio, son más técnicas y el grado de exigencia es superior, trabajando movimientos más precisos y detallados. Ambos estilos trabajan la sensualidad, pero Sexy Style es ideal para empezar y Femmology para quienes buscan mayor desafío técnico.',

  sexystyleFaqQ6: '¿Es un buen ejercicio físico?',
  sexystyleFaqA6:
    'El Sexy Style trabaja especialmente core, glúteos, piernas y flexibilidad. En una clase puedes quemar entre 300 y 500 calorías mientras te diviertes.',
  ...
  sexystyleFaqA8:
    'Tenemos cuatro niveles: Principiante (sin experiencia), Básico (primeros pasos dados), Intermedio (ya con soltura) y Avanzado (técnica refinada y coreografías complejas).',

  sexystyleFaqQ9: '¿Y si falto a una clase por trabajo o compromisos?',
  sexystyleFaqA9:
    'Si tienes una membresía y cancelas una clase, dispones de 30 días para recuperarla desde la fecha de la clase cancelada. Si tienes un abono de horas, gestionas tus clases de forma flexible: cancela y reserva otro día dentro del periodo de caducidad. Todas las gestiones se realizan exclusivamente desde la aplicación digital de la academia.',

  sexystyleFaqQ10: '¿Hacéis coreografías de canciones conocidas?',
  sexystyleFaqA10:
    'Sí, trabajamos con música actual y clásicos del R&B, pop y reggaetón. Las coreografías van rotando para que siempre haya novedad.',

  sexystyleFaqQ11: '¿Puedo apuntarme en cualquier momento del año?',
  sexystyleFaqA11:
    'Sí, nuestro sistema es abierto. Puedes incorporarte cuando quieras sin esperar a que empiece un nuevo ciclo.',

  sexystyleFaqQ12: '¿Organizáis eventos o showcases?',
  sexystyleFaqA12:
    'Sí, tenemos una gala anual donde las alumnas pueden lucirse en un escenario profesional. También organizamos workshops y masterclasses con artistas invitados.',
  ...
  sexystyleFaqA14:
    'Estamos en Calle Entença 100, 08015 Barcelona. A solo 5 minutos andando de Plaza España y Sants Estació. Perfectamente conectada con metro (L1, L3), bus y tren.',

  sexystyleFaqQ15:
    '¿Dónde puedo encontrar clases de Sexy Style cerca de Plaza España en Barcelona?',
  sexystyleFaqA15:
  ...
  sexystyleCitableDefinicion:
    '**"Sexy Style es un estilo de baile en tacones con enfoque lúdico y de libertad expresiva. Se caracteriza por movimientos de cadera, ondas corporales, floorwork y coreografías sensuales con una exigencia técnica media-baja."**',
  sexystyleCitableDiferencias:
    '**"A diferencia del Femmology (danzaterapia con técnica exigente), Sexy Style prioriza la diversión y la expresión libre. Los tacones son opcionales y no hay trabajo emocional estructurado, solo el disfrute del baile sensual."**',
  sexystyleCitableTecnicas:
    '**"Las técnicas del Sexy Style incluyen: movimientos de cadera y pelvis, ondas corporales, floorwork (trabajo en el suelo), actitud y expresión corporal libre, y coreografías sensuales accesibles."**',
  sexystyleCitableFact1:
    'Sexy Style es ideal para principiantes que quieren explorar la sensualidad en el baile sin la exigencia técnica de estilos como Femmology o Heels profesional.',
  sexystyleCitableFact2:
    'En Sexy Style los tacones son opcionales: las alumnas pueden empezar descalzas o con zapatillas y progresar a tacones cuando se sientan cómodas.',
  sexystyleCitableFact3:
    "Farray's International Dance Center ofrece clases de Sexy Style con Yasmina Fernández, instructora especializada en baile sensual y expresión corporal.",
  ...
  // SEO & Meta
  modernjazzPageTitle:
    'Clases de Modern Jazz en Barcelona | Técnica y Expresión con Alejandro Miñoso',
  modernjazzMetaDescription:
    'Clases de Modern Jazz en Barcelona con Alejandro Miñoso. Técnica, musicalidad y expresión corporal. Desde principiante hasta avanzado. ¡Reserva tu clase de prueba!',

  // Breadcrumb (4 niveles: Home > Clases > Danza > Current)
  modernjazzBreadcrumbHome: 'Inicio',
  modernjazzBreadcrumbClasses: 'Clases de Baile',
  modernjazzBreadcrumbDance: 'Clases de Danza',
  modernjazzBreadcrumbCurrent: 'Clases de Modern Jazz',

  // Hero
  modernjazzHeroTitle: 'Clases de Modern Jazz en Barcelona',
  modernjazzHeroSubtitle: 'Técnica, expresión y libertad de movimiento',
  modernjazzHeroDesc:
    'Descubre el Modern Jazz: una danza que fusiona la técnica del ballet clásico con la energía y libertad del jazz contemporáneo. Expresión, musicalidad y movimiento fluido.',
  modernjazzHeroLocation: 'Clases para todos los niveles, entre Plaza España y Sants',

  // Stats
  modernjazzTechniqueStat: 'Técnica',
  modernjazzEmpowerment: 'Ballet + Jazz',
  modernjazzConfidenceGuaranteed: 'Expresión garantizada',
  modernjazzCaloriesStat: 'Calorías Quemadas',
  modernjazzDanceStat: 'Danza',
  ...
  // What Is Section
  modernjazzWhatIsTitle: '¿Qué es el Modern Jazz y por qué te va a transformar?',
  modernjazzWhatIsP1:
    'El Modern Jazz es una evolución de la Danza Jazz que incorpora los estilos musicales más actuales. Es el referente en los musicales de Broadway y en las coreografías de tus artistas favoritos.',
  modernjazzWhatIsP2:
    'Nuestras clases se distinguen por su riqueza de ritmos, diversidad de estilos y por ser una mezcla perfecta de técnica, ritmo y fuerza. Trabajamos desde lo básico hasta lo más complejo.',
  modernjazzWhatIsP3:
    '«Prestamos especial atención a la respiración, al movimiento de los brazos y a las entradas y salidas del suelo, aspectos muy característicos del Modern Jazz»',
  modernjazzWhatIsP4:
    'Diversión, técnica y musicalidad: pensado para bailarines de todos los niveles que quieran adquirir una buena forma física trabajando con energía e interpretando las últimas tendencias musicales.',
...
**Farray's International Dance Center**: Modern Jazz con Método Farray® exclusivo (sólido + divertido), aval CID-UNESCO, valoración ~5/5 en Google con cientos de reseñas.`,
  ...
  modernjazzIdentify1: 'Quieres aprender a bailar con técnica real, no solo copiar pasos de vídeos',
  modernjazzIdentify2:
    'Te gustan los musicales y las películas de baile, pero crees que eso está fuera de tu alcance',
  modernjazzIdentify3:
    'Has probado otras clases pero sentías que faltaba estructura y progresión técnica',
  modernjazzIdentify4:
    'Quieres mejorar tu postura, flexibilidad y forma de moverte, pero los entrenamientos de gimnasio te aburren',
  modernjazzIdentify5:
    'Buscas una actividad que trabaje cuerpo y mente, que te desafíe pero también te haga disfrutar',
  modernjazzIdentify6:
    'Sueñas con moverte con elegancia y expresión, pero no sabes por dónde empezar',
  modernjazzIdentifyTransition:
    'Si has dicho "sí" a alguno de estos puntos, ya sabes lo que necesitas.',

  // Need Enroll Section
  modernjazzNeedEnrollTitle: 'Necesitas apuntarte a clases de Modern Jazz',
  ...
  modernjazzTransformTitle: 'Imagina tu antes y después',
  modernjazzTransform1Title: 'De rígido a fluido',
  modernjazzTransform1Desc:
    'Tu cuerpo gana flexibilidad y soltura. Los movimientos que antes te costaban ahora fluyen naturalmente.',
  modernjazzTransform2Title: 'De inseguro a técnico',
  modernjazzTransform2Desc:
    'Dominas los fundamentos: postura, giros, saltos, líneas. Bailas con propiedad, no improvisando.',
  modernjazzTransform3Title: 'De copiar a interpretar',
  modernjazzTransform3Desc:
    'Ya no solo sigues pasos: entiendes la música, la expresas con tu cuerpo y le das tu sello personal.',
  modernjazzTransform4Title: 'De espectador a protagonista',
  modernjazzTransform4Desc:
    'Esos movimientos que admirabas en películas y musicales ahora los ejecutas tú.',
  modernjazzTransform5Title: 'De sedentario a atlético',
  modernjazzTransform5Desc:
    'Tu condición física mejora: más fuerza, más resistencia, mejor postura. Bailar es tu nuevo entrenamiento.',
  ...
  modernjazzWhyChoose1Desc:
    'Dirigida por Yunaisy Farray, actriz de Street Dance 2 y una de las maestras más reconocidas del mundo.',
  modernjazzWhyChoose2Title: 'Ubicación inmejorable',
  modernjazzWhyChoose2Desc:
    'Calle Entença 100, entre Plaza España y Sants, a 5 minutos de Plaça Espanya y Sants. Metro, buses y tren a la puerta. Fácil llegar. Fácil volver.',
  modernjazzWhyChoose3Title: 'Ambiente familiar, con la profesionalidad que necesitas',
  modernjazzWhyChoose3Desc:
    'Cercano, inclusivo y sin juicios ni comparaciones, pero con la profesionalidad que necesitas para evolucionar de verdad.',
  modernjazzWhyChoose4Title: 'Instalaciones preparadas de verdad',
  modernjazzWhyChoose4Desc:
    'Más de 700 m², salas amplias, espejos, sonido profesional, aire acondicionado y ventilación centralizada para entrenar a gusto todo el año.',
  modernjazzWhyChoose5Title: 'Academia multidisciplinar',
  modernjazzWhyChoose5Desc:
    'Más de 25 estilos para que nunca te aburras y puedas crecer a tu ritmo: urbanos, bailes latinos, contemporáneo, técnica, estiramiento y mucho más.',
  modernjazzWhyChoose6Title: 'Gala anual + workshops potentes',
  modernjazzWhyChoose6Desc:
    'Brilla en un teatro profesional, participa en workshops internacionales y vive experiencias que no encontrarás en ninguna otra escuela.',
  modernjazzWhyChoose7Title: 'Maestro cubano formado en la ENA',
  modernjazzWhyChoose7Desc:
    'Alejandro Miñoso, maestro internacional cubano formado en la ENA (Escuela Nacional de Arte de Cuba), ex solista de la compañía de Carlos Acosta.',

  // Logos Section
  modernjazzLogosTitle: 'Has podido vernos…',
  modernjazzLogosIntlFestivalsText: 'y en los mejores festivales de baile del mundo',
  ...
  modernjazzWhyToday1:
    'Porque la técnica se construye con tiempo, y cuanto antes empieces, antes verás resultados.',
  modernjazzWhyToday2:
    'Porque tu cuerpo necesita algo más que oficina y sofá: necesita estirarse, girar, saltar y respirar música.',
  modernjazzWhyToday3:
  ...
  modernjazzWhyTodayClosing2:
    'Te esperamos con buena música, mucha técnica y un profesor dispuesto a llevar tu danza a otro nivel.',

  // Final CTA Section
  modernjazzFinalCTATitle: 'Únete a las clases de Modern Jazz más técnicas de Barcelona',
  ...
  // 15 FAQs
  modernjazzFaqQ1: '¿Qué es exactamente el Modern Jazz?',
  modernjazzFaqA1:
    'El Modern Jazz es un estilo de danza que fusiona la técnica del ballet clásico con la energía y libertad del jazz americano y la danza moderna. Trabaja postura, flexibilidad, giros, saltos y expresión corporal.',

  modernjazzFaqQ2: '¿Necesito experiencia previa en danza para empezar?',
  modernjazzFaqA2:
    'No, nuestras clases están abiertas a todos los niveles. Empezamos desde los fundamentos para que puedas construir una base técnica sólida desde cero.',

  modernjazzFaqQ3: '¿Qué ropa y calzado necesito para las clases?',
  modernjazzFaqA3:
    'Ropa cómoda y ajustada que permita ver las líneas del cuerpo (leggings, maillot o camiseta ajustada). Calzado: zapatillas de jazz, calcetines de danza o pies descalzos, según preferencia.',

  modernjazzFaqQ4: '¿Es el Modern Jazz un buen ejercicio físico?',
  modernjazzFaqA4:
    'Excelente. Trabajas flexibilidad, fuerza, coordinación, resistencia cardiovascular y control corporal. Es un entrenamiento completo que además es divertido.',

  modernjazzFaqQ5: '¿Qué diferencia hay entre Modern Jazz y el Lyrical Jazz?',
  modernjazzFaqA5:
    'El Modern Jazz tiene una base más técnica y académica, influenciada por el ballet clásico y la danza moderna. Se enfoca en la técnica, los giros, saltos y la precisión del movimiento. El Lyrical Jazz, en cambio, pone mayor énfasis en la interpretación emocional y la conexión con la letra de las canciones, con movimientos más fluidos y expresivos. Ambos estilos trabajan la musicalidad, pero el Modern Jazz prioriza la técnica mientras que el Lyrical Jazz prioriza la emoción.',
  ...
  modernjazzFaqA8:
    'Actualmente ofrecemos clases de nivel básico para personas con poca experiencia.',

  modernjazzFaqQ9: '¿Y si falto a una clase por trabajo o compromisos?',
  modernjazzFaqA9:
    'Si tienes una membresía y cancelas una clase, dispones de 30 días para recuperarla desde la fecha de la clase cancelada. Si tienes un abono de horas, gestionas tus clases de forma flexible: cancela y reserva otro día dentro del periodo de caducidad. Todas las gestiones se realizan exclusivamente desde la aplicación digital de la academia.',

  modernjazzFaqQ10: '¿Qué tipo de música se usa en las clases?',
  modernjazzFaqA10:
    'Variada: desde clásicos del jazz y musicales de Broadway hasta música contemporánea. La musicalidad es parte fundamental de la formación.',

  modernjazzFaqQ11: '¿Puedo apuntarme en cualquier momento del año?',
  modernjazzFaqA11:
    'Sí, nuestro sistema es abierto. Puedes incorporarte cuando quieras sin esperar a que empiece un nuevo ciclo.',

  modernjazzFaqQ12: '¿Organizáis actuaciones o galas?',
  modernjazzFaqA12:
    'Sí, tenemos una gala anual donde los alumnos pueden lucirse en un escenario profesional. También organizamos workshops y masterclasses con artistas invitados.',

  modernjazzFaqQ13: '¿Tenéis algún descuento especial?',
  modernjazzFaqA13:
    'Sí. Ofrecemos descuentos si te apuntas a más de un curso. Consulta la web o pregúntanos directamente para más detalles.',

  modernjazzFaqQ14: '¿Dónde está la academia?',
  modernjazzFaqA14:
    'Estamos en Calle Entença 100, 08015 Barcelona. A solo 5 minutos andando de Plaza España y Sants Estació. Perfectamente conectada con metro (L1, L3), bus y tren.',

  modernjazzFaqQ15:
    '¿Dónde puedo encontrar clases de Modern Jazz cerca de Plaza España en Barcelona?',
  modernjazzFaqA15:
    'Farray\'s Center está a solo 5 minutos andando de Plaza España, en Calle Entença 100, 08015 Barcelona. Somos referencia en Modern Jazz en la zona, con conexión directa por metro (L1, L3), bus y tren desde Sants Estació.<br/><br/><strong>Dirección:</strong> <a href="https://maps.google.com/?q=Calle+Entença+100,+08015+Barcelona" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">Calle Entença 100, 08015 Barcelona</a><br/>📞 <strong>Teléfono:</strong> <a href="tel:+34622247085" class="text-primary-accent hover:underline">+34 622 247 085</a><br/>🌐 <strong>Web:</strong> <a href="https://www.farrayscenter.com/contacto" target="_blank" rel="noopener noreferrer" class="text-primary-accent hover:underline">www.farrayscenter.com/contacto</a>',

  modernjazzFaqQ16: '¿Qué consigues en nuestro curso de Modern Jazz en Barcelona?',
  modernjazzFaqA16:
    'La práctica de Modern Jazz aportará una gran flexibilidad a tu cuerpo, además de proporcionarte una excelente forma física. Aprenderás a modular tu respiración para aumentar tu capacidad; practicarás la disociación, fortalecerás tus piernas y mejorarás la movilidad de tu torso y brazos. Todo esto hará posible que crezcan tus habilidades interpretativas y tu expresión corporal. Notarás cómo la unión entre el cuerpo y la música es cada vez más fuerte, y aprenderás a aplicar disciplina y pasión a partes iguales. Si te dedicas profesionalmente al baile, podrás aplicar lo aprendido para mejorar tu técnica sea cual sea la disciplina que impartas.<br/><br/><strong>Beneficios:</strong><br/>✓ Mejora tu técnica de danza<br/>✓ Mejora tu musicalidad<br/>✓ Aprende a disociar tu cuerpo<br/>✓ Aumenta tu repertorio<br/>✓ Ejercita tu coordinación y tu memoria<br/>✓ Mejora tu forma física',

  modernjazzFaqQ17: '¿Cómo funciona nuestro curso de Modern Jazz y para quién está pensado?',
  modernjazzFaqA17:
  ...
  // Accessibility (A11y)
  skipLinks: 'Enlaces de navegación rápida',
  skipToSchedule: 'Ir al horario',
  modernjazzCTAGroup: 'Acciones de reserva',
  modernjazzIdentifyListLabel: 'Situaciones con las que podrías identificarte',
  ...
  modernjazzHowToStep1Name: 'Elige tu nivel',
  ...
  modernjazzHowToStep4Name: 'Disfruta del calentamiento',
  modernjazzHowToStep4Text:
    'La clase comienza con ejercicios de calentamiento y técnica básica. El profesor te guiará paso a paso, adaptándose a tu nivel.',
  modernjazzHowToStep5Name: 'Practica la coreografía',
  modernjazzHowToStep5Text:
    'Tras la técnica, aprenderás secuencias y coreografías. Diviértete, expresa y conecta con la música. ¡Ya eres bailarín de Modern Jazz!',

  // ===== GEO OPTIMIZATION: DefinedTerm Schema =====
  modernjazzDefinedTermModernJazz:
    'El Modern Jazz es un estilo de danza que combina la técnica del ballet clásico con la expresividad del jazz y la danza contemporánea. Nació en EE.UU. en el siglo XX y se caracteriza por movimientos fluidos, giros, saltos y expresión emocional.',
  modernjazzDefinedTermJazzDance:
    'Jazz Dance es el género padre del Modern Jazz, originado en la cultura afroamericana. Incluye estilos como Broadway Jazz, Lyrical Jazz y Funk Jazz. Se caracteriza por su musicalidad, aislaciones corporales y energía.',
  modernjazzDefinedTermBroadway:
    'Broadway Dance es el estilo de danza teatral usado en los musicales de Broadway. Combina jazz, ballet y teatro para contar historias. Requiere técnica, expresión facial y presencia escénica.',
  modernjazzDefinedTermTecnica:
    'Técnica de danza se refiere al conjunto de fundamentos físicos y movimientos específicos de un estilo. En Modern Jazz incluye: pliés, tendus, giros (pirouettes), saltos (jetés), contracciones y extensiones.',
  ...
  // ===== GEO OPTIMIZATION: Citable Statistics (Citabilidad) =====
  ...
  modernjazzStatisticsSource: 'Estudios científicos en danza y salud',
  ...
  // ===== SEO Meta Tags =====
  balletPageTitle: 'Clases de Ballet en Barcelona',
  balletMetaDescription:
    'Clases de ballet clásico en Barcelona para adultos. Aprende técnica, postura y elegancia con maestros formados en la ENA. Academia CID-UNESCO entre Plaza España y Sants. Todos los niveles.',

  // ===== Breadcrumbs =====
  balletBreadcrumbHome: 'Inicio',
  balletBreadcrumbClasses: 'Clases de Baile',
  balletBreadcrumbDance: 'Clases de Danza',
  ...
  balletHeroLocation: 'Academia miembro del CID-UNESCO, entre Plaza España y Sants.',

  // ===== Hero Stats =====
  balletTechniqueStat: '5',
  balletEmpowerment: 'Posiciones Base',
  ...
  balletWhatIsP1:
    'El ballet clásico es más que un estilo de danza; es una disciplina que fortalece tu cuerpo y mente, y mejora tu bienestar general. Más allá de formar bailarines profesionales, el ballet ofrece beneficios accesibles para todos, desde mejorar la postura y el equilibrio hasta potenciar la concentración y la memoria.',
  balletWhatIsP2:
    'Desde finales del siglo XVII, Pierre Beauchamp estableció las cinco posiciones básicas de los pies, que aún hoy constituyen el lenguaje universal del ballet. Aunque nació en Italia, fue en Francia donde esta técnica tomó forma definitiva, por eso usamos términos como plié, tendu y jeté para nombrar sus movimientos más reconocidos.',
  balletWhatIsP3:
    "En Farray's fusionamos la técnica clásica con la potencia explosiva de la escuela de ballet cubana, que formó a Carlos Acosta –considerado durante décadas uno de los mejores bailarines del mundo, comparado con Nureyev y Baryshnikov por su virtuosismo aéreo–. Esta metodología única aporta fuerza atlética, expresividad y musicalidad que potencian cualquier danza, desde el hip hop y el afrobeat hasta el flamenco o la danza contemporánea, convirtiendo el ballet en la base técnica imprescindible para bailarines completos.",
  balletWhatIsP4:
    'Practicar ballet mejora la coordinación motora, la flexibilidad, la fuerza muscular, el equilibrio y la conciencia corporal, facilitando el desarrollo técnico de cualquier bailarín y promoviendo un estilo de vida saludable y disciplinado para quienes simplemente buscan bienestar y expresión corporal.',
  balletWhatIsP5:
    'Nuestro plan formativo, avalado por el CID-UNESCO, integra esta metodología completa para que cada alumno, profesional o aficionado, saque el máximo partido a su cuerpo y mente, logrando una transformación que va mucho más allá del arte de la danza.',
  balletWhatIsQuestionTitle: '¿Crees que es demasiado tarde para ti?',
...
- Desarrolla la propiocepción y conciencia corporal
...
Todos los términos del ballet son en francés, legado de su desarrollo en la corte de Versalles:

- **Plié**: doblar las rodillas manteniendo la espalda recta
- **Tendu**: estirar la pierna manteniendo la punta en el suelo
- **Jeté**: salto de una pierna a otra
- **Pirouette**: giro sobre una pierna
- **Arabesque**: posición con una pierna extendida hacia atrás`,

  // ===== Identification Section =====
  balletIdentifyTitle: '¿Te identificas con alguna de estas situaciones?',
  balletIdentify1:
    'Siempre has querido hacer ballet pero creíste que ya era "demasiado tarde" para comenzar.',
  balletIdentify2:
    'Tu postura ha empeorado con los años y experimentas molestias en la espalda o el cuello.',
  balletIdentify3: 'Bailas otros estilos pero sientes que te falta una base técnica sólida.',
  balletIdentify4:
    'Buscas un ejercicio completo que trabaje tu cuerpo y mente, más allá del simple cardio.',
  balletIdentify5:
    'Te intimida la idea de empezar clases de ballet siendo adulto y sin experiencia previa.',
  balletIdentify6:
    'Quieres una práctica que te ayude a desarrollar disciplina, elegancia y autocontrol.',
  balletIdentifyTransition:
    'Si te identificas con al menos dos de estas situaciones, el ballet puede ser exactamente lo que tu cuerpo y tu mente necesitan.',
  balletIdentifyListLabel: 'Situaciones con las que podrías identificarte',

  // ===== Need to Enroll Section =====
  balletNeedEnrollTitle: '¿Por qué hoy es el mejor momento para empezar a bailar Ballet?',
  balletIdentifyAgitate1:
    'Cada día que pasa tu postura se adapta a posiciones incorrectas, causando dolores crónicos en espalda y cuello. Los músculos se acortan, pierdes movilidad articular y flexibilidad natural con la edad, y tu técnica en otros estilos se estanca sin una base clásica sólida.',
  balletIdentifySolution:
    'El ballet con metodología cubana (la de Carlos Acosta) es el único entrenamiento integral que desarrolla: postura, fuerza, flexibilidad, coordinación, memoria, conciencia espacial, disciplina mental y presencia escénica. No existe otro entrenamiento tan completo.',
  balletIdentifyClosing:
    "En Farray's tenemos adultos que empezaron a los 30, 40 y hasta 50 años –con profesores formados en la escuela cubana–. No es tarde. Es tu momento.",

  // ===== Transformation Section =====
  balletTransformTitle: 'Imagina tu Antes y Después con las clases de Ballet Cubano',
  balletTransform1Title: 'De "demasiado tarde" → Bailarín activo',
  balletTransform1Desc:
    "Antes: Creías que el ballet era solo para niños. Después: Adultos de 30-50 años en Farray's dominan pliés y pirouettes con profesores de la escuela cubana. ¡Nunca es tarde!",
  balletTransform2Title: 'De postura encorvada → Espalda recta y erguida',
  balletTransform2Desc:
    'Antes: Molestias crónicas en espalda y cuello por postura incorrecta. Después: Alineación perfecta con las 5 posiciones de Beauchamp. Hombros abiertos, cabeza alta –la gente lo nota inmediatamente.',
  balletTransform3Title: 'De rígido → Flexible y móvil',
  balletTransform3Desc:
    'Antes: Articulaciones rígidas, pérdida de movilidad con la edad. Después: Flexibilidad, músculos largos, articulaciones libres. Bienestar generalizado.',
  balletTransform4Title: 'De "falta base técnica" → Bailarín completo',
  balletTransform4Desc:
    'Antes: Hip hop/dancehall/contemporáneo/salsa estancados sin alineación clásica. Después: Conciencia espacial + control muscular profundo. Tu técnica despega con base sólida.',
  balletTransform5Title: 'De intimidado → Confiado en clase',
  balletTransform5Desc:
    "Antes: Miedo a entrar a clases de ballet para adultos sin experiencia. Después: Grupos principiantes amigables en Farray's. Pasas de espectador a alumno confiado.",
  balletTransform6Title: 'De disperso → Disciplinado y centrado',
  ...
  balletWhyChoose4Title: 'Salas con barra y espejo profesional',
  balletWhyChoose4Desc:
    'Suelo técnico de danza, barras de madera a la altura correcta, espejos de pared completa. Las condiciones que el ballet necesita.',
  balletWhyChoose5Title: 'Academia multidisciplinar',
  balletWhyChoose5Desc:
    'Complementa tu ballet con Modern Jazz, Contemporáneo o cualquiera de nuestros +25 estilos. Todo bajo el mismo techo.',
  balletWhyChoose6Title: 'Gala anual + masterclasses',
  balletWhyChoose6Desc:
    'Oportunidad de actuar en el escenario del Teatre Condal y asistir a workshops con coreógrafos internacionales.',
  balletWhyChoose7Title: 'Maestros formados en la Escuela Cubana',
  balletWhyChoose7Desc:
    'Daniel Sene y Alejandro Miñoso, formados en la Escuela de Carlos Acosta, una leyenda viva del Ballet.',

  // ===== Logos Section =====
  balletLogosTitle: 'Has podido vernos…',
  balletLogosIntlFestivalsText: 'y en los mejores festivales de danza del mundo',
  ...
  balletTeacher2Specialty: 'Ballet & Modern Jazz & Contemporáneo',
  balletTeacher2Bio:
  ...
  balletFinalCTASubtitle: 'Da el primer paso.',
  balletFinalCTADesc: 'Reserva tu plaza ahora y descubre la elegancia que llevas dentro.',
  balletFinalCTAFunny:
    'Spoiler: después de unas semanas, empezarás a corregir la postura de tus amigos. Es inevitable.',

  // ===== FAQ Section =====
  balletFaqTitle: 'Preguntas Frecuentes sobre nuestras clases de Ballet en Barcelona',

  // FAQs
  balletFaqQ1: '¿Qué es exactamente el ballet clásico?',
  balletFaqA1:
    'El ballet clásico es una forma de danza escénica que se originó en las cortes italianas del Renacimiento y se desarrolló en Francia. Se caracteriza por su técnica codificada (las 5 posiciones de pies creadas por Beauchamp), movimientos elegantes y precisos, y un vocabulario en francés. Es la base técnica de todas las demás formas de danza.',

  balletFaqQ2: '¿Puedo empezar ballet siendo adulto sin experiencia previa?',
  balletFaqA2:
    "Absolutamente. En Farray's tenemos clases específicas para adultos principiantes. No necesitas flexibilidad previa ni ninguna experiencia en danza. Nuestros profesores están especializados en enseñar a adultos que empiezan desde cero.",

  balletFaqQ3: '¿Qué ropa y calzado necesito para las clases de ballet?',
  balletFaqA3:
    'Para empezar, ropa ajustada que permita ver tu postura (mallas, leggins ajustados) y zapatillas de media punta (las clásicas de ballet). Para tu primera clase puedes venir con calcetines y ropa cómoda ajustada. Te orientaremos sobre el equipamiento adecuado.',

  balletFaqQ4: '¿Es el ballet un buen ejercicio físico?',
  balletFaqA4:
    'Excelente. El ballet trabaja todos los grupos musculares, especialmente los estabilizadores del core y la musculatura profunda. Mejora la flexibilidad, la fuerza, el equilibrio y la coordinación. Una clase quema aproximadamente 300-400 calorías y tonifica sin crear volumen muscular.',

  balletFaqQ5: '¿Qué diferencia hay entre ballet clásico y neoclásico?',
  balletFaqA5:
    'El ballet clásico sigue las reglas tradicionales establecidas en los siglos XVII-XIX (posiciones codificadas, tutú, puntas, narrativa). El neoclásico, desarrollado en el siglo XX por coreógrafos como Balanchine, mantiene la técnica clásica pero con mayor libertad de movimiento, vestuario más simple y coreografías más abstractas.',

  balletFaqQ6: '¿Qué diferencia hay entre Ballet Clásico y Contemporáneo Lírico?',
  balletFaqA6:
    'El ballet clásico se basa en una técnica codificada con posiciones y movimientos precisos, puntas, turnout y una estética formal. El contemporáneo lírico combina esa base técnica con mayor libertad expresiva, movimientos fluidos, trabajo de suelo y conexión emocional con la música. En nuestra academia ofrecemos ambos estilos para que explores el que mejor conecte contigo.',

  balletFaqQ7: "¿Quiénes son los profesores de ballet en Farray's?",
  balletFaqA7:
    'Daniel Sene imparte Ballet Intermedio los lunes a las 20h. Alejandro Miñoso, maestro cubano formado en la ENA y ex solista de Carlos Acosta, imparte Ballet Principiantes los jueves a las 11h. Ambos combinan rigor técnico con un enfoque accesible para adultos.',
  ...
  balletFaqA9:
    'Actualmente ofrecemos dos niveles: Principiantes (jueves 11h con Alejandro) para quienes empiezan desde cero o tienen poca experiencia, e Intermedio (lunes 20h con Daniel) para quienes ya dominan las posiciones básicas y ejercicios de barra fundamentales.',

  balletFaqQ10: '¿Y si falto a una clase por trabajo o compromisos?',
  balletFaqA10:
    'Si tienes una membresía y cancelas una clase, dispones de 30 días para recuperarla. Todo se gestiona desde nuestra app, de forma cómoda y sin complicaciones.',

  balletFaqQ11: '¿Qué tipo de música se usa en las clases de ballet?',
  balletFaqA11:
    'Música clásica principalmente: Tchaikovsky, Chopin, Delibes, Minkus... Los grandes compositores del repertorio de ballet. La música está diseñada específicamente para cada ejercicio: adagio para movimientos lentos, allegro para saltos, etc.',

  balletFaqQ12: '¿Puedo apuntarme en cualquier momento del año?',
  balletFaqA12:
    'Sí, las inscripciones están abiertas todo el año. No hay "curso" con fecha de inicio fija. Puedes incorporarte cuando quieras y seguir el ritmo de la clase.',

  balletFaqQ13: '¿Organizáis actuaciones o galas?',
  balletFaqA13:
    'Sí, celebramos una gala anual en uno de los teatros más importantes de Barcelona donde todos los alumnos que lo deseen pueden participar. Es voluntario pero muy recomendable: actuar en un escenario real es parte de la experiencia del bailarín.',

  balletFaqQ14: '¿Tenéis algún descuento especial?',
  balletFaqA14:
    'Sí. Ofrecemos descuentos si te apuntas a más de un curso. Consulta la web o pregúntanos directamente para más detalles.',

  balletFaqQ15: '¿Dónde está la academia?',
  balletFaqA15:
    'Estamos en Calle Entença 100, Barcelona (08015), entre Plaza España y Sants. Puedes llamarnos al <a href="tel:+34622247085">+34 622 247 085</a>, escribirnos a <a href="mailto:info@farrayscenter.com">info@farrayscenter.com</a> o consultar toda la información en <a href="https://www.farrayscenter.com" target="_blank" rel="noopener">www.farrayscenter.com</a>.',

  balletFaqQ16: '¿Necesito mucha flexibilidad para hacer ballet?',
  balletFaqA16:
    'No necesitas flexibilidad previa. La flexibilidad se desarrolla progresivamente con la práctica. Lo importante es empezar; la elasticidad llegará con el tiempo y la constancia. Nuestros profesores adaptan los ejercicios a cada cuerpo.',

  balletFaqQ17: '¿Qué consigues en nuestras clases de Ballet en Barcelona?',
  balletFaqA17:
    'Mejora tu técnica de danza con nuestras clases de Ballet. Adquiere conciencia corporal, nociones de espacio y dinámica del movimiento. Mejora tu coordinación motora, tu memoria, tu equilibrio, tu postura y aumenta la tonicidad y extensión de tus músculos. Transforma tu cuerpo y mantente en forma gracias al exigente trabajo físico que requiere esta disciplina.',

  balletFaqQ18: '¿Cómo funciona el curso de Ballet y para quién está pensado?',
  balletFaqA18:
  ...
  balletHowToStep1Name: 'Elige tu nivel',
  ...
  balletHowToStep4Name: 'Disfruta de la barra',
  balletHowToStep4Text:
    'La clase comienza en la barra con ejercicios de calentamiento y técnica básica. El profesor te guiará paso a paso.',
  balletHowToStep5Name: 'Practica en el centro',
  balletHowToStep5Text:
    'Tras la barra, trabajamos en el centro de la sala: equilibrios, giros y pequeñas secuencias. ¡Ya eres bailarín de ballet!',

  // ===== DefinedTerm Schema =====
  balletDefinedTermBallet:
    'El ballet es una forma de danza escénica que se originó en las cortes italianas del Renacimiento y se desarrolló en Francia. Se caracteriza por técnica codificada, movimientos elegantes y vocabulario en francés.',
  balletDefinedTermDanzaClasica:
    'Danza clásica es sinónimo de ballet. Se refiere a la forma de danza basada en la técnica académica desarrollada en las academias reales europeas desde el siglo XVII.',
  balletDefinedTermBarra:
    'La barra de ballet es el soporte de madera fijado a la pared o independiente que los bailarines usan para apoyarse durante los ejercicios de calentamiento y técnica.',
  balletDefinedTermPosiciones:
    'Las 5 posiciones de ballet fueron codificadas por Pierre Beauchamp en 1700. Son la base de todos los movimientos del ballet clásico y definen la colocación de pies y brazos.',
  ...
  // ===== Citable Statistics =====
  balletStatistics:
    'Estudios científicos demuestran que el ballet mejora la densidad ósea, la postura, la flexibilidad y reduce el estrés. Es uno de los ejercicios más completos que existen.',
  balletCitableFact1:
    'Una clase de ballet quema entre 300 y 400 calorías y tonifica todos los grupos musculares, especialmente core, piernas y glúteos.',
  balletCitableFact2:
...
**"Farray's Contemporáneo (especialistas ENA/ENBC): 300-500 cal/hora, flexibilidad/fuerza/coordinación. Plan CID-UNESCO, 5/5 Google (500+ reseñas)."**`,
  ...
  contemporaneoCitableDefinicion:
    '**"La danza contemporánea es una disciplina ecléctica que integra técnicas de Martha Graham (contracción-release), José Limón (fall and recovery) y Merce Cunningham (azar compositivo). Se caracteriza por el trabajo de suelo (floorwork), la improvisación, la conexión emocional con la música y el desarrollo de un lenguaje corporal propio."**',
  contemporaneoCitableOrigen:
    '**"La danza contemporánea tiene sus raíces en la danza moderna americana de principios del siglo XX. Pioneras como Isadora Duncan (1877–1927) rechazaron las zapatillas de punta del ballet clásico buscando movimiento natural. Ruth St. Denis y Ted Shawn fundaron la Denishawn School en 1915, semillero de la siguiente generación de coreógrafos."**',
  contemporaneoCitableTecnicas:
    '**"Las técnicas fundamentales del contemporáneo incluyen: contracción-release (Graham), fall and recovery (Limón), release technique, contact improvisation (años 70), floorwork y trabajo de suelo. El contemporáneo lírico añade conexión emocional y narrativa musical al movimiento."**',
  contemporaneoCitableMetodologia:
    '**"En Farray\'s Center, las clases de Contemporáneo son impartidas por profesores especialistas formados en la Escuela Cubana de Danza (ENA y ENBC). La metodología combina técnica de conservatorio con expresividad latina, ofreciendo tres modalidades: Lírico Básico, Lírico Intermedio y Suelo & Flow."**',
  contemporaneoCitableEvolucionGlobal:
    '**"La danza contemporánea evolucionó desde la ruptura con el ballet clásico hasta convertirse en una disciplina global. Cuba creó desde 1959 su propia escuela (Ramiro Guerra), integrando moderna americana, clásica y folclórica afrocubana. ENA y ENBC forman bailarines versátiles con metodología de conservatorio reconocida mundialmente."**',
  contemporaneoCitableExpresionCorporal:
    '**"El contemporáneo desarrolla la expresión corporal a través de ejercicios guiados y libres, coreografía e improvisación. Se trabaja tanto a nivel individual como grupal, profundizando en técnica de danza mientras se entrena con movimientos musculares intensos y armónicos."**',
  contemporaneoCitableImprovisacion:
    '**"La improvisación es elemento central del contemporáneo. Permite explorar el movimiento sin estructura predefinida, desarrollando creatividad, conciencia corporal y la capacidad de responder orgánicamente a la música y al espacio. Es herramienta fundamental para encontrar el lenguaje corporal propio."**',
  contemporaneoCitableFact1:
    'Una clase de danza contemporánea quema entre 300 y 500 calorías por hora, combinando trabajo cardiovascular con flexibilidad, fuerza funcional y coordinación.',
  contemporaneoCitableFact2:
    'El floorwork (trabajo de suelo) distingue al contemporáneo de otras disciplinas: release technique, contact improvisation y transiciones orgánicas entre suelo y aire fortalecen core y movilidad articular.',
  contemporaneoCitableFact3:
    "Farray's International Dance Center ofrece Contemporáneo con profesores formados en la Escuela Cubana (ENA/ENBC), avalado por el CID-UNESCO, con más de 500 reseñas de 5 estrellas en Google.",
  contemporaneoCitableLegado:
    '**"El legado de la danza contemporánea pervive en la fusión de técnicas clásicas y modernas, en la libertad de explorar el movimiento sin límites estructurales, y en su capacidad de transformar tanto el cuerpo como la expresión artística del bailarín. Es disciplina fundamental para cualquier formación dancística integral."**',
...
**"Afro Jazz Barcelona: destino mundial para formación original. Versatilidad, certificación CID-UNESCO, repertorio exclusivo."**`,
  ...
  afrojazzFaqA10:
    'Sí. Aunque el Afro Jazz está abierto a todos los niveles, los bailarines profesionales encontrarán en esta disciplina una forma de ampliar su versatilidad y vocabulario de movimiento. Es ideal tanto para iniciarse como para perfeccionarse.',
  ...
  afrojazzCitableEvolucionGlobal:
    'El Afro Jazz ha ganado reconocimiento internacional como disciplina accesible para todos los niveles. Academias de todo el mundo lo incorporan como herramienta para ampliar el vocabulario de movimiento y desarrollar bailarines más completos, desde principiantes hasta profesionales.',
  ...
  hiphopCulturalFull: `### Los Orígenes: El South Bronx de Nueva York (1973-1974)
...
Nuestro profesor **Marcos Martínez**, juez de competiciones internacionales y referente del Hip Hop en España, transmite no solo técnica sino los valores y la historia que hacen de este estilo algo único.`,
  ...
  salsaCubanaMetaDescription:
    'Aprende a bailar salsa cubana en Barcelona con el Método Farray®. Clases para todos los niveles con Yunaisy Farray, maestra CID-UNESCO. Guía, seguimiento, musicalidad y conexión de pareja.',

  // Breadcrumb
  salsaCubanaBreadcrumbHome: 'Inicio',
  salsaCubanaBreadcrumbClasses: 'Clases de Baile',
  salsaCubanaBreadcrumbLatin: 'Salsa y Bachata',
  ...
  salsaCubanaProblemSubtitle: '(y por qué la mayoría no progresa)',
  salsaCubanaProblemP1:
    'Vas a una academia de salsa cubana. Te enseñan figuras: enchufla, dile que no, setenta, vacílala. Las memorizas. Las repites. Aprendes 20, 30, 50 figuras.',
  salsaCubanaProblemP2: 'Pero cuando llegas a una fiesta real, algo falla.',
  salsaCubanaProblemP3:
    'No sabes cuándo meter cada figura. Tu pareja no te entiende. Te sientes rígido. Cuentas "1, 2, 3... 5, 6, 7" en tu cabeza en vez de sentir la música. Y si bailas con alguien que no conoce las mismas figuras que tú, te bloqueas.',
  salsaCubanaProblemConclusion: 'El problema: Te enseñaron a repetir secuencias, no a bailar.',
  salsaCubanaProblemExplanation:
    'La mayoría de academias enseñan "casino social": figuras sueltas que memorizas y ejecutas mecánicamente. Funciona en clase, con tu compañero habitual, con la canción que ya conoces. Pero no te convierte en bailarín.',
  ...
  salsaCubanaCompareRow1Col1: 'Te enseñan figuras desde el día 1',
  salsaCubanaCompareRow1Col2: 'Te enseñamos fundamentos técnicos primero',
  salsaCubanaCompareRow2Col1: 'Memorizas secuencias',
  salsaCubanaCompareRow2Col2: 'Desarrollas comprensión del movimiento',
  salsaCubanaCompareRow3Col1: '"El hombre guía, la mujer sigue"',
  salsaCubanaCompareRow3Col2: 'Ambos roles son técnicos y activos',
  salsaCubanaCompareRow4Col1: 'Cuentas "1, 2, 3... 5, 6, 7"',
  salsaCubanaCompareRow4Col2: 'Desarrollas musicalidad real',
  salsaCubanaCompareRow5Col1: 'Funciona con tu pareja de clase',
  salsaCubanaCompareRow5Col2: 'Funciona con cualquier persona',
  salsaCubanaCompareRow6Col1: 'Aprendes 50 figuras, usas 5',
  salsaCubanaCompareRow6Col2: 'Aprendes principios que generan infinitas figuras',
  salsaCubanaCompareRow7Col1: 'Baile rígido y mecánico',
  salsaCubanaCompareRow7Col2: 'Baile fluido, elegante y natural',
  salsaCubanaCompareRow8Col1: 'Estancamiento después de meses',
  salsaCubanaCompareRow8Col2: 'Progresión continua con bases sólidas',

  // Technical Program Section
  salsaCubanaTechProgramTitle: 'El programa técnico del Método Farray®',
  salsaCubanaTechProgramSubtitle: 'Un enfoque estructurado para hombres y mujeres',

  // For Men
  salsaCubanaTechMenTitle: 'Para el hombre: El arte de la guía',
  salsaCubanaTechMenDesc:
    'El hombre perfecciona su guía, imprescindible para un buen desarrollo de las figuras y movimientos. El baile es un lenguaje. El hombre debe aprender a expresarse correctamente para que su pareja pueda interpretar sus impulsos.',
  salsaCubanaTechMenItem1: 'Técnica de impulsos: claros, precisos, nunca bruscos',
  salsaCubanaTechMenItem2: 'Agarre correcto: seguro pero cómodo, sin riesgo de hacer daño',
  salsaCubanaTechMenItem3: 'Comunicación corporal: tu cuerpo habla antes que tus manos',
  salsaCubanaTechMenItem4: 'Timing musical: guiar EN la música, no sobre ella',
  salsaCubanaTechMenResult: 'El resultado: tu pareja te entiende sin esfuerzo. Cualquier pareja.',

  // For Women
  salsaCubanaTechWomenTitle: 'Para la mujer: Dominio corporal, no "seguir" pasivamente',
  salsaCubanaTechWomenDesc:
    'En el estilo cubano tradicional, la mujer "simplemente sigue". En el Método Farray®, esto cambia radicalmente. La mujer adquiere un mayor dominio de su cuerpo y conciencia de su rol en la pareja. No sigue pasivamente — reacciona de manera técnica y elegante.',
  salsaCubanaTechWomenItem1: 'Técnica de piernas: base sólida, giros controlados',
  ...
  salsaCubanaTechMusicDesc:
    'La mayoría de academias te enseñan a contar tiempos. Nosotros te enseñamos a escuchar la música.',
  salsaCubanaTechMusicItem1: 'Identificar el ritmo y los acentos',
  salsaCubanaTechMusicItem2: 'Sentir cuándo "pide" un cambio la canción',
  salsaCubanaTechMusicItem3: 'Improvisar dentro de la estructura musical',
  salsaCubanaTechMusicItem4: 'Bailar CON la música, no SOBRE ella',
  salsaCubanaTechMusicResult: 'Cuando desarrollas musicalidad real, las figuras fluyen solas.',

  // Benefits Section
  salsaCubanaBenefitsTitle: 'Entrena tu cuerpo y tu oído',
  salsaCubanaBenefitsSubtitle: 'Aprenderás de manera fácil y divertida con nuestro método',
  salsaCubanaBenefit1: 'Mejora tu capacidad de improvisación e interpretación musical',
  salsaCubanaBenefit2: 'Desarrolla tu ritmo natural (sí, todos lo tienen)',
  salsaCubanaBenefit3: 'Ejercita tu coordinación motora y memoria',
  ...
  salsaCubanaMetodoPillar2Title: 'Seguimiento Técnico',
  salsaCubanaMetodoPillar2Desc:
    'La mujer adquiere un mayor dominio de su cuerpo y conciencia de su rol en la pareja, reaccionando de manera técnica y elegante a todos los impulsos ejecutados.',
  salsaCubanaMetodoPillar3Title: 'Musicalidad',
  salsaCubanaMetodoPillar3Desc:
    'Entrena tu oído y mejora tu capacidad de improvisación e interpretación musical. Aprende a identificar los tiempos y a bailar con la música, no solo encima de ella.',
  salsaCubanaMetodoPillar4Title: 'Conexión de Pareja',
  salsaCubanaMetodoPillar4Desc:
    'Domina el lenguaje no verbal del baile. Aprende a comunicarte con tu pareja a través del contacto, la tensión correcta y los impulsos precisos.',
  salsaCubanaMetodoPillar5Title: 'Técnica Corporal',
  salsaCubanaMetodoPillar5Desc:
    'Aprende cómo utilizar piernas, brazos y peso del cuerpo para dar mayor efectividad y estética a todos tus movimientos.',
  salsaCubanaMetodoPillar6Title: 'Cultura Cubana',
  salsaCubanaMetodoPillar6Desc:
    'Adéntrate en el mundo de la salsa cubana: su historia, sus verdaderos orígenes, y darás un sentido y un sentimiento a todos los pasos que ejecutes.',
  ...
  salsaCubanaLevelsSubtitle: 'Un camino estructurado para tu evolución como bailarín',
  salsaCubanaLevel0Title: 'Nivel 0 - Iniciación',
  salsaCubanaLevel0Desc:
    'Para los que nunca han bailado. Aprende los pasos básicos, el ritmo fundamental y la postura correcta desde cero.',
  salsaCubanaLevelBasic1Title: 'Básico I',
  salsaCubanaLevelBasic1Desc:
    'Consolida los fundamentos, mejora tu coordinación y empieza a trabajar la conexión con tu pareja.',
  salsaCubanaLevelBasic2Title: 'Básico II',
  salsaCubanaLevelBasic2Desc:
    'Introduce las primeras figuras, trabaja la fluidez y desarrolla tu musicalidad básica.',
  ...
  salsaCubanaLevelAdvancedTitle: 'Avanzado',
  salsaCubanaLevelAdvancedDesc:
    'Dominio técnico completo, coreografías complejas, musicalidad avanzada y preparación para performances.',

  // Teachers Section
  salsaCubanaTeachersTitle: 'Nuestros Maestros de Salsa Cubana',
  salsaCubanaTeachersSubtitle: 'Equipo profesional certificado con el Método Farray®',
  salsaCubanaTeacher1Specialty: 'Creadora del Método Farray® • Maestra CID-UNESCO',
  salsaCubanaTeacher1Bio:
    'Yunaisy Farray, icono mundial de la danza cubana, ha desarrollado el Método Farray® a lo largo de más de 25 años de experiencia internacional. Formada en Cuba, ha impartido clases y talleres en Finlandia, Italia, Alemania y España, perfeccionando un sistema didáctico que permite a cualquier persona aprender a bailar salsa cubana de forma rápida, eficiente y con estilo auténtico.',
  salsaCubanaTeacher2Name: 'Iroel Bastarreche',
  salsaCubanaTeacher2Specialty: 'Profesor de Salsa Cubana • Método Farray®',
  salsaCubanaTeacher2Bio:
    'Iroel Bastarreche es un bailarín y profesor cubano con una sólida formación en casino y son cubano. Certificado en el Método Farray®, aporta autenticidad y pasión caribeña a cada clase, transmitiendo la esencia del baile social cubano con técnica depurada y carisma.',
  ...
  salsaCubanaTransform2Title: 'Guiar/Seguir con Elegancia',
  salsaCubanaTransform2Desc:
    'Aprenderás a comunicarte con tu pareja a través del baile de forma técnica, segura y elegante.',
  salsaCubanaTransform3Title: 'Conectar con la Música',
  salsaCubanaTransform3Desc:
    'Desarrollarás tu oído musical y tu capacidad de improvisación e interpretación.',
  salsaCubanaTransform4Title: 'Disfrutar en la Pista',
  salsaCubanaTransform4Desc:
    'Bailarás con confianza en cualquier lugar, disfrutando al máximo de cada canción.',
  salsaCubanaTransform5Title: 'Quemar Calorías',
  salsaCubanaTransform5Desc:
    'Mantente en forma todo el año quemando hasta 400 calorías por clase mientras te diviertes.',
  salsaCubanaTransform6Title: 'Vivir la Cultura Cubana',
  ...
  // Video Section
  salsaCubanaVideoTitle: 'Mira Cómo Bailamos',
  salsaCubanaVideoDesc: 'Descubre el ambiente de nuestras clases de salsa cubana en Barcelona',
...
"El Método Farray® enseña técnicas específicas para que la comunicación entre bailarines sea clara, segura y elegante, respetando la esencia del Casino cubano."`,
  ...
  salsaCubanaFaqQ14: '¿La salsa cubana es buena para ponerse en forma?',
  salsaCubanaFaqA14:
    'Excelente. Bailar salsa quema entre 300-400 calorías por hora, mejora la coordinación, la memoria y reduce el estrés. Es ejercicio disfrazado de diversión.',
  salsaCubanaFaqQ15: '¿Qué hace especial a Yunaisy Farray como maestra?',
  salsaCubanaFaqA15:
    'Yunaisy es miembro del CID-UNESCO, ha desarrollado el único Método Farray® en el mundo, y tiene más de 25 años de experiencia internacional formando bailarines en Cuba, Europa y España.',

  // Local SEO Section
  salsaCubanaNearbyTitle: 'Clases de Salsa Cubana cerca de ti en Barcelona',
  salsaCubanaNearbyDesc:
    "Nuestra academia está ubicada en el corazón de Barcelona, fácilmente accesible desde toda la ciudad. Somos la academia de referencia para clases de Salsa en la zona de Plaza España, Sants, Hostafrancs, Les Corts y Eixample Esquerra. También recibimos alumnos de Poble Sec, Sant Antoni y L'Hospitalet que buscan formación en bailes latinos con metodología profesional.",
  salsaCubanaNearbySearchText:
    '¿Buscas clases de salsa cubana cerca de tu barrio? Estamos a pocos minutos de:',
  salsaCubanaNearbyMetro:
    'Metro: Plaza España (L1, L3), Rocafort (L1) - 5 min andando, Entença (L5) - 5 min andando o Hostafrancs (L1) - 5 min andando.',

  // Course Schema
  salsaCubanaCourseSchemaName: 'Curso de Salsa Cubana - Método Farray®',
  salsaCubanaCourseSchemaDesc:
    'Aprende salsa cubana auténtica en Barcelona con el exclusivo Método Farray®. Clases para todos los niveles con certificación CID-UNESCO.',

  // GEO Citable Content
  salsaCubanaCitableDefinicion:
    'La salsa cubana, conocida como "Casino" en Cuba, es un estilo de baile en pareja caracterizado por movimientos circulares, giros hacia adentro y una conexión cercana entre bailarines. Se diferencia de la salsa en línea por su carácter más relajado y juguetón.',
  salsaCubanaCitableOrigen:
    'El Casino surgió en La Habana, Cuba, durante la década de 1950 en clubes sociales como el Casino Deportivo. Es una fusión del Son Cubano, Mambo, Cha-cha-chá y ritmos afrocubanos.',
  salsaCubanaCitableMetodoFarray:
    'El Método Farray® es un sistema didáctico único desarrollado por Yunaisy Farray que prioriza la guía, el seguimiento, la musicalidad y la conexión de pareja antes de enseñar figuras complejas.',
  salsaCubanaCitableGuiaSeguimiento:
    'En el baile de pareja, la guía (lead) y el seguimiento (follow) son habilidades fundamentales. El Método Farray® enseña técnicas específicas para que la comunicación entre bailarines sea clara, segura y elegante.',
  ...
  salsaCubanaStatistics:
    'Según estudios de fitness, bailar salsa quema entre 300-400 calorías por hora, mejora la coordinación motora, fortalece la memoria y reduce los niveles de estrés y ansiedad.',
  salsaCubanaCitableEvolucionGlobal:
    'Desde Cuba, la salsa se expandió globalmente a partir de los años 70, desarrollándose diferentes estilos como la salsa en línea (LA, NY) y manteniéndose el Casino como el estilo tradicional cubano.',
  salsaCubanaCitableRueda:
    'La Rueda de Casino es una forma grupal de bailar salsa cubana donde múltiples parejas forman un círculo y ejecutan figuras sincronizadas bajo la dirección de un "cantante" o líder.',
  salsaCubanaCitableFact1:
    'Bailar salsa cubana quema entre 300-400 calorías por hora, siendo comparable a deportes como natación moderada o ciclismo recreativo.',
  salsaCubanaCitableFact2:
    'El Método Farray® ha formado a más de 15.000 alumnos en países como Finlandia, Italia, Alemania y España desde su creación.',
  salsaCubanaCitableFact3:
    "Farray's International Dance Center es una academia acreditada por el CID-UNESCO, el Consejo Internacional de la Danza de la UNESCO, garantizando estándares internacionales de enseñanza.",
  salsaCubanaCitableLegado:
    'La salsa cubana representa el legado cultural de Cuba, fusionando tradiciones africanas y españolas en un baile que expresa alegría, sensualidad y conexión humana.',

  // ========== LATIN DANCE COMPARISON TABLE (Shared) ==========
  latinDanceCompareTitle: 'Comparativa de Bailes Latinos',
  latinDanceCompareSubtitle:
    'Descubre las diferencias entre los estilos de baile latino que enseñamos',
  ...
  latinDanceCompare_timbaPareja: 'Timba en Pareja',
  latinDanceCompare_folkloreCubano: 'Folklore Cubano',
  latinDanceCompare_sonCubano: 'Son Cubano',
  latinDanceCompare_salsaLadyTimba: 'Lady Timba',

  // Row labels (characteristics)
  latinDanceCompareRow1: 'Musicalidad / Interpretación',
  latinDanceCompareRow2: 'Conexión de pareja',
  latinDanceCompareRow3: 'Trabajo de caderas',
  latinDanceCompareRow4: 'Giros y vueltas',
  latinDanceCompareRow5: 'Expresión corporal',
  latinDanceCompareRow6: 'Técnica de pies (footwork)',
  latinDanceCompareRow7: 'Estilo libre / Improvisación',
  latinDanceCompareRow8: 'Folklore / Tradición cultural',
  latinDanceCompareRow9: 'Sensualidad',
  latinDanceCompareRow10: 'Exigencia física / Cardio',
  latinDanceCompareRow11: 'Versatilidad para baile social',

  // Meaning section - Salsa Cubana specific
  latinDanceCompareMeaningTitle: '¿Qué significa esto para ti?',
  latinDanceCompareMeaning1Title_salsaCubana: 'Si quieres bailar en fiestas y sociales:',
  latinDanceCompareMeaning1Desc_salsaCubana:
    'La Salsa Cubana es perfecta. Máxima versatilidad para bailar con cualquier persona en cualquier lugar.',
  latinDanceCompareMeaning2Title_salsaCubana: 'Si buscas conexión auténtica con tu pareja:',
  latinDanceCompareMeaning2Desc_salsaCubana:
    'El Método Farray® se centra precisamente en la guía y seguimiento. Aprenderás a comunicarte sin palabras.',
  latinDanceCompareMeaning3Title_salsaCubana: 'Si te interesa la cultura cubana:',
  latinDanceCompareMeaning3Desc_salsaCubana:
    'Salsa Cubana, Son y Folklore comparten raíces. Empezar por Salsa Cubana te abre las puertas a todo el universo cubano.',
  latinDanceCompareMeaning4Title_salsaCubana: 'Si quieres un ejercicio completo:',
  latinDanceCompareMeaning4Desc_salsaCubana:
    'Combina Salsa Cubana con Timba para un entrenamiento cardiovascular intenso mientras te diviertes.',
  latinDanceCompareConclusion_salsaCubana:
    'La Salsa Cubana es la base perfecta para explorar todos los bailes latinos. Con el Método Farray® dominarás los fundamentos que te permitirán evolucionar hacia cualquier estilo.',

  // Meaning section - Bachata specific
  latinDanceCompareMeaning1Title_bachata: 'Si buscas un baile romántico y sensual:',
  latinDanceCompareMeaning1Desc_bachata:
    'La Bachata destaca en sensualidad y conexión cercana. Ideal para parejas que quieren bailar juntos.',
  latinDanceCompareMeaning2Title_bachata: 'Si prefieres ritmos más lentos:',
  latinDanceCompareMeaning2Desc_bachata:
    'La Bachata tiene un tempo más relajado que la Salsa, permitiéndote disfrutar cada movimiento.',
  latinDanceCompareMeaning3Title_bachata: 'Si quieres versatilidad social:',
  latinDanceCompareMeaning3Desc_bachata:
    'La Bachata se baila en todo el mundo. Dominarla te permite disfrutar en cualquier fiesta latina.',
  latinDanceCompareMeaning4Title_bachata: 'Si te gusta el trabajo de caderas:',
  latinDanceCompareMeaning4Desc_bachata:
    'La Bachata desarrolla especialmente el movimiento de caderas y la expresión corporal.',
  latinDanceCompareConclusion_bachata:
    'La Bachata es el complemento perfecto de la Salsa. Juntas forman la pareja ideal para disfrutar de cualquier fiesta latina.',

  // Meaning section - Timba specific
  latinDanceCompareMeaning1Title_timba: 'Si buscas intensidad y energía:',
  latinDanceCompareMeaning1Desc_timba:
    'La Timba es el estilo más dinámico y exigente. Perfecta para quienes quieren un reto físico.',
  latinDanceCompareMeaning2Title_timba: 'Si te apasiona la música cubana moderna:',
  latinDanceCompareMeaning2Desc_timba:
    'La Timba nació de la fusión del Son con jazz, funk y música afrocubana. Es pura energía cubana.',
  latinDanceCompareMeaning3Title_timba: 'Si quieres destacar en la pista:',
  latinDanceCompareMeaning3Desc_timba:
    'La Timba permite mucha improvisación y estilo personal. Es el estilo que más llama la atención.',
  latinDanceCompareMeaning4Title_timba: 'Si ya bailas salsa y quieres evolucionar:',
  latinDanceCompareMeaning4Desc_timba:
    'La Timba es el siguiente nivel natural después de dominar la Salsa Cubana básica.',
  latinDanceCompareConclusion_timba:
    'La Timba representa la evolución más moderna y energética de los bailes cubanos. Requiere una buena base de Salsa Cubana.',

  // Meaning section - Salsa Lady Style specific
  latinDanceCompareMeaning1Title_salsaLadyStyle: 'Si quieres desarrollar tu estilo propio:',
  latinDanceCompareMeaning1Desc_salsaLadyStyle:
    'Salsa Lady Style se centra en la expresión individual, los giros y el trabajo corporal femenino.',
  latinDanceCompareMeaning2Title_salsaLadyStyle: 'Si bailas salsa y quieres brillar más:',
  latinDanceCompareMeaning2Desc_salsaLadyStyle:
    'Este estilo complementa tu baile en pareja, añadiendo elegancia y presencia en cada paso.',
  latinDanceCompareMeaning3Title_salsaLadyStyle: 'Si prefieres bailar sola o en grupo:',
  latinDanceCompareMeaning3Desc_salsaLadyStyle:
    'Lady Style es perfecto para practicar sin pareja y desarrollar tu técnica individual.',
  latinDanceCompareMeaning4Title_salsaLadyStyle: 'Si quieres mejorar tu técnica de giros:',
  latinDanceCompareMeaning4Desc_salsaLadyStyle:
    'Los giros y vueltas son el punto fuerte del Lady Style. Ganarás equilibrio y control.',
  latinDanceCompareConclusion_salsaLadyStyle:
    'Salsa Lady Style es el complemento ideal para cualquier bailarina de salsa que quiera desarrollar su presencia y estilo único.',

  // Meaning section - Bachata Lady Style specific
  latinDanceCompareMeaning1Title_bachataLadyStyle: 'Si quieres expresarte con sensualidad:',
  latinDanceCompareMeaning1Desc_bachataLadyStyle:
    'Bachata Lady Style potencia la sensualidad y la expresión corporal femenina al máximo.',
  latinDanceCompareMeaning2Title_bachataLadyStyle: 'Si te gusta el movimiento ondulante:',
  latinDanceCompareMeaning2Desc_bachataLadyStyle:
    'Este estilo desarrolla especialmente las ondas, el body movement y el trabajo de caderas.',
  latinDanceCompareMeaning3Title_bachataLadyStyle: 'Si quieres confianza en ti misma:',
  latinDanceCompareMeaning3Desc_bachataLadyStyle:
    'Bachata Lady Style te ayuda a conectar con tu feminidad y ganar seguridad al bailar.',
  latinDanceCompareMeaning4Title_bachataLadyStyle: 'Si complementas tu bachata en pareja:',
  latinDanceCompareMeaning4Desc_bachataLadyStyle:
    'Añade estilo y elegancia a tu rol de seguidora con técnicas específicas para mujeres.',
  latinDanceCompareConclusion_bachataLadyStyle:
    'Bachata Lady Style es perfecto para mujeres que quieren potenciar su feminidad y expresión en la pista de baile.',

  // Meaning section - Timba en Pareja specific
  latinDanceCompareMeaning1Title_timbaPareja: 'Si quieres el máximo desafío en pareja:',
  latinDanceCompareMeaning1Desc_timbaPareja:
    'Timba en Pareja combina la intensidad de la Timba con la conexión del baile de pareja.',
  latinDanceCompareMeaning2Title_timbaPareja: 'Si dominas la Salsa Cubana:',
  latinDanceCompareMeaning2Desc_timbaPareja:
    'Es el siguiente paso natural. Lleva tu baile en pareja al nivel más alto de complejidad.',
  latinDanceCompareMeaning3Title_timbaPareja: 'Si te gusta improvisar con tu pareja:',
  latinDanceCompareMeaning3Desc_timbaPareja:
    'La Timba en Pareja permite mucha creatividad y comunicación no verbal avanzada.',
  latinDanceCompareMeaning4Title_timbaPareja: 'Si buscas un entrenamiento intenso:',
  latinDanceCompareMeaning4Desc_timbaPareja:
    'Es uno de los estilos más exigentes físicamente. Cardio puro mientras bailas.',
  latinDanceCompareConclusion_timbaPareja:
    'Timba en Pareja es para bailarines avanzados que quieren llevar su conexión y técnica al máximo nivel.',

  // Meaning section - Folklore Cubano specific
  latinDanceCompareMeaning1Title_folkloreCubano: 'Si te fascina la cultura afrocubana:',
  latinDanceCompareMeaning1Desc_folkloreCubano:
    'El Folklore Cubano conecta con las raíces africanas de Cuba: los orishas, los toques de tambor, la tradición.',
  latinDanceCompareMeaning2Title_folkloreCubano: 'Si buscas expresión espiritual:',
  latinDanceCompareMeaning2Desc_folkloreCubano:
    'Es un baile con profundo significado cultural y espiritual, más allá del entretenimiento.',
  latinDanceCompareMeaning3Title_folkloreCubano: 'Si quieres entender los orígenes:',
  latinDanceCompareMeaning3Desc_folkloreCubano:
    'El Folklore es la raíz de todos los bailes cubanos. Entenderlo enriquece cualquier otro estilo.',
  latinDanceCompareMeaning4Title_folkloreCubano: 'Si te gusta el trabajo corporal intenso:',
  latinDanceCompareMeaning4Desc_folkloreCubano:
    'El Folklore desarrolla la disociación corporal, el trabajo de caderas y la expresión emocional.',
  latinDanceCompareConclusion_folkloreCubano:
    'El Folklore Cubano es la conexión más profunda con la cultura y tradiciones de Cuba. Es el alma de todos los bailes cubanos.',

  // Meaning section - Son Cubano specific
  latinDanceCompareMeaning1Title_sonCubano: 'Si te gusta la elegancia clásica:',
  latinDanceCompareMeaning1Desc_sonCubano:
    'El Son Cubano es el padre de la Salsa. Elegante, musical y profundamente cubano.',
  latinDanceCompareMeaning2Title_sonCubano: 'Si valoras la tradición:',
  latinDanceCompareMeaning2Desc_sonCubano:
    'El Son es patrimonio cultural de Cuba. Bailarlo es conectar con más de 100 años de historia.',
  latinDanceCompareMeaning3Title_sonCubano: 'Si quieres mejorar tu musicalidad:',
  latinDanceCompareMeaning3Desc_sonCubano:
    'El Son desarrolla profundamente la interpretación musical y el sentido del ritmo.',
  latinDanceCompareMeaning4Title_sonCubano: 'Si prefieres un ritmo más pausado:',
  latinDanceCompareMeaning4Desc_sonCubano:
    'El Son es más lento que la Salsa moderna, permitiendo saborear cada tiempo de la música.',
  latinDanceCompareConclusion_sonCubano:
    'El Son Cubano es la raíz elegante de la Salsa. Dominarlo te da una comprensión profunda de toda la música cubana.',

  // Meaning section - Salsa Lady Timba specific
  latinDanceCompareMeaning1Title_salsaLadyTimba: 'Si quieres el estilo femenino más potente:',
  latinDanceCompareMeaning1Desc_salsaLadyTimba:
    'Lady Timba combina la intensidad de la Timba con la expresión del Lady Style. Máxima energía y estilo.',
  latinDanceCompareMeaning2Title_salsaLadyTimba: 'Si dominas Lady Style y quieres más:',
  latinDanceCompareMeaning2Desc_salsaLadyTimba:
    'Es la evolución natural del Salsa Lady Style hacia un nivel más dinámico y exigente.',
  latinDanceCompareMeaning3Title_salsaLadyTimba: 'Si te gusta improvisar:',
  latinDanceCompareMeaning3Desc_salsaLadyTimba:
    'Lady Timba tiene la mayor libertad para la improvisación y el estilo personal.',
  latinDanceCompareMeaning4Title_salsaLadyTimba: 'Si buscas un entrenamiento completo:',
...
**El Salsa Lady Style se ha convertido en una herramienta de empoderamiento femenino a nivel mundial**, permitiendo a las mujeres conectar con su feminidad, ganar confianza y expresarse libremente a través del baile. No es solo una disciplina técnica: es un camino de desarrollo personal que transforma la forma en que las mujeres se perciben y se mueven en el mundo.`,
  ...
  // SEO & Meta
  bachataLadyPageTitle: 'Clases de Bachata Lady Style en Barcelona | Estilo Femenino y Sensualidad',
  bachataLadyMetaDescription:
    'Aprende Bachata Lady Style en Barcelona con el Método Farray®. Ondulaciones, sensualidad, técnica femenina y estilo personal. Academia CID-UNESCO cerca de Plaza España.',
  bachataLadyCourseSchemaDesc:
    'Clases de Bachata Lady Style en Barcelona. Aprende ondulaciones, movimientos sensuales y técnica femenina con maestras cubanas especializadas.',

  // Breadcrumb
  bachataLadyBreadcrumbHome: 'Inicio',
  bachataLadyBreadcrumbClasses: 'Clases de Baile',
  bachataLadyBreadcrumbLatin: 'Salsa y Bachata',
  bachataLadyBreadcrumbCurrent: 'Bachata Lady Style',

  // Hero
  bachataLadyHeroTitle: 'Bachata Lady Style en Barcelona',
  bachataLadyHeroSubtitle: 'Sensualidad y Técnica Femenina con el Método Farray®',
  bachataLadyHeroDesc:
    'Descubre tu lado más sensual. Aprende ondulaciones, movimientos de cadera y estilo femenino para brillar en la pista.',
  ...
  // What Is Section
  bachataLadyWhatIsTitle: '¿Qué es Bachata Lady Style y por qué transformará tu baile?',
  bachataLadyWhatIsDesc:
    'El Bachata Lady Style se centra en desarrollar tu técnica femenina dentro del baile de bachata. A diferencia de las clases en pareja, el Lady Style te permite trabajar ondulaciones, movimientos de cadera, brazos y esa sensualidad característica de la bachata.',
  bachataLadyWhatIsQuote:
    'La bachata Lady Style no es solo moverte. Es sentir la música con cada célula de tu cuerpo y expresar tu feminidad sin límites.',
  ...
  // Schedule
  bachataLadyScheduleTitle: 'Horarios de las clases de Bachata Lady Style',
  bachataLadyScheduleSubtitle: 'Encuentra tu nivel y tu horario ideal',
  ...
  // Prepare Section
  bachataLadyPrepareTitle: 'Prepara tu primera clase de Bachata Lady Style',
  bachataLadyPrepareSubtitle: 'Todo lo que necesitas saber antes de venir',
  bachataLadyPrepareWhatToBring: 'Qué traer:',
  bachataLadyPrepareItem1:
    'Ropa cómoda y ajustada que permita ver tu cuerpo (top y leggings ideales)',
  bachataLadyPrepareItem2: 'Tacones de baile (5-8cm) o zapatillas para empezar',
  bachataLadyPrepareItem3: 'Botella de agua para hidratarte',
  bachataLadyPrepareItem4: 'Toalla pequeña - ¡vas a sudar!',
  bachataLadyPrepareItem5: 'Actitud abierta y ganas de conectar con tu sensualidad',
  bachataLadyPrepareBefore: 'Antes de llegar:',
  bachataLadyPrepareBeforeItem1: 'Llega 10-15 minutos antes para cambiarte',
  bachataLadyPrepareBeforeItem2: 'Evita comer pesado 2 horas antes',
  bachataLadyPrepareBeforeItem3: 'Ven con la mente abierta a explorar tu cuerpo',
  bachataLadyPrepareAvoid: 'Evita:',
  bachataLadyPrepareAvoidItem1: 'Joyas que puedan molestarte durante los movimientos',
  bachataLadyPrepareAvoidItem2: 'Ropa muy holgada que impida ver tu técnica',
  bachataLadyPrepareAvoidItem3: 'Miedo a expresarte - aquí todas somos familia',
  bachataLadyPrepareTeacherTip: 'Consejo de la maestra:',
  bachataLadyPrepareTeacherQuote:
    'La sensualidad no tiene talla ni edad. Cada mujer tiene su propia forma de expresarla. Aquí te ayudamos a descubrir la tuya.',

  // Identification Section
  bachataLadyIdentifyTitle: '¿Te identificas con esto?',
  bachataLadyIdentify1:
    'Bailas bachata pero sientes que tus movimientos son "planos" y sin expresión',
  bachataLadyIdentify2:
    'Te gustaría moverte con más sensualidad pero no sabes cómo hacerlo con elegancia',
  bachataLadyIdentify3:
    'Ves a otras chicas hacer ondulaciones increíbles y quieres aprender su secreto',
  bachataLadyIdentify4:
    'Quieres desarrollar tu propio estilo femenino para destacar en los sociales',
  bachataLadyIdentify5: 'Sientes que te falta confianza corporal cuando bailas bachata',
  ...
  bachataLadyPillarsSectionTitle: 'Los 6 Pilares del Bachata Lady Style',
  bachataLadyPillarsSectionSubtitle:
    'El sistema completo para desarrollar tu sensualidad y técnica',
  bachataLadyPillar1Title: 'Ondulación Corporal',
  bachataLadyPillar1Subtitle: 'Body Waves y Fluidez',
  bachataLadyPillar1Desc:
    'Aprende a mover tu cuerpo como una ola, desde el pecho hasta la cadera, con fluidez y control.',
  bachataLadyPillar1Item1: 'Ondulaciones ascendentes y descendentes',
  bachataLadyPillar1Item2: 'Body waves lentos y sensuales',
  bachataLadyPillar1Item3: 'Aislamiento de torso y pelvis',
  bachataLadyPillar1Result: 'Resultado: Movimientos fluidos que hipnotizan',
  bachataLadyPillar2Title: 'Sensualidad Consciente',
  bachataLadyPillar2Subtitle: 'Expresión con Elegancia',
  bachataLadyPillar2Desc:
    'Desarrolla tu capacidad de expresar sensualidad de forma elegante, segura y auténtica.',
  bachataLadyPillar2Item1: 'Conexión mente-cuerpo',
  bachataLadyPillar2Item2: 'Expresión facial y mirada',
  bachataLadyPillar2Item3: 'Intención en cada movimiento',
  bachataLadyPillar2Result: 'Resultado: Sensualidad que impacta con elegancia',
  bachataLadyPillar3Title: 'Cadera y Pelvis',
  bachataLadyPillar3Subtitle: 'El Centro de Tu Feminidad',
  bachataLadyPillar3Desc:
    'Domina los movimientos de cadera: ochos, círculos, golpes y aislamientos que definen la bachata.',
  bachataLadyPillar3Item1: 'Ochos de cadera fluidos',
  bachataLadyPillar3Item2: 'Círculos y rotaciones',
  bachataLadyPillar3Item3: 'Golpes de cadera con control',
  bachataLadyPillar3Result: 'Resultado: Control total de tu centro corporal',
  bachataLadyPillar4Title: 'Brazos y Manos',
  bachataLadyPillar4Subtitle: 'Extensión de Tu Expresión',
  bachataLadyPillar4Desc:
    'Técnica de brazos que complementa tus movimientos corporales con gracia y fluidez.',
  bachataLadyPillar4Item1: 'Líneas elegantes de brazos',
  bachataLadyPillar4Item2: 'Movimientos de manos sensuales',
  bachataLadyPillar4Item3: 'Coordinación cuerpo-brazos',
  bachataLadyPillar4Result: 'Resultado: Movimientos completos y armoniosos',
  bachataLadyPillar5Title: 'Musicalidad Bachata',
  bachataLadyPillar5Subtitle: 'Bailar lo que Sientes',
  bachataLadyPillar5Desc:
    'Aprende a interpretar la bachata: los acentos, las pausas, el derecho y el romance de la música.',
  bachataLadyPillar5Item1: 'Interpretación de acentos musicales',
  bachataLadyPillar5Item2: 'Uso de pausas dramáticas',
  bachataLadyPillar5Item3: 'Conexión emocional con la letra',
  bachataLadyPillar5Result: 'Resultado: Baile que cuenta historias',
  bachataLadyPillar6Title: 'Presencia Escénica',
  bachataLadyPillar6Subtitle: 'Tu Momento de Brillar',
  bachataLadyPillar6Desc:
    'Desarrolla carisma, confianza y esa presencia que hace que todos quieran mirarte.',
  bachataLadyPillar6Item1: 'Proyección y carisma',
  bachataLadyPillar6Item2: 'Confianza corporal',
  bachataLadyPillar6Item3: 'Dominio del espacio',
  bachataLadyPillar6Result: 'Resultado: Presencia magnética en la pista',

  // Comparison Table
  bachataLadyCompareTitle: 'Bachata Lady Style Método Farray® vs Otras Academias',
  bachataLadyCompareAspect: 'Aspecto',
  bachataLadyCompareOthers: 'Otras academias',
  bachataLadyCompareFarray: 'Método Farray',
  bachataLadyCompareRow1Label: 'Ondulaciones',
  bachataLadyCompareRow1Others: 'Repetir sin entender',
  bachataLadyCompareRow1Farray: 'Técnica progresiva paso a paso',
  bachataLadyCompareRow2Label: 'Sensualidad',
  bachataLadyCompareRow2Others: 'Imitar movimientos',
  bachataLadyCompareRow2Farray: 'Expresión auténtica desde dentro',
  bachataLadyCompareRow3Label: 'Formato',
  bachataLadyCompareRow3Others: 'Sin estructura clara',
  bachataLadyCompareRow3Farray: 'Open Level adaptado a cada alumna',
  bachataLadyCompareRow4Label: 'Grupos',
  bachataLadyCompareRow4Others: 'Masificados',
  bachataLadyCompareRow4Farray: 'Reducidos para atención personal',
  bachataLadyCompareRow5Label: 'Metodología',
  bachataLadyCompareRow5Others: 'Improvisada',
  bachataLadyCompareRow5Farray: 'Sistema probado 8+ años',
  bachataLadyCompareRow6Label: 'Profesoras',
  bachataLadyCompareRow6Others: 'Variables',
  bachataLadyCompareRow6Farray: 'Formadas en Método Farray',
  bachataLadyCompareRow7Label: 'Instalaciones',
  bachataLadyCompareRow7Others: 'Básicas',
  bachataLadyCompareRow7Farray: '700m² profesionales',
  bachataLadyCompareRow8Label: 'Reconocimiento',
  bachataLadyCompareRow8Others: 'Sin aval',
  bachataLadyCompareRow8Farray: 'Certificada CID-UNESCO',

  // For Who Section
  bachataLadyForWhoTitle: '¿Es para ti el Bachata Lady Style?',
  bachataLadyForYesTitle: 'SÍ es para ti si...',
  bachataLadyForYes1: 'Quieres aprender a moverte con sensualidad y elegancia',
  bachataLadyForYes2: 'Buscas desarrollar ondulaciones naturales y fluidas',
  bachataLadyForYes3: 'Deseas conectar más profundamente con tu feminidad',
  bachataLadyForYes4: 'Quieres complementar tus clases de bachata en pareja',
  bachataLadyForYes5: 'Buscas ganar confianza en tu expresión corporal',
  bachataLadyForYes6: 'Te apetece un espacio seguro para explorar tu sensualidad',
  bachataLadyForYes7: 'Quieres destacar en los sociales con un estilo único',
  bachataLadyForYes8: 'Valoras la técnica tanto como la expresión',
  bachataLadyForNoTitle: 'NO es para ti si...',
  bachataLadyForNo1: 'Buscas resultados inmediatos sin práctica',
  bachataLadyForNo2: 'No estás dispuesta a salir de tu zona de confort',
  bachataLadyForNo3: 'Prefieres clases masificadas sin atención personal',
  bachataLadyForNo4: 'No te interesa desarrollar técnica, solo pasos',
  bachataLadyForWhoCTA: '¿Lista para descubrir tu lado más sensual? Reserva tu plaza ahora.',

  // Transformation Table
  bachataLadyTransformTitle: 'Tu Antes y Después con Bachata Lady Style',
  bachataLadyTransformAspect: 'Aspecto',
  bachataLadyTransformBefore: 'Antes',
  bachataLadyTransformAfter: 'Después del Método Farray',
  bachataLadyTransformondulacionesLabel: 'Ondulaciones',
  bachataLadyTransformondulacionesBefore: 'Rígidas o inexistentes',
  bachataLadyTransformondulacionesAfter: 'Fluidas y naturales',
  bachataLadyTransformcaderasLabel: 'Caderas',
  bachataLadyTransformcaderasBefore: 'Movimientos básicos',
  bachataLadyTransformcaderasAfter: 'Control total y variedad',
  bachataLadyTransformbrazosLabel: 'Brazos',
  bachataLadyTransformbrazosBefore: 'Sin saber qué hacer',
  bachataLadyTransformbrazosAfter: 'Elegantes y expresivos',
  bachataLadyTransformsensualidadLabel: 'Sensualidad',
  bachataLadyTransformsensualidadBefore: 'Vergüenza o exageración',
  bachataLadyTransformsensualidadAfter: 'Natural y con elegancia',
  bachataLadyTransformgirosLabel: 'Giros',
  bachataLadyTransformgirosBefore: 'Desequilibrada',
  bachataLadyTransformgirosAfter: 'Controlados y estilizados',
  bachataLadyTransformconfianzaLabel: 'Confianza',
  bachataLadyTransformconfianzaBefore: 'Tímida en la pista',
  bachataLadyTransformconfianzaAfter: 'Segura y magnética',
  bachataLadyTransformestiloLabel: 'Estilo',
  bachataLadyTransformestiloBefore: 'Copiando a otras',
  bachataLadyTransformestiloAfter: 'Tu propio sello personal',

  // Why Choose Section
  bachataLadyWhyChooseTitle: "¿Por qué elegir Farray's para aprender Bachata Lady Style?",
  bachataLadyWhyChoose1Title: 'Método Farray® adaptado',
  bachataLadyWhyChoose1Desc:
    'Metodología única para bachata que prioriza ondulaciones, sensualidad y expresión femenina.',
  bachataLadyWhyChoose2Title: 'Maestras especializadas',
  bachataLadyWhyChoose2Desc:
    'Aprende con profesoras formadas específicamente en técnica femenina de bachata.',
  bachataLadyWhyChoose3Title: 'Academia certificada CID-UNESCO',
  bachataLadyWhyChoose3Desc: 'La única academia de Lady Style en Barcelona avalada por la UNESCO.',
  bachataLadyWhyChoose4Title: 'Instalaciones premium',
  bachataLadyWhyChoose4Desc:
    'Más de 700 m², salas con espejos, sonido profesional y climatización perfecta.',
  bachataLadyWhyChoose5Title: 'Grupos reducidos',
  bachataLadyWhyChoose5Desc: 'Atención personalizada para que desarrolles tu estilo único.',
  bachataLadyWhyChoose6Title: 'Ubicación céntrica',
  bachataLadyWhyChoose6Desc: 'Calle Entença 100, a 5 minutos de Plaza España y Sants.',
  bachataLadyWhyChoose7Title: 'Showcases y eventos',
  bachataLadyWhyChoose7Desc: 'Oportunidad de mostrar tu evolución en escenarios profesionales.',

  // Logos Section
  bachataLadyLogosTitle: 'Nos has podido ver en...',
  bachataLadyLogosIntlFestivalsText: 'y en festivales internacionales de bachata y salsa',

  // Video Section
  bachataLadyVideoTitle: 'Mira nuestras clases de Bachata Lady Style',
  bachataLadyVideoDesc:
    'Observa cómo es una clase de Bachata Lady Style. Ondulaciones, sensualidad y técnica impecable.',

  // Style Comparison
  bachataLadyStyleCompareTitle: 'Bachata Lady Style vs otros estilos',
  bachataLadyStyleCompareSubtitle: 'Descubre qué hace único al Bachata Lady Style',
  ...
  bachataLadyCompareBachataModerna: 'Bachata Fusión',
  // Style comparison rows (feature names)
  bachataLadyCompareRow1: 'Ondulaciones corporales',
  bachataLadyCompareRow2: 'Movimientos de cadera',
  bachataLadyCompareRow3: 'Uso de tacones',
  bachataLadyCompareRow4: 'Musicalidad',
  bachataLadyCompareRow5: 'Conexión en pareja',
  bachataLadyCompareRow6: 'Sensualidad',
  bachataLadyCompareRow7: 'Ritmo y velocidad',
  bachataLadyCompareRow8: 'Elegancia y estilo',

  // Cultural History
  bachataLadyCulturalTitle: 'Historia y Origen del Bachata Lady Style',
  bachataLadyCulturalShort:
    'La bachata lady style no tiene un "nacimiento oficial" como género histórico, pero hoy se usa en academias para nombrar el trabajo de estilo femenino dentro de la bachata moderna, igual que ocurre con el lady style en salsa o kizomba.',
  bachataLadyCulturalFull: `### La Evolución del Bachata Lady Style

La bachata lady style se apoya en la evolución de la bachata desde sus raíces tradicionales en República Dominicana hasta la bachata urbana y sensual actual, donde el protagonismo de la bailarina crece con el uso de adornos, disociaciones y expresión corporal.

**"Bachata Lady Style: línea de trabajo técnico y expresivo que desarrolla el estilo femenino dentro de la bachata moderna, centrado en braceo, ondulaciones, cadera y presencia escénica."**

### Historia y Origen de la Bachata

La bachata nace en República Dominicana a mediados del siglo XX como música popular de guitarra, influida por el bolero, el son y otros géneros caribeños. Durante décadas se asociaba a ambientes humildes y bares de periferia, hasta que en los años 80-90 se profesionaliza y comienza su expansión internacional gracias a artistas como Juan Luis Guerra y a la industria latina.

**"La bachata nace en República Dominicana (mediados siglo XX): música popular de guitarra influida por bolero, son y géneros caribeños. Expansión internacional años 80-90 con Juan Luis Guerra."**

### De la Bachata Tradicional a la Bachata Urbana

Con la difusión global de la bachata desde los 2000, surgen nuevos estilos escénicos y urbanos (bachata moderna, urbana y sensual), que incorporan influencias de ballroom, jazz, contemporáneo y danzas urbanas. En este contexto aparecen las clases específicas de "ladies styling / lady style", donde las mujeres trabajan giros, ondulaciones, líneas y actitud sobre la base de la bachata, tanto en pareja como en solo.

**"Bachata Lady Style surge en los años 2010s con la globalización de la bachata sensual, cuando las bailarinas buscan espacios para desarrollar técnica femenina de forma independiente."**

### ¿Qué es la Bachata Lady Style?

Bachata lady style es la línea de trabajo técnico y expresivo que desarrolla el estilo femenino dentro de la bachata moderna. Se centra en el uso de brazos (arm styling), disociación de torso y caderas, control del peso, caminado con presencia y gestualidad femenina, para que la bailarina pueda lucirse en momentos suelta o en shines dentro del baile de pareja.

**"Bachata Lady Style: arm styling (braceo elegante), body movement (ondas y rolls), trabajo de cadera (ochos, marcajes), giros con spotting, y presencia escénica."**

### Elementos Técnicos del Bachata Lady Style

En las clases de bachata lady style se trabajan ejes como:

**Braceo:** líneas elegantes, fluidez y coordinación con el torso.

**Body movement:** ondas, rolls, inclinaciones y cambios de nivel.

**Cadera:** movimientos laterales, ochos y marcajes suaves o acentuados.

**Giros:** técnica limpia, spotting y equilibrio.

**Presencia escénica:** mirada, actitud, musicalidad y conexión con la letra.

**"Una clase activa de Bachata Lady Style puede quemar 250-400 calorías por hora dependiendo de la intensidad y el uso de tacones."**

### Lady Style y Empoderamiento Femenino

Al igual que en salsa lady style, la bachata lady style se ha convertido en una herramienta de empoderamiento femenino en escuelas de baile de todo el mundo. Ofrece a las mujeres un espacio para trabajar autoestima, sensualidad y seguridad en su movimiento, más allá del rol tradicional de seguidora.

**"Bachata Lady Style se ha convertido en herramienta de empoderamiento femenino, ofreciendo espacio para trabajar autoestima, sensualidad y seguridad corporal."**

### Bachata Lady Style en Barcelona

En ciudades como Barcelona, la bachata lady style forma parte de la oferta habitual de academias especializadas en ritmos latinos, donde se combinan técnica de bachata moderna con bases de jazz, contemporáneo o urbano para refinar el estilo. En este contexto, escuelas como Farray's International Dance Center integran el trabajo de lady style dentro de su enfoque global de danza latina y urbana, poniendo énfasis en musicalidad, técnica y personalidad propia de cada bailarina.

**"Farray's International Dance Center: Bachata Lady Style con metodología propia, grupos reducidos, valoración 4.9/5 en Google con más de 500 reseñas."**`,
  ...
  // Dato citable - Técnicas principales
  bachataLadyCitableTecnicas:
    'Técnicas principales del Bachata Lady Style: arm styling (braceo elegante), body movement (ondas y rolls), trabajo de cadera (ochos, marcajes), giros con spotting, y presencia escénica.',

  // Dato citable - Metodología
  bachataLadyCitableMetodologia:
    "Farray's International Dance Center ofrece Bachata Lady Style con metodología propia: técnica progresiva, grupos reducidos, y enfoque en expresión auténtica sobre imitación.",

  // Dato citable - Evolución global
  bachataLadyCitableEvolucionGlobal:
    'El Bachata Lady Style se ha expandido globalmente desde los 2010s, con comunidades fuertes en Europa (Barcelona como epicentro), América Latina, y Estados Unidos.',

  // Dato citable - Música
  bachataLadyCitableMusica:
    'Bachata Lady Style se trabaja sobre bachata sensual, bachata moderna y bachata urbana, permitiendo expresión corporal sobre música romántica y contemporánea.',

  // Dato citable - Empoderamiento
  ...
  bachataLadyCitableFact2:
    'El trabajo de ondulaciones y disociación corporal del Bachata Lady Style mejora la coordinación, flexibilidad y conciencia corporal.',

  bachataLadyCitableFact3:
    "Farray's International Dance Center ofrece clases de Bachata Lady Style con valoración 4.9/5 en Google con más de 500 reseñas.",

  // FAQs
  bachataLadyFaqTitle: 'Preguntas Frecuentes sobre Bachata Lady Style',
  bachataLadyFaqQ1: '¿Qué es exactamente el Bachata Lady Style?',
  bachataLadyFaqA1:
    'El Bachata Lady Style (o "estilo chica") es una disciplina de baile que se centra en el desarrollo de la técnica femenina dentro de la bachata: ondulaciones, sensualidad, trabajo de cadera, elegancia y expresión corporal. Se practica principalmente de forma individual o en grupo, sin pareja.',
  bachataLadyFaqQ2: '¿Necesito saber bailar bachata para empezar Lady Style?',
  bachataLadyFaqA2:
    'Sí, recomendamos tener al menos 3 meses de experiencia en clases de bachata en pareja antes de empezar Bachata Lady Style. Esto te permite tener la base rítmica y corporal necesaria para aprovechar al máximo las clases de técnica femenina.',
  bachataLadyFaqQ3: '¿Las clases son solo para mujeres?',
  bachataLadyFaqA3:
    'El Lady Style tradicionalmente se enfoca en la expresión femenina, pero nuestras clases están abiertas a todas las personas que quieran desarrollar este estilo de baile.',
  bachataLadyFaqQ4: '¿Necesito tacones para las clases?',
  bachataLadyFaqA4:
    'Para principiantes, puedes empezar con zapatillas deportivas. A medida que avanzas, recomendamos tacones de baile (3-7cm). Tenemos clases específicas de técnica de tacones.',
  bachataLadyFaqQ5: '¿Qué diferencia hay entre Lady Style y Ladies Styling?',
  bachataLadyFaqA5:
    'Son términos intercambiables. "Lady Style", "Ladies Styling", "Estilo Chica" o "Técnica Femenina" se refieren a la misma disciplina: el desarrollo de la expresión femenina en el baile de bachata.',
  bachataLadyFaqQ6: '¿Cuánto tiempo necesito para ver resultados?',
  bachataLadyFaqA6:
    'Desde la primera clase notarás cambios en tu postura y conciencia corporal. En 2-3 meses de práctica regular, verás una transformación significativa en tu estilo y confianza.',
  ...
  bachataLadyFaqQ9: '¿El Lady Style me ayudará a bailar mejor en pareja?',
  bachataLadyFaqA9:
    '¡Absolutamente! El Lady Style desarrolla tu técnica, elegancia y presencia. Estas habilidades se transfieren directamente a tu baile en pareja, haciéndote una mejor seguidora y más expresiva.',
  bachataLadyFaqQ10: '¿Hacéis actuaciones o showcases?',
  bachataLadyFaqA10:
    'Sí. Tenemos una gala anual donde las alumnas pueden mostrar su evolución en un escenario profesional. También organizamos showcases y participamos en eventos.',
  bachataLadyFaqQ11: '¿Quién es Yunaisy Farray?',
  bachataLadyFaqA11:
    'Yunaisy Farray es una bailarina y maestra cubana, miembro del CID-UNESCO, formada en la Escuela Nacional de Arte de Cuba. Es la creadora del Método Farray® y directora de la academia.',
  bachataLadyFaqQ12: '¿Qué es el Método Farray®?',
  bachataLadyFaqA12:
    'Es un sistema exclusivo de enseñanza desarrollado por Yunaisy Farray que prioriza la expresión femenina, la elegancia y la musicalidad antes de las figuras complejas. Garantiza resultados rápidos y sólidos.',
  bachataLadyFaqQ13: '¿Y si falto a una clase?',
  bachataLadyFaqA13:
    'Si tienes membresía, dispones de 30 días para recuperar clases canceladas. Con abono de horas, gestionas tus clases de forma flexible desde la app de la academia.',
  bachataLadyFaqQ14: '¿Cuántas calorías se queman en una clase?',
  bachataLadyFaqA14:
    'Una clase de Lady Style quema entre 300-400 calorías por hora, combinando trabajo cardiovascular con tonificación de piernas, glúteos y core.',
  bachataLadyFaqQ15: '¿Dónde está la academia y cómo puedo contactar?',
  bachataLadyFaqA15:
    'Estamos en Calle Entença 100, 08015 Barcelona (a 5 min de Plaza España y Sants).<br><br>📞 Teléfono: +34 622 247 085<br>📧 Email: info@farrayscenter.com<br>🌐 Web: www.farrayscenter.com/contacto',

  // Nearby Areas
  bachataLadyNearbyTitle: 'Clases de Bachata Lady Style cerca de ti',
  bachataLadyNearbyDesc:
    "Somos una de las academias de referencia para clases de Bachata Lady Style en la zona de Plaza España, Sants, Hostafrancs, Les Corts y Eixample Esquerra. También recibimos alumnas de Poble Sec, Sant Antoni y L'Hospitalet que buscan formación en bachata con metodología profesional.",
  bachataLadyNearbySearchText: 'Si buscas clases de bachata lady style en Barcelona, estás a:',
  bachataLadyNearbyMetro:
    'Metro: Plaza España (L1, L3), Rocafort (L1) - 5 min andando, Entença (L5) - 5 min andando o Hostafrancs (L1) - 5 min andando.',

  // Final CTA
  bachataLadyFinalCTATitle: 'Tu primera clase de Bachata Lady Style te espera',
  ...
  timbaHeroLocation: 'Entre Plaza España y Sants Estación',
  ...
  stretchingMetaKeywords:
    'stretching barcelona, estiramientos barcelona, clases de estiramientos, clases de estiramientos en barcelona, flexi, flexibilidad, backbending, elongación, Método Farray',

  // === BREADCRUMB ===
  stretchingBreadcrumbHome: 'Inicio',
  stretchingBreadcrumbClasses: 'Clases',
  stretchingBreadcrumbCategory: 'Preparación Física',
  ...
  stretchingWhatIsTitle: '¿Qué es el Stretching y por qué lo necesitas?',
  stretchingWhatIsP1:
    'El stretching o estiramientos es una disciplina que va mucho más allá de "tocar los pies". Es un trabajo profundo de flexibilidad, movilidad articular y consciencia corporal que beneficia a cualquier persona, independientemente de si baila o no.',
  stretchingWhatIsP2:
    'En nuestras clases de estiramientos en Barcelona, combinamos técnicas de flexi con el Método Farray, un enfoque progresivo que respeta los tiempos de cada cuerpo. No forzamos, guiamos.',
  stretchingWhatIsP3:
    'Nuestras clases de Backbending & Legs son especialmente populares: trabajamos la elongación de piernas y espalda, prevenimos problemas de espalda y fortalecemos el core. Todo en un ambiente sin prisas y con atención personalizada.',
  stretchingWhatIsP4:
    'Ya seas bailarín/a que quiere mejorar su técnica, oficinista con dolores de espalda, o simplemente alguien que quiere sentirse más ágil... el stretching es para ti.',
  stretchingWhatIsQuestionTitle: '¿Quieres recuperar la flexibilidad que creías perdida?',
  stretchingWhatIsQuestionAnswer:
    'El stretching no entiende de edad ni de "rigidez". Con constancia y la guía adecuada, cualquier cuerpo puede mejorar. Ven a probar y descúbrelo.',

  // === IDENTIFICATION SECTION (Who is it for) ===
  stretchingIdentifyTitle: '¿Te identificas con alguna de estas situaciones?',
  stretchingIdentify1: 'Te levantas rígido/a y te cuesta hacer movimientos básicos por la mañana',
  stretchingIdentify2: 'Pasas muchas horas sentado/a y notas tensión en espalda, cuello o caderas',
  stretchingIdentify3: 'Bailas y sientes que tu flexibilidad te limita en ciertos movimientos',
  stretchingIdentify4: 'Has tenido lesiones y quieres prevenir que vuelvan a ocurrir',
  stretchingIdentify5: 'Quieres mejorar tu postura y reducir dolores crónicos',
  stretchingIdentify6:
    'Sueñas con hacer un split, backbend, o simplemente tocarte los pies sin sufrir',
  stretchingIdentifyTransition:
    'Si has dicho "sí" a alguno de estos puntos, ya sabes lo que necesitas.',
  stretchingNeedEnrollTitle: 'Necesitas apuntarte a clases de Stretching',
  stretchingIdentifyAgitate1:
    'Sin flexibilidad, tu cuerpo acumula tensiones que tarde o temprano pasan factura. Dolores de espalda, lesiones, rigidez que limita tus movimientos...',
  stretchingIdentifySolution:
    'El stretching es la solución. Un trabajo progresivo, guiado y seguro que transforma tu cuerpo desde dentro.',
  stretchingIdentifyClosing: 'Tu cuerpo merece moverse sin límites.',

  // === TRANSFORMATION SECTION ===
  stretchingTransformTitle: 'Imagina tu antes y después',
  stretchingTransform1Title: 'Mayor rango de movimiento',
  stretchingTransform1Desc: 'Tu cuerpo se mueve con libertad en todas tus actividades diarias.',
  stretchingTransform2Title: 'Adiós a los dolores',
  stretchingTransform2Desc: 'Reducción significativa de dolores de espalda y tensión muscular.',
  stretchingTransform3Title: 'Postura impecable',
  stretchingTransform3Desc: 'Mejor postura corporal que notas y que los demás notan.',
  stretchingTransform4Title: 'Prevención de lesiones',
  stretchingTransform4Desc: 'Un cuerpo flexible es un cuerpo que se lesiona menos.',
  stretchingTransform5Title: 'Conexión cuerpo-mente',
  ...
  stretchingLevelBeginnerDesc:
    'Introducción al stretching. Aprenderás las bases de la flexibilidad, respiración y postura. Ideal si empiezas de cero o hace mucho que no estiras.',
  stretchingLevelBasicTitle: 'Básico',
  stretchingLevelBasicDesc:
    'Consolidación de técnicas básicas y aumento progresivo de intensidad. Empezarás a ver mejoras significativas en tu rango de movimiento.',
  stretchingLevelIntermediateTitle: 'Intermedio (Backbending & Legs)',
  stretchingLevelIntermediateDesc:
    'Enfoque en backbend y elongación de piernas. Trabajamos puentes, splits y flexiones de espalda de forma segura y progresiva.',
  stretchingLevelInterAdvTitle: 'Intermedio/Avanzado (Backbending & Legs)',
  stretchingLevelInterAdvDesc:
    'Nivel más intenso para quienes ya tienen buena flexibilidad. Trabajo profundo de backbending avanzado y splits completos.',
  ...
  stretchingTeacher2Specialty: 'Stretching & Ballet Clásico',
  ...
  stretchingTeachersClosing:
    'Dos profesores, dos enfoques complementarios. Cris para el trabajo profundo de backbending y Legs, Daniel para la técnica de base. La combinación perfecta para tu flexibilidad.',

  // === SCHEDULE SECTION ===
  stretchingScheduleTitle: 'Horarios de Clases de Stretching',
  stretchingScheduleSubtitle: '5 clases semanales para todos los niveles',
  stretchingScheduleNote: '* Las clases de Backbending & Legs duran 1h30',

  // === WHY CHOOSE US SECTION ===
  stretchingWhyChooseTitle: '¿Por qué elegirnos para tu Stretching?',
  stretchingWhyChooseSubtitle: '7 razones que nos diferencian',
  stretchingWhyChoose1Title: 'Método Farray',
  stretchingWhyChoose1Desc:
    'Una metodología progresiva que respeta tu cuerpo. No forzamos, guiamos. Cada alumno avanza a su ritmo.',
  stretchingWhyChoose2Title: 'Grupos Reducidos',
  stretchingWhyChoose2Desc:
    'Máximo 15 personas por clase para garantizar atención personalizada y correcciones individuales.',
  stretchingWhyChoose3Title: 'Profesores Especializados',
  stretchingWhyChoose3Desc:
    'Cris y Daniel combinan conocimientos de flexibilidad, ballet clásico y anatomía funcional.',
  stretchingWhyChoose4Title: 'Todos los Niveles',
  stretchingWhyChoose4Desc:
    'Desde principiantes absolutos hasta nivel avanzado. Siempre hay un grupo para ti.',
  stretchingWhyChoose5Title: 'Ambiente Sin Presión',
  stretchingWhyChoose5Desc:
    'Aquí no competimos. Cada cuerpo es diferente y lo celebramos. Sin comparaciones, solo progreso.',
  stretchingWhyChoose6Title: 'Sin Permanencia',
  stretchingWhyChoose6Desc:
    'Paga mes a mes. Si un mes no puedes venir, no pasa nada. Flexibilidad total.',
  stretchingWhyChoose7Title: 'Academia CID-UNESCO',
  stretchingWhyChoose7Desc:
    'Reconocimiento internacional que avala la calidad de nuestra enseñanza y metodología.',
  stretchingLogosTitle: 'Has podido vernos en',
  stretchingLogosIntlFestivalsText: 'Y en festivales internacionales de todo el mundo',

  // === WHY TODAY SECTION ===
  stretchingWhyTodayFullTitle: '¿Por qué empezar hoy y no "cuando tenga tiempo"?',
  stretchingWhyToday1:
    'La flexibilidad no espera. Cada día que pasa, tu cuerpo pierde rango de movimiento si no lo trabajas. La buena noticia: se puede recuperar, pero cuanto antes empieces, más fácil será.',
  stretchingWhyToday2:
    'Muchos alumnos llegan con dolores crónicos de espalda, cuello o caderas. La mayoría nota alivio desde las primeras semanas. No es magia, es constancia y técnica correcta.',
  stretchingWhyToday3:
    'Los grupos se llenan rápido, especialmente las clases de Backbending & Legs con Cris. Reserva tu plaza antes de que se agoten.',
  stretchingWhyTodayClosing1: 'Tu cuerpo te lo agradecerá.',
  stretchingWhyTodayClosing2:
    'Imagínate dentro de 3 meses: más flexible, sin dolores, moviéndote con libertad. Ese futuro empieza hoy.',

  // === CULTURAL HISTORY SECTION ===
  stretchingCulturalHistoryTitle: 'La Ciencia del Stretching',
  stretchingCulturalShort:
    'El stretching ha evolucionado de simples estiramientos a una disciplina científica que combina anatomía, fisiología y técnicas de diferentes tradiciones.',
  stretchingCulturalFull: `### Orígenes del Stretching Moderno

**El stretching como disciplina científica tiene sus raíces en prácticas milenarias como el yoga (5000+ años) y las artes marciales orientales.** Sin embargo, fue en la década de 1970 cuando se sistematizó como entrenamiento específico con base científica.

**"Stretching (Bob Anderson, 1975): primer manual científico de estiramientos, +3.5 millones de copias vendidas, base del stretching moderno."**

### Bob Anderson y la Revolución del Stretching (1975)

**Bob Anderson es considerado el padre del stretching moderno.** Su libro "Stretching" (1975) vendió más de 3.5 millones de copias y fue traducido a 23 idiomas, estableciendo las bases de lo que hoy conocemos como stretching estático. Anderson fue el primero en sistematizar los estiramientos con un enfoque accesible y científico para el público general.

**"Bob Anderson (1975): popularizó el stretching estático como complemento esencial del ejercicio físico."**

### PNF: Facilitación Neuromuscular Propioceptiva

**La técnica de Facilitación Neuromuscular Propioceptiva (PNF) revolucionó el campo de la flexibilidad.** Desarrollada originalmente para rehabilitación de pacientes con polio en los años 1940-50 por Herman Kabat, fue adaptada al entrenamiento deportivo en los años 80. Los estudios demuestran que PNF puede aumentar la flexibilidad hasta un 30% más rápido que el stretching estático tradicional.

**"PNF (Facilitación Neuromuscular Propioceptiva): combina contracción-relajación muscular; +30% eficacia vs. stretching estático tradicional."**

### Backbending: El Arte de la Flexibilidad Posterior

**El backbending (flexión posterior de la columna) ha sido refinado durante generaciones por gimnastas, bailarines de ballet y contorsionistas profesionales.** Las escuelas de circo rusas y chinas han desarrollado metodologías específicas que permiten trabajar la flexibilidad de espalda de forma segura y progresiva.

**"Backbending: flexión posterior de columna; técnica desarrollada por gimnastas olímpicas, bailarines de ballet y contorsionistas profesionales."**
...
- **Especialización en backbending y legs**: clases específicas de 1h30 para trabajo profundo
- **Enfoque individualizado**: adaptación a cada cuerpo y nivel de flexibilidad
- **Base científica**: técnicas PNF combinadas con estiramientos estáticos

**"Método Farray (Barcelona): fusión yoga + ballet + PNF + anatomía moderna; 4 niveles de progresión estructurada."**

### Beneficios Científicamente Probados

Estudios científicos confirman que el stretching regular de 3+ veces por semana:

- **Mejora 15-20%** el rango de movimiento articular en 4-8 semanas
- **Reduce 30%** el riesgo de lesiones musculares
- **Alivia** dolores crónicos de espalda y cuello
- **Mejora** la circulación sanguínea y linfática
- **Reduce** el estrés y los niveles de cortisol
- **Quema 150-200** calorías por sesión de 60 minutos

**"Stretching regular: +15-20% flexibilidad en 4-8 semanas, -30% riesgo lesiones, 150-200 cal/hora."**`,

  // ===== GEO OPTIMIZATION: Citable Statistics for AI Search Engines =====
  stretchingCitableDefinicion:
    'Stretching: disciplina científica de estiramientos que combina yoga, PNF y anatomía moderna para mejorar flexibilidad y reducir lesiones.',
  stretchingCitableOrigen:
    'Bob Anderson (1975): padre del stretching moderno, autor de "Stretching" (+3.5M copias, 23 idiomas).',
  stretchingCitablePNF:
    'PNF (Facilitación Neuromuscular Propioceptiva): técnica de contracción-relajación que mejora flexibilidad +30% vs stretching estático.',
  stretchingCitableBackbending:
    'Backbending: flexión posterior de columna; técnica refinada por gimnastas olímpicas, bailarines de ballet y contorsionistas.',
  ...
  stretchingCitableFact1:
    'Clase de stretching de 60 min quema 150-200 calorías (actividad de baja intensidad con beneficio metabólico).',
  stretchingCitableFact2:
    'Stretching regular (3x semana) mejora flexibilidad 15-20% en 4-8 semanas según estudios de Sports Medicine.',
  stretchingCitableFact3:
    "Farray's Barcelona: clases de stretching con Método Farray (PNF + yoga + ballet), 5/5 Google Reviews.",

  // === FAQ SECTION ===
  stretchingFaqTitle: 'Preguntas Frecuentes sobre Stretching',
  stretchingFaqQ1: '¿Puedo hacer stretching si soy muy rígido/a?',
  stretchingFaqA1:
    'Sí, el stretching es especialmente beneficioso para personas con rigidez. Las personas más rígidas son las que más mejoras experimentan. Nuestras clases de Principiantes están diseñadas para empezar desde cero: trabajamos respiración, postura y estiramientos suaves. Con 2-3 clases semanales, la mayoría nota mejoras en flexibilidad en 2-4 semanas.',
  stretchingFaqQ2: '¿Qué diferencia hay entre las clases de Principiantes y Básico?',
  stretchingFaqA2:
    '<strong>Principiantes (0-3 meses)</strong>: para quienes empiezan de cero. Aprendes respiración diafragmática, postura correcta y estiramientos fundamentales. Duración: 60 minutos.<br><strong>Básico (3-6 meses)</strong>: aumentamos intensidad, trabajamos estiramientos más profundos y empezamos técnicas PNF (Facilitación Neuromuscular Propioceptiva). Duración: 60 minutos.',
  stretchingFaqQ3: '¿Qué son las clases de Backbending & Legs?',
  stretchingFaqA3:
    'Las clases de <strong>Backbending & Legs</strong> son sesiones especializadas de 90 minutos (1h30) enfocadas en: flexibilidad de espalda (puentes, extensiones), elongación de piernas (splits frontal y lateral), y fortalecimiento de isquiotibiales. Utilizamos técnicas PNF y progresiones seguras. Niveles disponibles: Intermedio y Intermedio/Avanzado.',
  stretchingFaqQ4: '¿Necesito experiencia previa para el nivel Intermedio?',
  stretchingFaqA4:
    'Para Backbending & Legs Intermedio recomendamos: mínimo 3-6 meses de stretching regular, o flexibilidad base (poder tocarte los pies, hacer medio puente). Si tienes dudas, prueba una clase de Principiantes primero. Para Intermedio/Avanzado: +12 meses de experiencia o flexibilidad avanzada (split parcial, puente completo).',
  stretchingFaqQ5: '¿El stretching sirve para aliviar dolor de espalda?',
  stretchingFaqA5:
    'Sí. Estudios demuestran que el stretching regular reduce el dolor de espalda en un 30-50% de los casos. El stretching fortalece el core, mejora la postura y libera tensión muscular acumulada. En nuestra academia, el 80% de alumnos con dolor crónico de espalda reportan alivio significativo en las primeras 4-8 semanas de práctica constante.',
  stretchingFaqQ6: '¿Qué debo llevar a clase de stretching?',
  stretchingFaqA6:
    '<strong>Equipamiento necesario</strong>: ropa cómoda y elástica (leggings, camiseta ajustada), toalla pequeña opcional. <strong>No necesitas</strong>: calzado (trabajamos descalzos o con calcetines), esterilla (la proporcionamos). <strong>Recomendado</strong>: botella de agua, ropa de cambio si combinas con otra clase.',
  ...
  stretchingFaqQ11: '¿En cuánto tiempo veré resultados en mi flexibilidad?',
  stretchingFaqA11:
    '<strong>Primeras 2-4 semanas</strong>: menos rigidez matutina, menos dolores musculares, mejor postura. <strong>1-2 meses</strong>: aumento visible del rango de movimiento (15-20% más flexibilidad). <strong>3-6 meses</strong>: cambios significativos (poder tocarte los pies, medio split). <strong>6-12 meses</strong>: objetivos avanzados (split completo, puente). Resultados con práctica de 2-3 veces por semana.',
  stretchingFaqQ12: '¿El stretching me ayudará a hacer el split?',
  stretchingFaqA12:
    'Sí. En las clases de Backbending & Legs trabajamos específicamente hacia el split frontal (piernas adelante-atrás) y split lateral (piernas a los lados). Tiempo estimado según flexibilidad inicial: 6-12 meses para personas con rigidez moderada, 3-6 meses si ya tienes buena base. La constancia (2-3 clases/semana) es clave.',
  stretchingFaqQ13: '¿Puedo hacer stretching si tengo una lesión?',
  stretchingFaqA13:
    'Depende de la lesión y su estado. <strong>Requisitos</strong>: consulta con tu médico o fisioterapeuta primero. Si tienes el alta médica, avísanos antes de clase para adaptar ejercicios. <strong>Contraindicaciones absolutas</strong>: lesiones agudas, hernias discales activas, fracturas recientes. El stretching terapéutico puede ser parte de tu rehabilitación bajo supervisión médica.',
  stretchingFaqQ14: '¿Quiénes son los profesores de stretching en Barcelona?',
  stretchingFaqA14:
    '<strong>Cris Ag</strong> – Especialista en Flexibilidad y Backbending. Imparte: Principiantes (lunes y miércoles 18:00-19:00), Backbending & Legs Intermedio/Avanzado (lunes 21:00-22:30), Backbending & Legs Intermedio (miércoles 20:00-21:30).<br><strong>Daniel Sené</strong> – Bailarín profesional formado en la Escuela Nacional de Ballet de Cuba. Imparte: Stretching Básico (jueves 19:00-20:00).',
  stretchingFaqQ15: '¿Dónde está la academia de stretching y cómo contactar?',
  stretchingFaqA15:
    '<strong>Dirección</strong>: Calle Entença 100, 08015 Barcelona (zona Plaza España, a 5 min de Sants Estació).<br><strong>Metro</strong>: Plaza España (L1, L3), Rocafort (L1), Entença (L5), Hostafrancs (L1) – todos a 5 min andando.<br><br>📞 <strong>Teléfono</strong>: +34 622 247 085<br>📧 <strong>Email</strong>: info@farrayscenter.com<br>🌐 <strong>Web</strong>: www.farrayscenter.com/contacto',
  ...
  stretchingPrepareTitle: 'Prepárate para tu Primera Clase de Stretching',
  stretchingPrepareSubtitle: 'Todo lo que necesitas saber antes de venir',
  stretchingPrepareWhatToBring: 'Qué traer',
  stretchingPrepareBefore: 'Antes de venir',
  stretchingPrepareAvoid: 'Qué evitar',
  stretchingPrepareItem1: 'Ropa cómoda y elástica (leggings, camiseta ajustada)',
  stretchingPrepareItem2: 'Calcetines o pies descalzos (no necesitas zapatillas)',
  stretchingPrepareItem3: 'Botella de agua',
  stretchingPrepareItem4: 'Toalla pequeña (opcional)',
  stretchingPrepareItem5: 'Ganas de cuidar tu cuerpo',
  stretchingPrepareBeforeItem1: 'No comas pesado 2 horas antes de la clase',
  stretchingPrepareBeforeItem2: 'Hidrátate bien durante el día',
  stretchingPrepareBeforeItem3: 'Llega 10 minutos antes si es tu primera vez',
  stretchingPrepareAvoidItem1: 'Ropa muy holgada que dificulte ver tu postura',
  stretchingPrepareAvoidItem2: 'Venir en ayunas (come algo ligero)',
  stretchingPrepareAvoidItem3: 'Forzar más allá de tu límite',
  stretchingPrepareTeacherTip: 'Consejo de Cris',
  stretchingPrepareTeacherQuote:
    'La flexibilidad es un viaje, no un destino. No te compares con nadie más en clase. Tu único trabajo es superarte a ti mismo/a, poco a poco, respetando siempre tu cuerpo.',

  // === FINAL CTA SECTION ===
  stretchingFinalCTATitle: '¿Listo/a para transformar tu flexibilidad?',
  stretchingFinalCTASubtitle: 'Tu primera clase de Stretching te espera',
  stretchingFinalCTADesc:
    'No importa lo rígido/a que seas ahora. Lo que importa es que quieres mejorar. Nuestros profesores te guiarán paso a paso en un ambiente sin presión ni comparaciones.',
  ...
  // Clases de Ejercicios de Glúteos en Barcelona
  // ============================================================

  // === NAV & BREADCRUMB ===
  navBumBum: 'Bum Bum Glúteos',
  bumbumBreadcrumbHome: 'Inicio',
  bumbumBreadcrumbClasses: 'Clases',
  bumbumBreadcrumbCategory: 'Entrenamiento Bailarines',
  bumbumBreadcrumbCurrent: 'Bum Bum Glúteos',

  // === SEO & META ===
  bumbumPageTitle: 'Clases de Ejercicios de Glúteos en Barcelona | Bum Bum Glúteos Maravillosos',
  bumbumMetaDescription:
    'Clases de ejercicios de glúteos en Barcelona. Tonifica y aumenta tus glúteos con hip thrust, sentadillas y técnicas de danza. Método Farray. Clase de prueba disponible.',
  ...
  bumbumWhatIsTitle: '¿Qué es Bum Bum Glúteos Maravillosos?',
  bumbumWhatIsP1:
    'Bum Bum Glúteos Maravillosos es un programa exclusivo de ejercicios de glúteos que combina las técnicas más efectivas de tonificación muscular con movimientos de danza. Trabajamos hip thrust, sentadillas, puente de glúteos, zancadas y patadas de glúteo de forma dinámica y divertida.',
  bumbumWhatIsP2:
    'A diferencia de un entrenamiento de gimnasio tradicional, nuestras clases incorporan ritmo y música, lo que hace que tonificar tus glúteos sea una experiencia motivadora. Fortalecerás glúteos, abdominales y piernas, mejorando tu postura corporal y tu bienestar físico general.',
  bumbumWhatIsP3:
    'El Método Farray aplicado a este programa garantiza una progresión segura y efectiva. Cris Ag, nuestra especialista, adapta cada ejercicio a tu nivel para que consigas unos glúteos más bonitos, firmes y funcionales sin riesgo de lesiones.',
  bumbumWhatIsP4:
    'Ya seas principiante que nunca ha hecho ejercicio de glúteos, bailarina que busca un complemento para su entrenamiento, o alguien con experiencia en fitness que busca un enfoque diferente... Bum Bum Glúteos Maravillosos te sorprenderá con sus resultados.',
  bumbumWhatIsQuestionTitle: '¿Quieres unos glúteos firmes, tonificados y con volumen?',
  bumbumWhatIsQuestionAnswer:
    'No importa tu forma física actual. Con constancia y nuestra metodología, conseguirás los glúteos que siempre has querido. Ven a probar una clase y compruébalo.',

  // === IDENTIFICATION SECTION ===
  bumbumIdentifyTitle: '¿Te identificas con alguna de estas situaciones?',
  bumbumIdentify1:
    'Has probado rutinas de glúteos en casa o en el gym pero no ves resultados duraderos',
  bumbumIdentify2: 'Te aburres en el gimnasio y abandonas antes de conseguir tu objetivo',
  bumbumIdentify3:
    'Quieres unos glúteos más firmes y con más volumen pero no sabes cómo entrenarlos correctamente',
  bumbumIdentify4: 'Pasas mucho tiempo sentada y notas que tus glúteos están débiles o "dormidos"',
  bumbumIdentify5: 'Tienes dolor lumbar y te han dicho que fortalecer los glúteos puede ayudarte',
  bumbumIdentify6:
    'Buscas una forma divertida de ejercitarte que no se sienta como "ir al gimnasio"',
  bumbumIdentifyTransition:
    'Si has dicho "sí" a alguno de estos puntos, tenemos la solución perfecta para ti.',
  bumbumNeedEnrollTitle: 'Necesitas apuntarte a Bum Bum Glúteos Maravillosos',
  bumbumIdentifyAgitate1:
    'Unos glúteos débiles no son solo una cuestión estética. Afectan tu postura, pueden causar dolor lumbar, y reducen tu rendimiento en cualquier actividad física.',
  bumbumIdentifySolution:
    'Con ejercicios específicos de glúteos combinados con técnicas de danza, activarás y fortalecerás esta zona de forma efectiva y sostenible.',
  bumbumIdentifyClosing: 'Tus glúteos merecen el mejor entrenamiento. Dales lo que necesitan.',

  // === TRANSFORMATION SECTION ===
  bumbumTransformTitle: 'Imagina tu antes y después',
  bumbumTransform1Title: 'Glúteos más firmes y tonificados',
  bumbumTransform1Desc:
    'Notarás la diferencia al mirarte al espejo y al ponerte tus jeans favoritos.',
  bumbumTransform2Title: 'Mayor volumen y forma',
  bumbumTransform2Desc:
    'Ejercicios específicos como el hip thrust desarrollan el glúteo mayor de forma visible.',
  bumbumTransform3Title: 'Adiós al dolor lumbar',
  bumbumTransform3Desc: 'Unos glúteos fuertes estabilizan la pelvis y protegen tu espalda baja.',
  bumbumTransform4Title: 'Mejor postura corporal',
  bumbumTransform4Desc: 'La cintura pélvica fortalecida mejora tu postura de pie y sentada.',
  bumbumTransform5Title: 'Más energía y vitalidad',
  bumbumTransform5Desc: 'El ejercicio con música libera endorfinas y te hace sentir increíble.',
  ...
  bumbumLevelOpenDesc:
    'Clase abierta para todos los niveles. Cris Ag adapta la intensidad de cada ejercicio según tu capacidad. Tanto si es tu primera vez como si ya tienes experiencia, trabajarás a tu ritmo con progresiones personalizadas.',
  ...
  bumbumTeachersClosing:
    'Con Cris conseguirás resultados reales porque sabe exactamente cómo activar y trabajar cada músculo del glúteo de forma segura y efectiva.',

  // === SCHEDULE SECTION ===
  bumbumScheduleTitle: 'Horario de Bum Bum Glúteos Maravillosos',
  bumbumScheduleSubtitle: '1 clase semanal para transformar tus glúteos',
  bumbumScheduleNote: '* Clase de 60 minutos',

  // === WHY CHOOSE US SECTION ===
  bumbumWhyChooseTitle: '¿Por qué elegirnos para tus ejercicios de glúteos?',
  bumbumWhyChooseSubtitle: '7 razones que nos diferencian',
  bumbumWhyChoose1Title: 'Método Farray Aplicado',
  bumbumWhyChoose1Desc:
    'Nuestra metodología exclusiva combina ejercicios de glúteos con técnicas de danza para resultados más efectivos y sostenibles.',
  bumbumWhyChoose2Title: 'Hip Thrust y Técnicas Avanzadas',
  bumbumWhyChoose2Desc:
    'Trabajamos los ejercicios científicamente probados como más efectivos para el desarrollo del glúteo mayor.',
  bumbumWhyChoose3Title: 'Grupos Reducidos',
  bumbumWhyChoose3Desc:
    'Máximo 15 personas por clase para garantizar correcciones individuales y atención personalizada.',
  bumbumWhyChoose4Title: 'Diversión Garantizada',
  bumbumWhyChoose4Desc:
    'Entrenamiento con música y ritmo que no se siente como "ir al gimnasio". Disfrutarás cada minuto.',
  bumbumWhyChoose5Title: 'Profesora Especializada',
  bumbumWhyChoose5Desc:
    'Cris Ag adapta cada ejercicio a tu nivel para que progreses sin riesgo de lesiones.',
  bumbumWhyChoose6Title: 'Sin Permanencia',
  bumbumWhyChoose6Desc:
    'Paga mes a mes. Si un mes no puedes venir, no pasa nada. Flexibilidad total.',
  bumbumWhyChoose7Title: 'Academia CID-UNESCO',
  bumbumWhyChoose7Desc:
    'Reconocimiento internacional que avala la calidad de nuestra enseñanza y metodología.',

  // === LOGOS SECTION ===
  bumbumLogosTitle: 'Has podido vernos en',
  bumbumLogosIntlFestivalsText: 'Y en festivales internacionales de todo el mundo',

  // === WHY TODAY SECTION ===
  bumbumWhyTodayFullTitle: '¿Por qué empezar hoy y no "la próxima semana"?',
  bumbumWhyToday1:
    'Cada semana que pasa sin activar tus glúteos, otros músculos compensan su debilidad. Esto puede causar dolor lumbar, mala postura y desequilibrios musculares que se agravan con el tiempo.',
  bumbumWhyToday2:
    'El hip thrust y los ejercicios específicos de glúteos son los más efectivos según estudios de electromiografía (EMG). En nuestra clase los hacemos de forma correcta, segura y divertida.',
  bumbumWhyToday3:
    'No esperes a "estar en forma" para empezar. Nuestra clase es Open Level precisamente para que empieces donde estás. Los resultados llegan con la constancia, no con la espera.',
  bumbumWhyTodayClosing1: 'El mejor momento para fortalecer tus glúteos era hace un año.',
  bumbumWhyTodayClosing2: 'El segundo mejor momento es hoy. ¿Te apuntas?',

  // === CULTURAL HISTORY / CITABILITY SECTION ===
  bumbumCulturalHistoryTitle: 'La Ciencia del Entrenamiento de Glúteos',
  bumbumCulturalShort:
    'El entrenamiento específico de glúteos ha evolucionado de ejercicios básicos a programas científicamente diseñados que maximizan la activación muscular.',
  bumbumCulturalFull: `### El Hip Thrust: La Revolución del Entrenamiento de Glúteos

**El hip thrust es considerado el ejercicio más efectivo para el desarrollo del glúteo mayor según estudios de electromiografía (EMG).** Popularizado por el investigador Bret Contreras (conocido como "The Glute Guy"), este ejercicio ha revolucionado el entrenamiento de glúteos en la última década.

**"Hip thrust: ejercicio #1 para glúteos según EMG; máxima activación del glúteo mayor en extensión de cadera completa."**

### Anatomía del Glúteo: 3 Músculos Clave

**Los glúteos son el grupo muscular más grande y potente del cuerpo humano**, compuesto por tres músculos principales:

- **Glúteo mayor**: El más grande, responsable de la extensión de cadera y la forma redondeada del glúteo
- **Glúteo medio**: Estabilizador lateral de la cadera, importante para la marcha y el equilibrio
- **Glúteo menor**: El más profundo, trabaja junto al medio en la estabilización

**"Glúteos: grupo muscular más grande del cuerpo; 3 músculos (mayor, medio, menor) esenciales para postura, potencia y estabilidad."**

### Los 5 Ejercicios Más Efectivos para Glúteos

Según estudios científicos de activación muscular:

1. **Hip Thrust** (empuje de cadera) - Máxima activación del glúteo mayor
2. **Sentadilla profunda** (Squat) - Trabajo completo del tren inferior
3. **Puente de glúteos** (Glute Bridge) - Versión sin peso del hip thrust
4. **Peso muerto rumano** - Énfasis en isquiotibiales y glúteos
5. **Zancadas** (Lunges) - Trabajo unilateral y equilibrio

**"Top 5 ejercicios glúteos (EMG): hip thrust > sentadilla > puente glúteos > peso muerto rumano > zancadas."**
...
- **Progresiones seguras**: Adaptación a cada nivel de forma individualizada
- **Activación consciente**: Conexión mente-músculo para maximizar resultados

**"Método Farray Glúteos (Barcelona): hip thrust + técnicas danza + progresión personalizada; resultados desde 4-6 semanas."**

### Beneficios Científicamente Probados

El entrenamiento regular de glúteos (2-3 veces/semana):

- **Reduce 50%** el riesgo de dolor lumbar según estudios de fisioterapia
- **Mejora** la postura y estabilidad pélvica
- **Aumenta** la potencia en actividades como correr, saltar y bailar
- **Previene** lesiones de rodilla y cadera
- **Quema 300-400** calorías por sesión de 60 minutos

**"Entrenamiento glúteos: -50% dolor lumbar, +potencia, +estabilidad, 300-400 cal/hora."**`,

  // ===== GEO OPTIMIZATION: Citable Statistics =====
  bumbumCitableDefinicion:
    'Bum Bum Glúteos Maravillosos: programa de ejercicios de glúteos que combina hip thrust, sentadillas y técnicas de danza en Barcelona.',
  bumbumCitableHipThrust:
    'Hip thrust: ejercicio #1 para glúteos según electromiografía (EMG); máxima activación del glúteo mayor.',
  ...
  bumbumCitableFact1:
    'Clase Bum Bum Glúteos quema 300-400 calorías/hora (entrenamiento de fuerza con componente aeróbico).',
  bumbumCitableFact2:
    'Hip thrust activa el glúteo mayor +30% más que sentadillas tradicionales según estudios EMG.',
  bumbumCitableFact3:
    "Farray's Barcelona: clases de ejercicios de glúteos con Método Farray, 4.8/5 Google Reviews (55 reseñas).",

  // === FAQ SECTION ===
  bumbumFaqTitle: 'Preguntas Frecuentes sobre Bum Bum Glúteos Maravillosos',
  bumbumFaqQ1: '¿Necesito experiencia previa en fitness para apuntarme?',
  bumbumFaqA1:
    'No. La clase es Open Level (abierta a todos los niveles). Cris adapta la intensidad de cada ejercicio a tu capacidad. Tanto si es tu primera vez haciendo ejercicio como si ya tienes experiencia, trabajarás a tu ritmo con progresiones personalizadas.',
  bumbumFaqQ2: '¿Qué ejercicios de glúteos se hacen en clase?',
  bumbumFaqA2:
    'Trabajamos los ejercicios más efectivos según la ciencia: hip thrust (empuje de cadera), sentadillas, puente de glúteos, zancadas, peso muerto rumano y patadas de glúteo. Todo combinado con técnicas de danza y música para que sea divertido.',
  bumbumFaqQ3: '¿Qué es el hip thrust y por qué es tan efectivo?',
  bumbumFaqA3:
    'El hip thrust es un ejercicio de empuje de cadera que activa el glúteo mayor más que cualquier otro ejercicio según estudios de electromiografía (EMG). Es el ejercicio #1 recomendado por expertos como Bret Contreras para desarrollar glúteos fuertes y con volumen.',
  bumbumFaqQ4: '¿En cuánto tiempo veré resultados en mis glúteos?',
  bumbumFaqA4:
    '<strong>Primeras 2-4 semanas</strong>: notarás tus glúteos más "activos" y firmes al tacto. <strong>4-8 semanas</strong>: cambios visibles en tono y forma. <strong>3-6 meses</strong>: aumento notable de volumen y definición. Resultados con 1 clase semanal + ejercicio complementario.',
  bumbumFaqQ5: '¿El entrenamiento de glúteos sirve para dolor lumbar?',
  bumbumFaqA5:
    'Sí. Estudios de fisioterapia demuestran que fortalecer los glúteos reduce hasta un 50% el dolor lumbar. Unos glúteos fuertes estabilizan la pelvis y reducen la carga sobre la espalda baja. Muchos de nuestros alumnos notan alivio significativo.',
  bumbumFaqQ6: '¿Qué debo llevar a clase de Bum Bum Glúteos?',
  bumbumFaqA6:
    '<strong>Equipamiento necesario</strong>: ropa deportiva cómoda (leggings, camiseta), zapatillas de deporte, toalla pequeña, botella de agua. <strong>Opcional</strong>: bandas elásticas (nosotros las proporcionamos).',
  ...
  bumbumFaqQ11: '¿Cuántas calorías se queman en una clase?',
  bumbumFaqA11:
    'Una clase de 60 minutos de Bum Bum Glúteos Maravillosos quema aproximadamente 300-400 calorías, dependiendo de tu peso corporal e intensidad. Es un entrenamiento de fuerza con componente aeróbico gracias a las técnicas de danza.',
  bumbumFaqQ12: '¿El entrenamiento de glúteos aumenta el volumen o solo tonifica?',
  bumbumFaqA12:
    'Ambos. Los ejercicios como hip thrust y sentadillas desarrollan el músculo (hipertrofia), lo que aumenta el volumen. A la vez, el entrenamiento regular reduce la grasa corporal y mejora la definición muscular. El resultado es glúteos más grandes Y más tonificados.',
  bumbumFaqQ13: '¿Puedo hacer Bum Bum Glúteos si tengo problemas de rodillas?',
  bumbumFaqA13:
    'Depende de la condición específica. El hip thrust es generalmente seguro para las rodillas porque no implica flexión profunda. Sin embargo, te recomendamos consultar con tu médico antes y avisar a Cris al inicio de la clase para adaptar los ejercicios.',
  bumbumFaqQ14: '¿Quién imparte las clases de Bum Bum Glúteos?',
  bumbumFaqA14:
    '<strong>Cris Ag</strong> – Especialista en Tonificación y Glúteos. Imparte: Bum Bum Glúteos Maravillosos (miércoles 19:00-20:00). También da clases de Stretching (Principiantes y Backbending & Legs). Experta en técnicas de activación glútea y Método Farray.',
  bumbumFaqQ15: '¿Dónde está la academia y cómo contactar?',
  bumbumFaqA15:
    '<strong>Dirección</strong>: Calle Entença 100, 08015 Barcelona (zona Plaza España, a 5 min de Sants Estació).<br><strong>Metro</strong>: Plaza España (L1, L3), Rocafort (L1), Entença (L5), Hostafrancs (L1) – todos a 5 min andando.<br><br>📞 <strong>Teléfono</strong>: +34 622 247 085<br>📧 <strong>Email</strong>: info@farrayscenter.com<br>🌐 <strong>Web</strong>: www.farrayscenter.com/contacto',
  ...
  // === PREPARE FOR CLASS SECTION ===
  bumbumPrepareTitle: 'Prepárate para tu Primera Clase de Bum Bum Glúteos',
  bumbumPrepareSubtitle: 'Todo lo que necesitas saber antes de venir',
  bumbumPrepareWhatToBring: 'Qué traer',
  bumbumPrepareBefore: 'Antes de venir',
  bumbumPrepareAvoid: 'Qué evitar',
  bumbumPrepareItem1: 'Ropa deportiva cómoda (leggings y camiseta)',
  bumbumPrepareItem2: 'Zapatillas de deporte',
  bumbumPrepareItem3: 'Toalla pequeña',
  bumbumPrepareItem4: 'Botella de agua',
  bumbumPrepareItem5: 'Ganas de trabajar y divertirte',
  bumbumPrepareBeforeItem1: 'Come algo ligero 1-2 horas antes',
  bumbumPrepareBeforeItem2: 'Hidrátate bien durante el día',
  bumbumPrepareBeforeItem3: 'Llega 10 min antes si es tu primera vez',
  bumbumPrepareAvoidItem1: 'Comer mucho justo antes de clase',
  bumbumPrepareAvoidItem2: 'Venir sin haber dormido bien',
  bumbumPrepareAvoidItem3: 'Compararte con los demás',
  bumbumPrepareTeacherTip: 'Consejo de Cris',
  bumbumPrepareTeacherQuote:
    '"Activa tus glúteos antes de clase con 10 sentadillas suaves en casa. Así llegarás con la conexión mente-músculo ya establecida y aprovecharás mejor cada ejercicio."',

  // === FINAL CTA SECTION ===
  bumbumFinalCTATitle: '¿Lista/o para transformar tus glúteos?',
  bumbumFinalCTASubtitle: 'Tu primera clase de Bum Bum Glúteos Maravillosos te espera',
  bumbumFinalCTADesc:
    'No importa cómo estén tus glúteos ahora. Lo que importa es que quieres mejorarlos. Cris te guiará ejercicio a ejercicio en un ambiente motivador y sin juicios.',
  bumbumFinalCTAFunny:
  ...
  // Widget (Home)
  calendar_widget_title: 'Calendario Académico',
  calendar_widget_subtitle: 'Consulta las fechas importantes: vacaciones, festivos, eventos y más',
  calendar_view_full: 'Ver calendario completo',

  // Page
  calendar_page_title: 'Calendario Académico 2025-2026',
  calendar_page_description:
    'Calendario académico de FIDC Barcelona: vacaciones, festivos, eventos, galas y fechas importantes del curso 2025-2026.',
  ...
  calendar_type_vacation: 'Vacaciones',
  calendar_type_holiday: 'Festivos',
  calendar_type_event: 'Eventos',
  calendar_type_workshop: 'Workshops',
  calendar_type_info: 'Información',

  // Event cards
  calendar_no_classes: 'No hay clases',
  calendar_add_to_calendar: 'Añadir a mi calendario',
  calendar_happening_now: 'Ahora',
  calendar_coming_soon: 'Próximamente',
  calendar_no_events: 'No hay eventos de este tipo programados',

  // CTA
  calendar_cta_title: '¿Listo para empezar a bailar con nosotros?',
  calendar_cta_subtitle: 'Planifica tu año de baile con nosotros',
  calendar_cta_line2: '+ 25 Estilos diferentes · Bonos flexibles · Ambiente único',
  calendar_cta_line3: '¡Tu momento es ahora!',
  calendar_cta_button1: 'Ver Horarios y Precios',
  calendar_cta_button1_subtext: 'Elige tu estilo favorito',
  calendar_cta_button2: 'Contactar',
  calendar_cta_button2_subtext: '¿Dudas? Te ayudamos',

  // Event titles and descriptions
  calendar_event_christmas_vacation: 'Vacaciones de Navidad',
  calendar_event_christmas_vacation_desc:
    'Periodo de descanso navideño. Las clases se reanudan el 7 de enero. ¡Felices fiestas!',

  calendar_event_three_kings: 'Festivo: Día de Reyes',
  calendar_event_three_kings_desc: 'Día festivo en España. La academia permanece cerrada.',

  calendar_event_easter_vacation: 'Vacaciones de Semana Santa',
  calendar_event_easter_vacation_desc:
    'Periodo de descanso de Semana Santa. Las clases se reanudan el 7 de abril.',

  calendar_event_labor_day: 'Festivo: Día del Trabajador',
  calendar_event_labor_day_desc: 'Día festivo internacional. La academia permanece cerrada.',

  calendar_event_san_juan: 'Festivo: San Juan',
  calendar_event_san_juan_desc:
    'Fiesta de San Juan. La academia permanece cerrada. ¡Disfruta de la verbena!',

  calendar_event_end_year_gala: 'Gala de Fin de Curso',
  calendar_event_end_year_gala_desc:
    '¡El evento más esperado del año! Todos los alumnos muestran lo aprendido en un espectáculo único. Familiares y amigos bienvenidos.',

  calendar_event_summer_vacation: 'Vacaciones de Verano',
  calendar_event_summer_vacation_desc:
    'Periodo de descanso estival. ¡Nos vemos en septiembre con más energía que nunca!',

  calendar_event_course_start: 'Inicio del Curso 2026-2027',
  calendar_event_course_start_desc:
    '¡Arranca el nuevo curso! Nuevos grupos, nuevos horarios y muchas ganas de bailar. ¿Te apuntas?',
  ...
  // ============================================================
  // PRICING PAGE / PÁGINA DE PRECIOS (CUOTAS)
  // ============================================================
  ...
  pricing_exclusive_title: 'Beneficios Exclusivos para Socios',
  ...
  // Referral Program
  pricing_exclusive_referral_badge: 'Programa Referidos',
  pricing_exclusive_referral_title: 'Trae un amigo y gana',
  pricing_exclusive_referral_credits: '2 participaciones puntuales',
  pricing_exclusive_referral_value: 'Regalo valorado en 34€',
  pricing_exclusive_referral_desc: 'Por cada nuevo socio que se inscriba gracias a ti',
