...
export const TEACHER_IMAGES: Record<string, TeacherImageConfig> = {
  ...
  'daniel-sene': {
    id: 'daniel-sene',
    name: 'Daniel Sené',
    basePath: '/images/teachers/img/profesor-daniel-sene',
    objectPosition: 'center 20%',
    sizes: [320, 640, 960],
    formats: ['avif', 'webp', 'jpg'],
  ...
  'alejandro-minoso': {
    ...
    basePath: '/images/teachers/img/profesor-alejandro-minoso',
    objectPosition: 'center 20%',
    sizes: [320, 640, 960],
    formats: ['avif', 'webp', 'jpg'],
  ...
  'isabel-lopez': {
    id: 'isabel-lopez',
    name: 'Isabel López',
    basePath: '/images/teachers/img/profesora-isabel-lopez',
    objectPosition: 'center 20%',
    sizes: [320, 640, 960],
    formats: ['avif', 'webp', 'jpg'],
    styles: ['dancehall', 'twerk'],
  ...
  'marcos-martinez': {
    ...
    basePath: '/images/teachers/img/profesor-marcos-martinez',
    objectPosition: 'center 20%',
    sizes: [320, 640, 960],
    formats: ['avif', 'webp', 'jpg'],
  ...
  'yasmina-fernandez': {
    ...
    basePath: '/images/teachers/img/profesora-yasmina-fernandez',
  ...
  'charlie-breezy': {
    ...
    sizes: [320, 640, 960],
    formats: ['avif', 'webp', 'jpg'],
    styles: ['afro-contemporaneo', 'hip-hop', 'afrobeats', 'hip-hop-reggaeton'],
  },
  'eugenia-trujillo': {
    id: 'eugenia-trujillo',
    name: 'Eugenia Trujillo',
    basePath: '/images/teachers/img/profesora-eugenia-trujillo',
  ...
  noemi: {
    id: 'noemi',
    name: 'Noemi',
    basePath: '/images/teachers/img/profesora-noemie-guerin',
    objectPosition: 'center 20%',
    sizes: [320, 640, 960],
    formats: ['avif', 'webp', 'jpg'],
  ...
  'grechen-mendez': {
    id: 'grechen-mendez',
    name: 'Grechén Méndez',
    basePath: '/images/teachers/img/profesora-greechen-mendez',
    objectPosition: 'center 20%',
    sizes: [320, 640, 960],
    formats: ['avif', 'webp', 'jpg'],
