...
export const SALSA_VS_BACHATA_CONFIG: BlogArticleConfig = {
  ...
  summaryStats: [
    ...
    {
      value: '+86%',
      labelKey: 'blogSalsaVsBachata_statCrecimientoLabel',
      citation: {
        source: 'GO Latin Dance - Community Growth Analysis',
        url: 'https://golatindance.com/3-charts-that-explain-how-our-latin-dance-community-is-changing/',
        year: '2024',
        authors: 'GO Latin Dance',
      },
    },
  ],
