...
const classes = ["dancehall", "twerk", "afrobeat", "hip-hop-reggaeton", "sexy-reggaeton", "reggaeton-cubano", "femmology", "sexy-style", "modern-jazz", "ballet", "contemporaneo", "test-preview"]; // añade más clases aquí
