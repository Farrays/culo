...
const metadata = {
  es: {
    ...
    yrProject: {
      title: 'Y&R | Yunaisy & Renier - Artistas de Baile',
      description: 'Contacta con Y&R (Yunaisy & Renier). Artistas de baile, shows y clases en Barcelona. WhatsApp e Instagram.',
      robots: 'noindex, nofollow',
    },
    miReserva: {
  ...
  ca: {
    ...
    yrProject: {
      title: 'Y&R | Yunaisy & Renier - Artistes de Ball',
      description: 'Contacta amb Y&R (Yunaisy & Renier). Artistes de ball, shows i classes a Barcelona. WhatsApp i Instagram.',
      robots: 'noindex, nofollow',
    },
    miReserva: {
  ...
  en: {
    ...
    yrProject: {
      title: 'Y&R | Yunaisy & Renier - Dance Artists',
      description: 'Contact Y&R (Yunaisy & Renier). Dance artists, shows and classes in Barcelona. WhatsApp and Instagram.',
      robots: 'noindex, nofollow',
    },
    miReserva: {
  ...
  fr: {
    ...
    yrProject: {
      title: 'Y&R | Yunaisy & Renier - Artistes de Danse',
      description: 'Contactez Y&R (Yunaisy & Renier). Artistes de danse, spectacles et cours à Barcelone. WhatsApp et Instagram.',
      robots: 'noindex, nofollow',
    },
    miReserva: {
...
const manualOverrides = {
  es: {
    ...
    yrProject: `<main id="main-content"><h1 class="holographic-text text-4xl font-bold">Y&R | Yunaisy & Renier</h1><p>Artistas de baile urbano · Barcelona</p></main>`,
  ...
  ca: {
    // home excluded - causes hydration error #418 because React renders complex components
    yrProject: `<main id="main-content"><h1 class="holographic-text text-4xl font-bold">Y&R | Yunaisy & Renier</h1><p>Artistes de ball urbà · Barcelona</p></main>`,
  ...
  en: {
    // home excluded - causes hydration error #418 because React renders complex components
    yrProject: `<main id="main-content"><h1 class="holographic-text text-4xl font-bold">Y&R | Yunaisy & Renier</h1><p>Urban dance artists · Barcelona</p></main>`,
  ...
  fr: {
    // home excluded - causes hydration error #418 because React renders complex components
    yrProject: `<main id="main-content"><h1 class="holographic-text text-4xl font-bold">Y&R | Yunaisy & Renier</h1><p>Artistes de danse urbaine · Barcelone</p></main>`,
