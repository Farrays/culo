...
const ANGRY_USER_TRIGGERS = [
  ...
  'enfadado contigo',
  'enfadada contigo',
  // Español - petición de humano (variantes comunes)
  ...
  'worst experience',
  'i want to complain',
  // Francés - petición de humano
  "je veux parler à quelqu'un",
  'je veux parler a quelquun',
