  ...
  try {
    ...
    if (templateName === 'confirmation') {
      const result = await resend.emails.send({
        ...
        html: `<!DOCTYPE html><html><body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;"><div style="text-align: center; margin-bottom: 30px;"><h1 style="color: #B01E3C; margin: 0; font-size: 26px; font-weight: bold;">Farray's International Dance Center</h1></div><div style="background: linear-gradient(135deg, #B01E3C 0%, #800020 100%); color: white; padding: 30px; border-radius: 12px; text-align: center; margin-bottom: 30px;"><h2 style="margin: 0 0 10px 0;">¡Reserva Confirmada!</h2></div><div style="background: #f8f9fa; padding: 25px; border-radius: 12px; margin-bottom: 30px;"><p style="margin: 0 0 15px 0;">Hola <strong>${userFirstName}</strong>,</p><p style="margin: 0;">Tu reserva ha sido confirmada:</p></div><div style="border: 1px solid #e0e0e0; border-radius: 12px; padding: 25px; margin-bottom: 30px;"><table style="width: 100%; border-collapse: collapse;"><tr><td style="padding: 10px 0; border-bottom: 1px solid #eee;"><span style="color: #666;">Clase</span><br><strong style="font-size: 18px;">${userClassName}</strong></td></tr><tr><td style="padding: 10px 0; border-bottom: 1px solid #eee;"><span style="color: #666;">Fecha</span><br><strong>${userClassDate}</strong></td></tr><tr><td style="padding: 10px 0;"><span style="color: #666;">Hora</span><br><strong>${userClassTime}</strong></td></tr></table></div><div style="text-align: center; margin-bottom: 30px;"><p style="color: #666; margin-bottom: 15px;">¿Necesitas cambiar la fecha?</p><a href="https://farrayscenter.com/mis-reservas" style="display: inline-block; background: linear-gradient(135deg, #B01E3C 0%, #800020 100%); color: white; text-decoration: none; padding: 15px 30px; border-radius: 8px; font-weight: bold; font-size: 16px;">Cancelar/Reprogramar</a></div><div style="background: #1a1a1a; color: #fff; text-align: center; padding: 30px 20px; border-top: 1px solid #333;"><img src="https://farrayscenter.com/images/logo/img/logo-fidc_512.png" alt="Farray's International Dance Center" style="max-width: 200px; height: auto; margin-bottom: 20px;"><p style="margin: 10px 0; color: #ccc; font-size: 14px;"><strong style="color: #fff;">Farray's International Dance Center</strong><br>C/ Entença 100, 08015 Barcelona<br><a href="tel:+34622247085" style="color: #B01E3C; text-decoration: none;">+34 622 247 085</a> (WhatsApp)<br><a href="https://farrayscenter.com" style="color: #B01E3C; text-decoration: none;">farrayscenter.com</a> | <a href="https://www.instagram.com/farrays_centerbcn/" style="color: #B01E3C; text-decoration: none;">Instagram</a></p></div></body></html>`,
      });
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="text-align: center; margin-bottom: 30px;">
    <h1 style="color: #B01E3C; margin: 0; font-size: 26px; font-weight: bold;">Farray's International Dance Center</h1>
  </div>
  ...
  <div style="text-align: center; margin-bottom: 30px;">
    <a href="${bookingUrl}" style="display: inline-block; background: linear-gradient(135deg, #B01E3C 0%, #800020 100%); color: white; text-decoration: none; padding: 15px 30px; border-radius: 8px; font-weight: bold; font-size: 16px;">
  ...
  <div style="background: #1a1a1a; color: #fff; text-align: center; padding: 30px 20px; border-top: 1px solid #333;">
    ...
    <p style="margin: 10px 0; color: #ccc; font-size: 14px;">
      ...
      <a href="https://farrayscenter.com" style="color: #B01E3C; text-decoration: none;">farrayscenter.com</a> |
      <a href="https://www.instagram.com/farrays_centerbcn/" style="color: #B01E3C; text-decoration: none;">Instagram</a>
    </p>
  </div>
</body>
</html>
...
<body style="font-family: sans-serif; padding: 20px;">
  <h1 style="color: #B01E3C;">Test de Email</h1>
