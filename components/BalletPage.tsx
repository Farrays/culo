  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-20 md:pt-24" role="main">
        ...
        {/* 3b. Level Cards */}
        <LevelCardsSection titleKey="balletLevelsTitle" levels={BALLET_LEVELS} />
        ...
        <PrepareClassSection
          titleKey="balletPrepareTitle"
          subtitleKey="balletPrepareSubtitle"
          config={BALLET_PREPARE_CONFIG}
        />
