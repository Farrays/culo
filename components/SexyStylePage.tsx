            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <AnimateOnScroll delay={0}>
                <div className="h-full p-6 bg-primary-dark/20 border border-primary-dark/40 rounded-2xl hover:border-primary-dark/60 transition-colors">
                  ...
                  <h3 className="text-xl font-bold text-neutral mb-3">
                    {t('sexystyleLevelBasicTitle')}
                  </h3>
                  <p className="text-neutral/80 text-sm leading-relaxed">
                    {t('sexystyleLevelBasicDesc')}
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={ANIMATION_DELAYS.STAGGER_SMALL}>
                <div className="h-full p-6 bg-primary-accent/15 border border-primary-accent/30 rounded-2xl hover:border-primary-accent/50 transition-colors">
                  ...
                  <h3 className="text-xl font-bold text-neutral mb-3">
                    {t('sexystyleLevelIntermediateTitle')}
                  </h3>
                  <p className="text-neutral/80 text-sm leading-relaxed">
                    {t('sexystyleLevelIntermediateDesc')}
                  </p>
                </div>
              </AnimateOnScroll>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <AnimateOnScroll>
              <div className="max-w-5xl mx-auto">
                <h3 className="text-2xl sm:text-3xl font-black tracking-tighter text-neutral mb-2 text-center holographic-text">{t('sexystylePrepareTitle')}</h3>
                <p className="text-base text-neutral/70 mb-6 text-center">{t('sexystylePrepareSubtitle')}</p>
                    ...
                    <ul className="space-y-2">
                      {[1, 2, 3, 4, 5].map(num => (
                        <li key={num} className="flex items-start gap-2 text-sm text-neutral/80">
                          ...
                          <span>{t(`sexystylePrepareItem${num}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                    ...
                    <ul className="space-y-2">
                      {[1, 2, 3].map(num => (
                        <li key={num} className="flex items-start gap-2 text-sm text-neutral/80">
                          ...
                          <span>{t(`sexystylePrepareBeforeItem${num}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                    ...
                    <ul className="space-y-2">
                      {[1, 2, 3].map(num => (
                        <li key={num} className="flex items-start gap-2 text-sm text-neutral/80">
                          ...
                          <span>{t(`sexystylePrepareAvoidItem${num}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="mt-6 p-5 bg-gradient-to-r from-primary-accent/10 via-primary-dark/10 to-primary-accent/10 rounded-2xl border border-primary-accent/30">
                  <p className="text-sm font-bold text-primary-accent mb-2">{t('sexystylePrepareTeacherTip')}</p>
                  <blockquote className="text-neutral/90 italic leading-relaxed text-sm">&ldquo;{t('sexystylePrepareTeacherQuote')}&rdquo;</blockquote>
                </div>
              </div>
            </AnimateOnScroll>
          </div>
            ...
            <AnimateOnScroll>
              <div className="max-w-4xl mx-auto p-6 bg-black/30 rounded-2xl border border-neutral/20">
                <h3 className="text-xl sm:text-2xl font-bold text-neutral mb-4">
                  {t('sexystyleNearbyTitle')}
                </h3>
                <p className="text-neutral/80 mb-6">{t('sexystyleNearbyDesc')}</p>
                <p className="text-neutral/90 font-semibold mb-4">
                  {t('sexystyleNearbySearchText')}
                </p>
                <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-3">
                  {SEXY_NEARBY_AREAS.map((area, index) => (
                ...
                <p className="text-neutral/70 text-sm mt-4">{t('sexystyleNearbyMetro')}</p>
              </div>
            </AnimateOnScroll>
          </div>
        </section>
