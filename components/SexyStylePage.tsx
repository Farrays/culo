  ...
  return (
    <>
      ...
      <main role="main" id="main-content" className="pt-20 md:pt-24">
        ...
        <LevelCardsSection titleKey="sexystyleLevelsTitle" levels={SEXY_STYLE_LEVELS} />
        ...
        <PrepareClassSection
          titleKey="sexystylePrepareTitle"
          subtitleKey="sexystylePrepareSubtitle"
          config={SEXY_STYLE_PREPARE_CONFIG}
        />
