...
const FooterLink: React.FC<{ to?: string; href?: string; textKey: string }> = ({
  ...
  // Only load 'common' namespace - all footer link translations are in common.json
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 xl:gap-6 text-center sm:text-left">
            ...
            <div className="sm:col-span-2 lg:col-span-1 flex flex-col items-center sm:items-start space-y-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-3 flex items-center gap-2 bg-neutral/5 hover:bg-neutral/10 rounded-full px-3 py-1.5 border border-primary-accent/20 transition-all duration-300"
                title={t('sitemapCID')}
              >
                <svg
                ...
                <span className="text-neutral/80 text-xs font-medium">CID-UNESCO</span>
              </a>
            </div>
