...
// ============================================================================
// COMMON ICONS - Iconos que se repiten en múltiples páginas de clases de baile
// ============================================================================
// Extraídos para evitar duplicación en 23+ archivos de páginas

interface IconProps {
  className?: string;
}

// Users/Group icon - usado en social proof y secciones de comunidad
...
// MapPin icon - usado en secciones de ubicación y nearby areas
...
// Calendar icon - usado en secciones de horarios
...
// Music note icon - usado en secciones de musicalidad
export const MusicNoteIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l2.31-.66a2.25 2.25 0 001.632-2.163zm0 0V4.125c0-.621-.504-1.125-1.125-1.125l-9 2.25v11.25l9-2.25z"
    />
  </svg>
);

// Sparkles/Magic icon - usado en secciones de transformación
...
// Academic cap icon - usado en secciones de niveles/aprendizaje
...
// Trophy icon - usado en secciones de logros/resultados
...
// Fire/Flame icon (outline version)
...
// Bolt/Lightning icon - usado para energía/dinamismo
...
// Arrow trending up - usado para progresión/mejora
...
// Light bulb icon - usado para tips/consejos
...
// Person/User silhouette - usado para perfiles
...
// All icons are already exported with 'export const' declarations above
