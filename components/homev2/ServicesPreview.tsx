            ...
            <div key={service.id} className="w-full md:w-1/2 lg:w-1/3 p-4">
              <AnimateOnScroll delay={index * 100} className="h-full">
                <Link to={`/${locale}${service.href}`} className="group block h-full">
                  <div className="p-8 bg-black/50 backdrop-blur-md border border-primary-dark/50 rounded-2xl shadow-lg transition-all duration-500 hover:border-primary-accent hover:shadow-accent-glow hover:-translate-y-3 hover:scale-[1.02] h-full flex flex-col">
                    {/* Icono */}
                    <div className="mb-6">
