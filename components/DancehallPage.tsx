  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-20 md:pt-24" role="main">
        ...
        <LevelCardsSection titleKey="dhV3LevelsTitle" levels={DANCEHALL_LEVELS} />
        ...
        <PrepareClassSection
          titleKey="dancehallPrepareTitle"
          subtitleKey="dancehallPrepareSubtitle"
          config={DANCEHALL_PREPARE_CONFIG}
        />
