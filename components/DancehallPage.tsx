              ...
              <div className="max-w-5xl mx-auto">
                    ...
                    <ul className="space-y-2">
                      {[1, 2, 3, 4, 5].map(num => (
                        <li key={num} className="flex items-start gap-2 text-sm text-neutral/80">
                          ...
                          <span>{t(`dancehallPrepareItem${num}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                    ...
                    <ul className="space-y-2">
                      {[1, 2, 3].map(num => (
                        <li key={num} className="flex items-start gap-2 text-sm text-neutral/80">
                          ...
                          <span>{t(`dancehallPrepareBeforeItem${num}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                    ...
                    <ul className="space-y-2">
                      {[1, 2, 3].map(num => (
                        <li key={num} className="flex items-start gap-2 text-sm text-neutral/80">
                          ...
                          <span>{t(`dancehallPrepareAvoidItem${num}`)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="mt-6 p-5 bg-gradient-to-r from-primary-accent/10 via-primary-dark/10 to-primary-accent/10 rounded-2xl border border-primary-accent/30">
                  <p className="text-sm font-bold text-primary-accent mb-2">
                    {t('dancehallPrepareTeacherTip')}
                  </p>
                  <blockquote className="text-neutral/90 italic leading-relaxed text-sm">
                    &ldquo;{t('dancehallPrepareTeacherQuote')}&rdquo;
                  </blockquote>
                </div>
              </div>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll>
              <div className="max-w-4xl mx-auto p-6 bg-black/30 rounded-2xl border border-neutral/20">
                <h3 className="text-xl sm:text-2xl font-bold text-neutral mb-4">
                  {t('dancehallNearbyTitle')}
                </h3>
                <p className="text-neutral/80 mb-6">{t('dancehallNearbyDesc')}</p>
                <p className="text-neutral/90 font-semibold mb-4">
                  {t('dancehallNearbySearchText')}
                </p>
                <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-3">
                  {DANCEHALL_NEARBY_AREAS.map((area, index) => (
                ...
                <p className="text-neutral/70 text-sm mt-4">{t('dancehallNearbyMetro')}</p>
              </div>
            </AnimateOnScroll>
          </div>
        </section>
