  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-20 md:pt-24" role="main">
        ...
        {/* 3b. Level Cards */}
        <LevelCardsSection
          titleKey="afrocontemporaneoLevelsTitle"
        ...
        <PrepareClassSection
          titleKey="afrocontemporaneoPrepareTitle"
          subtitleKey="afrocontemporaneoPrepareSubtitle"
          config={AFRO_CONTEMPORANEO_PREPARE_CONFIG}
        />
