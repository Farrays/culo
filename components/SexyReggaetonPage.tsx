  ...
  return (
    <>
      ...
      <main role="main" id="main-content" className="pt-20 md:pt-24">
        ...
        <LevelCardsSection titleKey="sxrLevelsTitle" levels={SEXY_REGGAETON_LEVELS} />
        ...
        <PrepareClassSection
          titleKey="sxrPrepareTitle"
          subtitleKey="sxrPrepareSubtitle"
          config={SEXY_REGGAETON_PREPARE_CONFIG}
        />
