  ...
  return (
    <>
      ...
      <div className="pt-20 md:pt-24">
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="space-y-6 text-lg text-neutral/90 leading-relaxed">
                    <p className="text-xl font-semibold holographic-text">{t('hhrWhatIsP1')}</p>
                    <p>{t('hhrWhatIsP2')}</p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
              {[1, 2, 3, 4, 5].map((num, index) => (
                <AnimateOnScroll key={num} delay={index * 100} className="[perspective:1000px]">
                  <div className="group relative h-full min-h-[100px] flex items-start gap-4 p-6 bg-primary-dark/20 rounded-xl border border-primary-dark/50 hover:border-primary-accent transition-all duration-500 [transform-style:preserve-3d] hover:[transform:translateY(-0.5rem)_scale(1.05)_rotateY(5deg)] hover:shadow-accent-glow">
                    ...
                    <p className="text-neutral/90 leading-relaxed">{t(`hhrIdentify${num}`)}</p>
                  </div>
                </AnimateOnScroll>
              ))}
              <AnimateOnScroll delay={500} className="[perspective:1000px]">
                <div className="group relative h-full min-h-[100px] flex items-start gap-4 p-6 bg-primary-dark/20 rounded-xl border border-primary-dark/50 hover:border-primary-accent transition-all duration-500 [transform-style:preserve-3d] hover:[transform:translateY(-0.5rem)_scale(1.05)_rotateY(5deg)] hover:shadow-accent-glow">
                  ...
                  <p className="text-neutral/90 leading-relaxed">{t('hhrIdentify6')}</p>
                </div>
              </AnimateOnScroll>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <AnimateOnScroll>
              <div className="max-w-3xl mx-auto text-center space-y-6">
                <p className="text-xl font-semibold holographic-text">{t('hhrIdentifyAgitate1')}</p>
                <p className="text-lg text-neutral/90">{t('hhrIdentifySolution')}</p>
                <p className="text-xl text-neutral/90 italic">{t('hhrIdentifyClosing')}</p>
              </div>
            </AnimateOnScroll>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-primary-dark/10">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-12">
              {[1, 2, 3, 4, 5].map((num, index) => (
                <AnimateOnScroll key={num} delay={index * 100} className="[perspective:1000px]">
                  <div className="group h-full min-h-[180px] p-8 bg-black/50 backdrop-blur-md border border-primary-dark/50 hover:border-primary-accent rounded-2xl transition-all duration-500 [transform-style:preserve-3d] hover:[transform:translateY(-0.5rem)_scale(1.05)_rotateY(5deg)] hover:shadow-accent-glow">
                    ...
                    <p className="text-neutral/90 leading-relaxed">{t(`hhrTransform${num}Desc`)}</p>
                  </div>
                </AnimateOnScroll>
              ))}
              <AnimateOnScroll delay={500} className="[perspective:1000px]">
                <div className="group h-full min-h-[180px] p-8 bg-black/50 backdrop-blur-md border border-primary-dark/50 hover:border-primary-accent rounded-2xl transition-all duration-500 [transform-style:preserve-3d] hover:[transform:translateY(-0.5rem)_scale(1.05)_rotateY(5deg)] hover:shadow-accent-glow">
                  ...
                  <h3 className="text-xl font-bold text-neutral mb-3">{t('hhrTransform6Title')}</h3>
                  <p className="text-neutral/90 leading-relaxed">{t('hhrTransform6Desc')}</p>
                </div>
              </AnimateOnScroll>
            </div>
          </div>
        ...
        {/* Teacher Section - Charlie Breezy ONLY */}
          ...
          <div className="container mx-auto px-6 relative z-10">
            <AnimateOnScroll>
              <div className="text-center mb-16 max-w-4xl mx-auto">
                ...
                <p className="text-xl text-neutral/70 mt-4">{t('hhrTeachersSubtitle')}</p>
              </div>
            </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={100} className="[perspective:1000px]">
                <div className="group h-full bg-black/70 backdrop-blur-md border border-primary-dark/50 hover:border-primary-accent rounded-2xl shadow-lg p-8 transition-all duration-500 [transform-style:preserve-3d] hover:[transform:translateY(-0.5rem)_scale(1.05)_rotateY(5deg)] hover:shadow-accent-glow">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-neutral/90 leading-relaxed">{t('hhrTeacher1Bio')}</p>
                  </div>
                </div>
              </AnimateOnScroll>
            </div>
          ...
          <div className="container mx-auto px-6">
            <AnimateOnScroll>
              <div className="text-center mb-12 max-w-4xl mx-auto">
                ...
                <p className="text-lg text-neutral/70">{t('hhrVideoDesc')}</p>
              </div>
            </AnimateOnScroll>
          ...
          <div className="container mx-auto px-6">
            <AnimateOnScroll>
              <div className="max-w-3xl mx-auto text-center space-y-6">
                ...
                <p className="text-xl text-neutral/90">{t('hhrWhyToday1')}</p>
                <p className="text-xl text-neutral/90">{t('hhrWhyToday2')}</p>
                <p className="text-xl text-neutral/90">{t('hhrWhyToday3')}</p>
                <p className="text-2xl font-bold holographic-text mt-8">
                  {t('hhrWhyTodayClosing1')}
                </p>
                <p className="text-lg text-neutral/90 italic">{t('hhrWhyTodayClosing2')}</p>
              </div>
            </AnimateOnScroll>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 relative z-20">
            <AnimateOnScroll>
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg text-neutral/90 mb-10 italic">{t('hhrFinalCTAFunny')}</p>
