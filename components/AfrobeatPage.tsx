  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-20 md:pt-24" role="main">
        ...
        <LevelCardsSection titleKey="afroLevelsTitle" levels={AFROBEAT_LEVELS} />
        ...
        <PrepareClassSection
          titleKey="afroPrepareTitle"
          subtitleKey="afroPrepareSubtitle"
          config={AFROBEAT_PREPARE_CONFIG}
        />
